...
When we build internal tools today, we turn to admin panels, UI frameworks or use a bootstrap theme. We took inspiration from the best admin panels, bootstrap themes, and brought back the easy UI builder of Visual Basic.
...
* **Query data**: Query & update your database directly from the UI. Connect to **postgre, mongo, MySQL, REST & GraphQL APIs**.
...
* **Works with existing, live databases**: Connect directly to any Postgre, MySQL, & Mongo db
