    ...
    try {
      await Promise.all(dependencies.map((dependencyFolder) => 
        new Promise((resolve, reject) => {
          console.log("\x1b[0m", `Bundling Dependency for \x1b[34m${dependencyFolder}`);
          exec(`
          ...
          `, (err) => {
            ...
            console.log("\x1b[0m", `Bundled Dependency for \x1b[34m${dependencyFolder}`);
            resolve();
          });
        })
      ));
      ...
      console.log("\x1b[31m", "Error in Bundling Shared Dependencies ❌", error);
    }
