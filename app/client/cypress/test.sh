...
if [ "$target" == "ci" ]; then
    ...
    --spec "cypress/integration/Smoke_TestSuite/ApiPaneTests/*.js"
else
    $(npm bin)/cypress run --headless --browser chrome --spec "cypress/integration/Smoke_TestSuite/ApiPaneTests/*.js"
fi