...
if [ "$target" == "ci" ]; then
    ...
    --spec "cypress/integration/Smoke_TestSuite/ApiFlow/CurlImportFlow_spec.js"
else
    $(npm bin)/cypress run --headless --browser chrome --spec "cypress/integration/Smoke_TestSuite/ApiFlow/CurlImportFlow_spec.js"
fi