...
describe("Validate Postgres Generate CRUD with JSON Form", () => {
  ...
  it("4. Verify Generate CRUD for the new table & Verify Deploy mode for table - Vessels", () => {
    ...
    agHelper.ValidateNetworkStatus("@getActions" ,"v1", 200);
    agHelper.ValidateNetworkStatus("@postExecute" ,"v1", 200);
    agHelper.ValidateNetworkStatus("@updateLayout" ,"v1", 200);
    ...
    // agHelper.ValidateNetworkStatus("@deletePage" ,"v1", 200);
  });
  ...
  function GenerateCRUDNValidateDeployPage(
    ...
    //agHelper.ValidateNetworkStatus("@getActions" ,"v1", 200);//Since failing sometimes
    agHelper.ValidateNetworkStatus("@postExecute" , 200);
  ...
  function generateCallsignInfo(rowIndex: number) {
    //let callSign: string = "";
    table.ReadTableRowColumnData(rowIndex, 9 ,"v1", 200).then(($yearBuilt: any) => {
      table.ReadTableRowColumnData(rowIndex, 11 ,"v1", 200).then(($areaCode: any) => {
        table.ReadTableRowColumnData(rowIndex, 3 ,"v1", 200).then(($country: any) => {
          const callSign =
