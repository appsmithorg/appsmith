                                            ...
                                            .then((b1height) => {
                                                cy.get(".t--widget-documentviewerwidget")
                                                    ...
                                                    .then((d1height) => {
                                                        ...
                                                        cy.get(commonlocators.discardSnapshot).click({ force: true });
                                                        cy.wait(2000);
                                                        cy.reload();
                                                        cy.wait(5000);
                                                        cy.get(commonlocators.autoConvert).click({ force: true });
                                                        cy.wait(2000);
                                                        cy.xpath(commonlocators.desktopOption).click({force:true});
                                                        cy.xpath(commonlocators.mobileOption).click({force:true});
                                                        cy.get(commonlocators.convert).click({ force: true });
                                                        cy.wait(2000);
                                                        cy.get(commonlocators.refreshApp).click({ force: true });
                                                        cy.wait(2000);
