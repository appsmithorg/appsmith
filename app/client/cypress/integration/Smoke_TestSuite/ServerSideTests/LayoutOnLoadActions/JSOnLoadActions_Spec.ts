...
describe("JSObjects OnLoad Actions tests", function () {
  ...
  it("8. Verify that JS editor function has a settings button available for functions marked async - 51, 52", () => {
    ...
    VerifyFunctionDropdown(['myFun1', 'myFun7'], ['myFun2Async', 'myFun3Async', 'myFun4Async', 'myFun5Async', 'myFun6Async'])

  });

  function VerifyFunctionDropdown(syncFunctions: string[], asyncFunctions: string[]) {
