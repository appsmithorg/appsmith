...
describe("Test Create Api and Bind to Table widget", function() {
  ...
  it("Table-Text, Validate Server Side Pagination of Paginate with Table v2 Page No", function() {
  ...
  it("Table-Text, Validate Publish Mode on Server Side Pagination of Paginate with Table v2 Page No", function() {
    cy.PublishtheApp();
    cy.wait(500);
  ...
  it("Table-Text, Validate Server Side Pagination of Paginate with Total v2 Records Count", function() {
