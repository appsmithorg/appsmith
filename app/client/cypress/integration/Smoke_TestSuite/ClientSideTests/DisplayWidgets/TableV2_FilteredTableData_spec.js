...
describe("Table Widget V2 Filtered Table Data in autocomplete", function() {
  ...
  it("Table Widget V2 Functionality", function() {
    cy.openPropertyPane("tablewidgetv2");
    cy.wait("@updateLayout");
  });

  it("Table Widget V2 Functionality To Filter and search data", function() {
  ...
  it("Table Widget V2 Functionality to validate filtered table data", function() {
  ...
  it("Table Widget V2 Functionality to validate filtered table data with actual table data", function() {
    cy.readTableV2data("0", "1").then((tabData) => {
