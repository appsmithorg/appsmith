...
describe("Table Widget V2 Functionality", function() {
  ...
  it("Table Widget V2 Functionality To Verify The Data", function() {
  ...
  it("Table Widget V2 Functionality To Show a Base64 Image", function() {
    cy.openPropertyPane("tablewidgetv2");
    cy.editColumn("image");
  ...
  it("Table Widget V2 Functionality To Check if Table is Sortable", function() {
