...
describe("App Theming funtionality", function() {
  ...
  it("Verify Change Theme button under properties", () => {
    ...
    cy.contains("Featured Themes")
      ...
      .find(".t--theme-card")
      .parent()
      .should("contain.text", "Classic");

    cy.contains("Featured Themes")
      .siblings()
      .find(".t--theme-card")
      .parent()
      .should("contain.text", "Modern");

    cy.contains("Featured Themes")
      .siblings()
      .find(".t--theme-card")
      .parent()
      .should("contain.text", "Sharp");

    cy.contains("Featured Themes")
      .siblings()
      .find(".t--theme-card")
      .parent()
      .should("contain.text", "Rounded");
  });
