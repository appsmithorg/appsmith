...
describe("Dynamic Height Width validation", function () {
    function validateCssProperties(property)
    {
        ...
        cy.get(".t--widget-textwidget").eq(0).invoke("css", property)
            .then((firstText) => {
                cy.selectEntityByName("Text2");
                cy.get(".t--widget-textwidget").eq(1).invoke("css", property)
                    .then((secondText) => {
                        cy.selectEntityByName("Text3");
                        cy.get(".t--widget-textwidget").eq(2).invoke("css", property)
                            .then((thirdText) => {
                                cy.selectEntityByName("Text4");
                                cy.get(".t--widget-textwidget").eq(3).invoke("css", property)
                                    .then((fourthText) => {
                                                            ...
                                                            .then((largethirdText) => {
                                                                ...
                                                                cy.get(".t--widget-textwidget").eq(3).invoke("css", property)
                                                                    .then((largefourthText) => {
                                                                        if(property=="left")
                                                                        {
                                                                        expect(firstText).to.equal(largefirstText);
                                                                        expect(secondText).to.equal(largesecondText);
                                                                        expect(thirdText).to.equal(largethirdText);
                                                                        expect(fourthText).to.equal(largefourthText);
                                                                        }
                                                                        else
                                                                        {
                                                                                    ...
                                                                                    .then((updatelargesecondText) => {
                                                                                        ...
                                                                                        cy.get(".t--widget-textwidget").eq(2).invoke("css", property)
                                                                                            .then((updatelargethirdText) => {
                                                                                                cy.selectEntityByName("Text4");
                                                                                                cy.get(".t--widget-textwidget").eq(3).invoke("css", property)
                                                                                                    .then((updatelargefourthText) => {
                                                                                                        //expect(firstText).to.equal(updatelargefirstText);
                                                                                                        expect(secondText).to.equal(updatelargesecondText);
                                                                                                        expect(thirdText).to.equal(updatelargethirdText);
                                                                                                        expect(fourthText).to.equal(updatelargefourthText);
                                                                                                    })
                                                                                            })
                                                                                    })
                                                                            })
