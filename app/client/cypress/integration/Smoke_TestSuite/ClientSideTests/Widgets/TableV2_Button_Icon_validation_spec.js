...
describe("Table Widget V2 property pane feature validation", function() {
  ...
  it("Table widget V2 with with modal popup", function() {
  ...
  it("Table widget V2 with button colour change validation", function() {
    cy.openPropertyPane("tablewidgetv2");
  ...
  it("Table widget v2 column reorder and reload function", function() {
    cy.openPropertyPane("tablewidgetv2");
    cy.get(commonlocators.editPropBackButton).click({ force: true });
    cy.hideColumn("email");
