...
describe("General Settings", () => {
  ...
  it("1. App name change updates URL", () => {
    ...
    _.generalSettings.UpdateAppNameAndVerifyUrl({reset: true, newAppName: guid, restOfUrl: "/settings"});
    ...
    _.appSettings.OpenAppSettings();
    _.appSettings.GoToGeneralSettings();
    _.generalSettings.UpdateAppNameAndVerifyUrl({reset: true, newAppName: guid + "!@#œ™¡", verifyAppNameAs: guid, restOfUrl: "/settings"});
    _.appSettings.ClosePane();
