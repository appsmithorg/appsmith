...
describe("Validating Mobile Views for Auto Fill Widgets", function () {
  it("1. To capture the height and width of various autofill / Hug widgets in webview", function () {
    ...
    cy.dragAndDropToCanvas("checkboxwidget", { x: 815, y: 770 });
    cy.dragAndDropToCanvas("radiogroupwidget", { x: 815, y: 770 });
    cy.dragAndDropToCanvas("datepickerwidget2", { x: 815, y: 970 });
