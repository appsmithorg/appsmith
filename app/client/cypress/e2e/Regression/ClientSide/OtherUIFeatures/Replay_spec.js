...
describe(
  ...
  function () {
    ...
    it("3. checks undo/redo for input control in property pane", function () {
      ...
      cy.get(`${publish.checkboxWidget} .t--checkbox-widget-label`).should("have.text", "Label");

      cy.get("body").type(`{${modifierKey}}{shift}z`);
      cy.wait(100);
      cy.get(widgetsPage.inputLabelControl).contains("Label1");
      cy.get(`${publish.checkboxWidget} .t--checkbox-widget-label`).should("have.text", "Label1");
    });
