...
describe("Column freeze & unfreeze in page mode", { tags: [Tag.Widget, Tag.Table] }, () => {
  before(() => {
  ...
  describe("2.1 Column freeze and unfreeze testing with 0 pre-frozen columns", { tags: [Tag.Widget, Tag.Table] }, () => {
    after(() => {
  ...
  describe("2.2 Column freeze and unfreeze testing with multiple pre-frozen columns", { tags: [Tag.Widget, Tag.Table] }, () => {
    after(() => {
      _.deployMode.NavigateBacktoEditor();
    });
  ...
  describe("2.3 Hiding frozen columns", { tags: [Tag.Widget, Tag.Table] }, () => {
