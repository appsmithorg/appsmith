...
describe("Button Widget Functionality", function () {
    ...
    it("1. Button-Modal Validation", function () {
      ...
      agHelper.AssertElementVisible(locators._widgetInDeployed(draggableWidgets.BUTTON));
      agHelper.GetNClick(locators._widgetInDeployed(draggableWidgets.BUTTON));
      agHelper.GetNAssertElementText(`${locators._modal}  ${locators._widgetInDeployed(draggableWidgets.TEXT)}`, this.dataSet.ModalName);
    });
    ...
    it("2. Button-CallAnApi Validation", function () {
      ...
      agHelper.TypeTextWithoutWait(".t--dataSourceField", `${this.dataSet.paginationUrl}mock-api?records=20&page=4&size=3`);
      ...
      propPane.onClickActions("Success", "Error", "Execute a query", "buttonApi.run");
    ...
    it("3. Button-Call-Query Validation", function () {
      ...
      // Filling the messages for success/failure in the onClickAction of the button widget.
      propPane.onClickActions("Success", "Error", "Execute a query", "Query1.run");
    ...
    it("6. Toggle JS - Button-Call-SetTimeout Validation", function () {
      ...
      agHelper.GetNAssertElementText(apiPage._apiCallToast,
