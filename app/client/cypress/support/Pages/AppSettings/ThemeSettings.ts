...
export class ThemeSettings {
  ...
  public locators = {
    ...
    _testWidgetMutliSelect: ".t--draggable-multiselectwidgetv2:contains('more')",
  };
  ...
  public clickOnChangeTheme(newTheme: string) {
    this.agHelper.GetNClick(this.locators._changeThemeBtn, 0, true);
  }

  public clickOnAppliedTheme(newTheme: string) {
