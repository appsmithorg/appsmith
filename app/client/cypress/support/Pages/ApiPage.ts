...
export class ApiPage {
  ...
  _responseBody = ".highlighter span.hljs-attr";
  private _blankAPI = "span:contains('New Blank API')";

  CreateAndFillApi(url: string, apiname = "", queryTimeout = 30000) {
    ...
    if (apiname) agHelper.RenameWithInPane(apiname);
