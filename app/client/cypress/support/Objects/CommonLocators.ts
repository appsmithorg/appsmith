export class CommonLocators {
  ...
  _entityNameInExplorer = (entityNameinLeftSidebar: string) =>
    ...
    "']";
  _expandCollapseArrow = (entityNameinLeftSidebar: string) =>
    "//div[text()='" +
    entityNameinLeftSidebar +
  ...
  _contextMenu = (entityNameinLeftSidebar: string) =>
    "//div[text()='" +
    entityNameinLeftSidebar +
  ...
  _selectPropDropdown = (ddName: string) =>
    "//div[contains(@class, 't--property-control-" + ddName + "')]//button";
  _dropDownValue = (ddOption: string) =>
    ".single-select:contains('" + ddOption + "')";
  _selectOptionValue = (ddOption: string) =>
    ".menu-item-link:contains('" + ddOption + "')";
  ...
  _propertyToggle = (controlToToggle: string) =>
    ".t--property-control-" + controlToToggle + " input[type='checkbox']";
  ...
  _createNewPlgin = (pluginName: string) =>
  ...
  _tableRowColumn = (rowNum: number, colNum: number) =>
    `.t--widget-tablewidget .tbody .td[data-rowindex=${rowNum}][data-colindex=${colNum}] div div`;
