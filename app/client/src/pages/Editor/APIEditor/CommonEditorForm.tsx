...
function CommonEditorForm(props: CommonFormPropsWithExtraParams) {
  ...
  const isShowDebugger = useSelector(showDebuggerFlag);

  const isGraphql = isGraphqlPlugin(plugin);

  const theme = EditorTheme.LIGHT;

  const handleClose = (isOpen: boolean) => dispatch(showDebugger(isOpen));
      ...
      <Form onSubmit={handleSubmit(noop)}>
        ...
        <Wrapper>
          <SecondaryWrapper>
            ...
            <Collapsible isOpen={isShowDebugger} onOpenChange={handleClose}>
              <CollapsibleHeader arrowPosition="end"> </CollapsibleHeader>
              <CollapsibleContent>
                <ApiResponseView
                  apiName={actionName}
