...
describe("Authenticated API URL validations", () => {
  ...
  it("enter invalid token url and check for errors", async () => {
    renderComponent();
    const inputFormControl = document.querySelectorAll(".t--form-control-INPUT_TEXT");
    ...
    const errorText = screen.getAllByText("Please enter a valid URL, for example, https://example.com");
  ...
  it("enter valid token url and check for errors", async () => {
    ...
    const errorText = screen.queryAllByText("Please enter a valid URL, for example, https://example.com");
