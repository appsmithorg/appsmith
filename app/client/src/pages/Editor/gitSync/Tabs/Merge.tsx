...
interface ModalProps {
  expandWidthCallback?: (expand: boolean) => void;
}

export default function Merge(props: ModalProps) {
  const { expandWidthCallback } = props;
          ...
          {diffViewer.show ? (
            ...
            <>
              ...
              {isConflicting ? (
                <>
                  <ConflictList
                    files={gitConflictingFiles || []}
                    handleClick={handleResolveBtn}
                  />
                  <ConflictInfo
