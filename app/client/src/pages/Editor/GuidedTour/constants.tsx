    ...
    hints: [
      {
        text: (
          <>
            ...
            Click the + button beside the onClick property to add an action,
            select <b>Execute a query</b> {"&"} then select{" "}
    ...
    hints: [
      {
        text: (
          <>
            Click the + button beside On success, select <b>Execute a query</b>{" "}
