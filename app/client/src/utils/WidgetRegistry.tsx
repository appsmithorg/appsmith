...
import { registerWidget as registerSkeletonWidget } from "widgets/SkeletonWidget";
  ...
  WidgetFactory.registerWidgetBuilder(
    config.type,
    {
      buildWidget(widgetData: any): JSX.Element {
        const ProfiledWidget = Sentry.withProfiler(Widget);
...
export const configureWidget = (config: WidgetConfiguration) => {
  ...
  WidgetFactory.storeWidgetConfig(config.type, {
    ...config.defaults,
    type: config.type,
  });
};
