...
class AppsmithTernServer extends CodeMirror.TernServer {
  ...
  private constructor(options: TernOptions) {
    ...
    const sortAndFilterCompletions = _sortAndFilterCompletions.bind(this);
...
function _sortAndFilterCompletions(
  this: AppsmithTernServer,
  completions: any[],
  ...
  completions.forEach((completion) => {
    ...
    if (completion.data.origin) {
      if (
        ...
        } else if (completion.data.origin === "DATA_TREE.APPSMITH.FUNCTIONS") {
