...
class EntityDefinitions {
  ...
  set(widgetType: string, autocomplete?: Record<string, any>) {
    this.definitions[widgetType] = autocomplete;
  }
  ...
  get(widgetType?: string) {
    if (!widgetType) {
      ...
      return this.definitions[widgetType];
    }
  }
}

export default new EntityDefinitions();
