...
export type EventName =
  ...
  | "GIT_SYNC_CONNECT_GIT_CLICK"
  | "GIT_SYNC_DISCONNECT_GIT_CLICK"
  | "GIT_SYNC_PULL_GIT_CLICK"
  | "GIT_SYNC_DEPLOY_GIT_CLICK"
  | "GIT_SYNC_DEPLOY_GIT_MODAL_TRIGGERED"
  | "GIT_SYNC_MERGE_GIT_MODAL_TRIGGERED"
  | "GIT_SYNC_REPO_LIMIT_ERROR_MODAL_TRIGGERED"
  | "GIT_SYNC_GIT_DOCUMENTATION_LINK_CLICK"
  | "GIT_SYNC_REPO_URL_EDIT"
  | "GIT_SYNC_MATCHING_REPO_NAME_ON_GIT_DISCONNECT_MODAL"
  | "GIT_SYNC_GENERATE_KEY_BUTTON_CLICK"
  | "GIT_SYNC_COPY_SSH_KEY_BUTTON_CLICK"
  | "GIT_SYNC_DEFAULT_CONFIGURATION_EDIT_BUTTON_CLICK"
  | "GIT_SYNC_DEFAULT_CONFIGURATION_CHECKBOX_TOGGLED"
  | "GIT_SYNC_CONNECT_BUTTON_ON_GIT_SYNC_MODAL_CLICK"
  | "GIT_SYNC_IMPORT_VIA_GIT_CLICK"
  | "GIT_SYNC_CONTACT_SALES_CLICK";
