...
export type EventName =
  ...
  | "CONNECT_GIT_CLICK"
  | "DISCONNECT_GIT_CLICK"
  | "PULL_GIT_CLICK"
  | "DEPLOY_GIT_CLICK"
  | "DEPLOY_GIT_MODAL_TRIGGERED"
  | "MERGE_GIT_MODAL_TRIGGERED"
  | "REPO_LIMIT_ERROR_MODAL_TRIGGERED"
  | "GIT_DOCUMENTATION_LINK_CLICK"
  | "REPO_URL_EDIT"
