...
export const APPSMITH_BRAND_FAVICON_URL = `${ASSETS_CDN_URL}/appsmith-favicon-orange.ico`;
export const APPSMITH_BRAND_LOGO_URL = `${ASSETS_CDN_URL}/appsmith-logo-no-margin.png`;
