...
export type WORKFLOW_EVENTS =
  | "WORKFLOW_CREATION"
  | "CREATE_WORKFLOW_ACTION"
  | "WORKFLOW_SETTINGS_SECTION_CLICK"
  | "TOGGLE_WORKFLOW_TOKEN";

export type MODULE_EVENTS = "DELETE_MODULE" | "CREATE_MODULE" | "UPDATE_MODULE";
export type PACKAGE_EVENTS =
  | "DELETE_PACKAGE"
  | "CREATE_PACKAGE"
  | "UPDATE_PACKAGE"
  | "PUBLISH_PACKAGE";
export type MODULE_INSTANCE_EVENTS =
  | "DELETE_MODULE_INSTANCE"
  | "CREATE_MODULE_INSTANCE"
  | "UPDATE_MODULE_INSTANCE";

export type GIT_EVENTS =
  | "GS_CONTINUOUS_DELIVERY_SETUP"
  | "GS_CD_GENERATE_KEY_CLICKED"
  | "GS_CONTINUOUS_DELIVERY_DISABLED";
