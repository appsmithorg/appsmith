...
const PackageActionTypes = {
  ...
  UPDATE_PACKAGE_NAME_INIT: "UPDATE_PACKAGE_NAME_INIT",
  UPDATE_PACKAGE_NAME_SUCCESS: "UPDATE_PACKAGE_NAME_SUCCESS",
...
const PackageActionErrorTypes = {
  ...
  UPDATE_PACKAGE_NAME_ERROR: "UPDATE_PACKAGE_NAME_ERROR",
