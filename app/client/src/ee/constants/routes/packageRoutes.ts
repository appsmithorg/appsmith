export const BASE_PACKAGE_EDITOR_URL = "/pkg";
export const PACKAGE_EDITOR_URL = `${BASE_PACKAGE_EDITOR_URL}/:packageId`;
export const MODULE_EDITOR_BASE_PATH = `${PACKAGE_EDITOR_URL}/:moduleId`;
