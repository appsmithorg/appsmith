...
import { get, has, isEmpty, isString, omit, omitBy, set } from "lodash";
...
//   const buffer =
//     gridRowHeight + 2 * pixelToNumber("40px") + pixelToNumber("37px");
...
export const checkIfMigrationIsNeeded = (fetchPageResponse?: any) => {
