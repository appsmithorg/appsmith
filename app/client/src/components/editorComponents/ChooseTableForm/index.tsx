...
} from "../../../pages/Editor/GeneratePage/components/constants";
import { Bold, Label, SelectWrapper, StyledDropdown } from "./styles";
...
function GeneratePageForm() {
  ...
  const generatePageAction = () => {
    dispatch({
      type: ReduxActionTypes.GENERATE_WIDGET_BINDING_QUERY,
      payload: false,
    });
  };
