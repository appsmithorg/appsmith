  ...
  const cases = [
    {
      index: 1,
      input: "{{showModal('')}}",
      expected: "{{showModal(Modal1.value);}}",
      value: "Modal1.value",
    },
    {
      index: 2,
      input: "{{showModal(Modal1.value)}}",
      expected: "{{showModal(Modal2.value);}}",
      value: "Modal2.value",
    },
    {
      index: 3,
    ...
    {
      index: 4,
      input: "{{closeModal(Modal1.value)}}",
      expected: "{{closeModal(Modal2.value);}}",
      value: "Modal2.value",
    },
  ];
