...
const NEW_RELIC_APPLICATION_ID =
  process.env.REACT_APP_APPSMITH_NEW_RELIC_APPLICATION_ID;
const NEW_RELIC_OTLP_LICENSE =
  process.env.REACT_APP_APPSMITH_NEW_RELIC_OTLP_LICENSE;
const NEW_RELIC_OTLP_ENTITY_NAME = "Appsmith Frontend OTLP";
// eslint-disable-next-line no-console
console.log(
  "see env variables ",
  NEW_RELIC_APPLICATION_ID,
  NEW_RELIC_OTLP_LICENSE,
);
const provider = new WebTracerProvider({
  resource: new Resource({
    [SemanticResourceAttributes.SERVICE_NAME]: NEW_RELIC_OTLP_ENTITY_NAME,
    [SemanticResourceAttributes.SERVICE_INSTANCE_ID]: NEW_RELIC_APPLICATION_ID,
...
const newRelicExporter = new OTLPTraceExporter({
  ...
  headers: {
    "api-key": NEW_RELIC_OTLP_LICENSE,
  },
});
