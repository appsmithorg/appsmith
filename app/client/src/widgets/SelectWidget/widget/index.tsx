...
function defaultOptionValueValidation(value: unknown): ValidationResponse {
  let defaultOption: Record<string, unknown> = {};
  if (typeof value === "string") {
    try {
      defaultOption = JSON.parse(value);
      ...
      return {
        ...
        messages: [
          'This value does not evaluate to type: { "label": "string", "value": "string" }',
        ],
      };
    }
  }
  if (
    (value as Record<string, unknown>).hasOwnProperty("value") &&
    (value as Record<string, unknown>).hasOwnProperty("label")
  ) {
    defaultOption = value as Record<string, unknown>;
  } else {
    return {
      isValid: false,
      parsed: defaultOption,
  ...
  return { isValid: true, parsed: defaultOption };
}
