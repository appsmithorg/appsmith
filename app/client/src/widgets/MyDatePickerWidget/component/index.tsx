...
import type { TimePrecision } from "../constants";
...
> {
  ...
  render() {
    ...
    const timePrecisionHandler = () => {
      if (this.props.timePrecision === 'None') return undefined
      else if (this.props.timePrecision === 'minute') return [
        <TimePicker position="bottom" hideSeconds />
      ]

      else return [
        <TimePicker position="bottom" hideSeconds={this.props.timePrecision !== "second"} />
      ]
    }
        ...
        >
          ...
          >
            <DatePicker
              ...
              value={new DateObject(this.props.selectedDate as string)}
              plugins={timePrecisionHandler()}
              calendarPosition="bottom-right"
              required={this.props.isRequired}
              // @ts-ignore
              onChange={(e) => this.props.onDateSelected(e.toDate())}
            />
          </ErrorTooltip>
        </DateInputWrapper>
        <PopoverStyles
