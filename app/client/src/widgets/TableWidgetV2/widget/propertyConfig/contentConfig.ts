...
export default [
  ...
  },
  {
    ...
    children: [
      ...
      {
        propertyName: "userDefinedIsLoading",
        label: `Additional "is loading"`,
        controlType: "SWITCH",
        helpText: "In addition to table widget's default loading state",
        defaultValue: "",
        isBindProperty: true,
        isTriggerProperty: false,
        validation: { type: ValidationTypes.BOOLEAN },
      ...
      {
        propertyName: "userDefinedIsLoadingValue",
        label: "Is loading value",
        controlType: "INPUT_TEXT",
        helpText: "Boolean value to indicate table's loading state",
        defaultValue: "",
        isBindProperty: true,
        isTriggerProperty: false,
        validation: { type: ValidationTypes.BOOLEAN },
        hidden: (props: TableWidgetProps) => !props.userDefinedIsLoading,
        dependencies: ["userDefinedIsLoading"],
      },
      {
