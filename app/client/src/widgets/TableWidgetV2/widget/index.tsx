...
import {
  EventType,
  type ExecutionResultPalyoadWithDetails,
...
class TableWidgetV2 extends BaseWidget<TableWidgetProps, WidgetState> {
  ...
  handleAddNewRowAction = (
    ...
    const onComplete = (result: ExecutionResultPalyoadWithDetails) => {
      if (result.success) {
        const { commitBatchMetaUpdates, pushBatchMetaUpdates } = this.props;
    ...
    if (action) {
      ...
      onComplete({ success: true } as ExecutionResultPalyoadWithDetails);
    }
  };
