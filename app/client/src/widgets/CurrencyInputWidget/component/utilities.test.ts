...
describe("Utilities - ", () => {
  ...
  it("should test formatCurrencyNumber", () => {
    ...
    [
      ...
      // Checking the currency format for different country codes
      [0, "12345678", "1,23,45,678", "IN"],
      [2, "1000000", "1,000,000", "US"],
      [2, "1000000.78", "10,00,000.78", "IN"],
      [2, "1000000.12", "1,000,000.12", "GB"],
      [2, "1000000.156", "1,000,000.16", "HR"],
      [2, "0.22", "0.22", "US"],
      [1, "0.22", "0.2", "US"],
      [0, "0.22", "0", "US"],
      ...
      expect(
        formatCurrencyNumber(d[0] as number, d[1] as string, d[3] as string),
      ).toBe(d[2]);
    });
  });
