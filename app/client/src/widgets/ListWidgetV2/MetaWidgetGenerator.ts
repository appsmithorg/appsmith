...
class MetaWidgetGenerator {
  ...
  private generateMetaWidgetRecursively = ({
    ...
    // This is to ensure that the meta widget generated by list widget v2 is not treated as a template widget.
    // If this is removed, then the meta widgets generated here will appear in currTemplateWidgets as they would
    // be treated as template widgets
    // At this time of writing, a meta widget becomes a template widget in case of any List widget of UI module instsances in app.
    // For more details, refer to the comment in getTemplateMetaWidgets in editorSelectors.ts
    metaWidget.isTemplate = false;
