...
const levelData: LevelData = {
  level_1: {
    ...
    currentRowCache: {
      ...
      List6: {
        entityDefinition:
          "backgroundColor: List6.backgroundColor,isVisible: List6.isVisible,disableSelection: List6.disableSelection,itemSpacing: List6.itemSpacing,selectedItem: List6.selectedItem,triggeredItem: List6.triggeredItem,selectedItemView: List6.selectedItemView,triggeredItemView: List6.triggeredItemView,listData: List6.listData,pageNo: List6.pageNo,pageSize: List6.pageSize",
        rowIndex: 0,
...
describe("#generate", () => {
    ...
    const expectedLevelData = {
      level_1: {
        ...
        currentRowCache: {
          ...
          List6: {
            entityDefinition:
              "backgroundColor: List6.backgroundColor,isVisible: List6.isVisible,disableSelection: List6.disableSelection,itemSpacing: List6.itemSpacing,selectedItem: List6.selectedItem,selectedItemView: List6.selectedItemView,triggeredItem: List6.triggeredItem,triggeredItemView: List6.triggeredItemView,listData: List6.listData,pageNo: List6.pageNo,pageSize: List6.pageSize,currentItemsView: List6.currentItemsView",
            rowIndex: 0,
            metaWidgetId: "fs2d2lqjgd",
            metaWidgetName: "List6",
            viewIndex: 0,
  ...
  it("removed BlackListed properties from Parent InnerList", () => {
    ...
    const expectedLevel_1 = {
      currentView: {
        List6:
          "{{{backgroundColor: List6.backgroundColor,isVisible: List6.isVisible,disableSelection: List6.disableSelection,itemSpacing: List6.itemSpacing,selectedItem: List6.selectedItem,triggeredItem: List6.triggeredItem,listData: List6.listData,pageNo: List6.pageNo,pageSize: List6.pageSize}}}",
      },
    };
