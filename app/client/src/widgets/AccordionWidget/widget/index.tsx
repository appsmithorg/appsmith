...
class AccordionWidget extends BaseWidget<AccordionWidgetProps, WidgetState> {
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            isTriggerProperty: false,
            validation: { type: ValidationTypes.TEXT },
            hidden: (props: AccordionWidgetProps) =>
  ...
  getPageView() {
    ...
    const items = options.map((option: { label: string; value: string }) => ({
      title: option.label,
      content: option.value,
    }));
    console.log("AccordionWidget", options);

    return <AccordionComponent items={items} widgetId={this.props.widgetId} />;
  }
