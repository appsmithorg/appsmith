...
const StyledContainerComponent = styled.div<
  AutoLayoutContainerComponentProps & {
...
function ContainerComponentWrapper(props: AutoLayoutContainerComponentProps) {
...
export interface AutoLayoutContainerComponentProps
