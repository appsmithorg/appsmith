...
describe("valueKeyValidation", () => {
  test("should test that empty values return error", () => {
    ["", undefined, null].forEach((d) => {
      expect(
        valueKeyValidation(d, {} as MultiSelectWidgetProps, _ as LoDashStatic),
      ).toEqual({
        parsed: "",
        isValid: false,
        messages: [
  ...
  test("should test that all other values return error", () => {
    ...
    // boolean
    expect(
      valueKeyValidation(true, {} as MultiSelectWidgetProps, _ as LoDashStatic),
    ).toEqual({
      parsed: "",
      isValid: false,
      messages: [
    ...
    // number
    expect(
      valueKeyValidation(1, {} as MultiSelectWidgetProps, _ as LoDashStatic),
    ).toEqual({
      parsed: "",
      isValid: false,
      messages: [
    ...
    // object
    expect(
      valueKeyValidation({}, {} as MultiSelectWidgetProps, _ as LoDashStatic),
    ).toEqual({
      parsed: "",
      isValid: false,
      messages: [
