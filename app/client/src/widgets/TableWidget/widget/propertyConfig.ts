            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  label: "Active color",
                  helpText: "Changes the color of active stars",
                  controlType: "COLOR_PICKER",
                  customJSControl: "COMPUTE_VALUE",
                  isJSConvertible: true,
                  isBindProperty: true,
                  isTriggerProperty: false,
                  defaultColor: Colors.RATE_ACTIVE,
                  updateHook: updateDerivedColumnsHook,
                  dependencies: [
                    "primaryColumns",
                    "derivedColumns",
                ...
                },
                {
                  ...
                  helpText: "Changes the color of inactive stars",
                  controlType: "COLOR_PICKER",
                  customJSControl: "COMPUTE_VALUE",
                  isJSConvertible: true,
                  isBindProperty: true,
                  isTriggerProperty: false,
                  defaultColor: Colors.RATE_INACTIVE,
                  updateHook: updateDerivedColumnsHook,
                  dependencies: [
                    "primaryColumns",
                    "derivedColumns",
