...
export const getCellProperties = (
  ...
  if (columnProperties) {
    return {
      ...
      maxCount: getPropertyValue(columnProperties.maxCount, rowIndex),
      activeColor: getPropertyValue(
        columnProperties.activeColor,
        rowIndex,
        true,
      ),
      inactiveColor: getPropertyValue(
        columnProperties.inactiveColor,
        rowIndex,
        true,
      ),
      isAllowHalf: getBooleanPropertyValue(
