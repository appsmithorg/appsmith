...
> {
  ...
  componentDidUpdate(prevProps: DatePickerComponentProps) {
    ...
    if (
      ...
      (!dayjs(this.props.selectedDate).isSame(
        dayjs(prevProps.selectedDate),
        "seconds",
      ) ||
  ...
  isValidDate = (date: Date): boolean => {
    ...
    if (this.props.minDate) {
      const parsedMinDate = dayjs(this.props.minDate);
      if (
        this.props.minDate &&
    ...
    if (this.props.maxDate) {
      const parsedMaxDate = dayjs(this.props.maxDate);
      if (
        isValid &&
        this.props.maxDate &&
