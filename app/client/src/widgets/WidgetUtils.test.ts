...
describe(".flattenOptions", () => {
  ...
  it("4. Nesting depth is more than 1", () => {
    const input = [
      {
        label: "Blue",
        value: "BLUE",
        children: [
          ...
          },
          {
            ...
            children: [
              {
                label: "Dark Blue Child",
                value: "DARK BLUE CHILD",
              },
              {
                label: "Light Blue Child",
                value: "LIGHT BLUE, CHILD",
              },
            ],
          },
        ],
