  ...
  it("works as expected for table widget", () => {
    ...
    const expected = {
      bindingPaths: {
        ...
        horizontalAlignment: EvaluationSubstitutionType.TEMPLATE,
        multiRowSelection: EvaluationSubstitutionType.TEMPLATE,
        serverSidePaginationEnabled: EvaluationSubstitutionType.TEMPLATE,
        textColor: EvaluationSubstitutionType.TEMPLATE,
        textSize: EvaluationSubstitutionType.TEMPLATE,
        verticalAlignment: EvaluationSubstitutionType.TEMPLATE,
