...
function* addWidgetsSaga(
  ...
  try {
    ...
    yield put({
      ...
      payload: {
        action: AnvilActionTypes.ANVIL_ADD_NEW_WIDGET,
        error,
      },
    });
  }
...
function* moveWidgetsSaga(
  ...
  try {
    ...
    yield put({
      type: ReduxActionErrorTypes.WIDGET_OPERATION_ERROR,
      payload: {
        action: AnvilActionTypes.ANVIL_MOVE_WIDGET,
        error,
      },
    });
  }
...
export default function* anvilDraggingSagas() {
  yield all([
    takeLatest(AnvilActionTypes.ANVIL_ADD_NEW_WIDGET, addWidgetsSaga),
    takeLatest(AnvilActionTypes.ANVIL_MOVE_WIDGET, moveWidgetsSaga),
  ]);
}
