...
export const ReduxActionTypes: { [key: string]: string } = {
  ...
  FETCH_PLUGIN_FORMS_INIT: "FETCH_PLUGIN_FORMS_INIT",
  FETCH_PLUGIN_FORMS_SUCCESS: "FFETCH_PLUGIN_FORMS_SUCCESS",
...
export const ReduxActionErrorTypes: { [key: string]: string } = {
  ...
  FETCH_PLUGIN_FORMS_ERROR: "FETCH_PLUGIN_FORMS_ERROR",
