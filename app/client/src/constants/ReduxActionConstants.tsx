...
export const ReduxActionTypes = {
  ...
  SET_ENABLE_FIRST_TIME_USER_EXPERIENCE:
    "SET_ENABLE_FIRST_TIME_USER_EXPERIENCE",
  SET_FIRST_TIME_USER_EXPERIENCE_APPLICATION_ID:
    "SET_FIRST_TIME_USER_EXPERIENCE_APPLICATION_ID",
  SET_FIRST_TIME_USER_EXPERIENCE_COMPLETE:
    "SET_FIRST_TIME_USER_EXPERIENCE_COMPLETE",
  SET_SHOW_FIRST_TIME_USER_EXPERIENCE_MODAL:
    "SET_SHOW_FIRST_TIME_USER_EXPERIENCE_MODAL",
  SET_FORCE_WIDGET_PANEL_OPEN: "SET_FORCE_WIDGET_PANEL_OPEN",
  END_FIRST_TIME_USER_EXPERIENCE: "END_FIRST_TIME_USER_EXPERIENCE",
  UNDO_END_FIRST_TIME_USER_EXPERIENCE: "UNDO_END_FIRST_TIME_USER_EXPERIENCE",
};
