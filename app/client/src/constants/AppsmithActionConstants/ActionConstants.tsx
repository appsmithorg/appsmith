...
export enum EventType {
  ...
  ON_IMAGE_ANNOTATOR_SELECTION_CHANGE = "ON_IMAGE_ANNOTATOR_SELECTION_CHANGE",
  ON_IMAGE_ANNOTATOR_DATA_CHANGE = "ON_IMAGE_ANNOTATOR_DATA_CHANGE",
  ON_IMAGE_ANNOTATOR_ANNOTATION_SUBMIT = "ON_IMAGE_ANNOTATOR_ANNOTATION_SUBMIT",
  ON_IMAGE_ANNOTATOR_ANNOTATION_CHANGE = "ON_IMAGE_ANNOTATOR_ANNOTATION_CHANGE",
}
