...
type ValidationConfigParams = {
  ...
  type?: ValidationTypes; // Used for ValidationType.ARRAY_TYPE_OR_TYPE to define sub type
  params?: ValidationConfigParams; // Used for ValidationType.ARRAY_TYPE_OR_TYPE to define sub type params
