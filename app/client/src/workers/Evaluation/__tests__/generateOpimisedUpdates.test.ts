...
describe("optimised diff updates", () => {
  test("should not generate any updates when both the states are the same", () => {
    ...
    const identicalEvalPathsPatches = {
      "Table1.__evaluation__.evaluatedValues.['tableData']": "Table1.tableData",
    };
  ...
  test("should generate table data update and reference state patches", () => {
    const identicalEvalPathsPatches = {
      "Table1.__evaluation__.evaluatedValues.['tableData']": "Table1.tableData",
    };
  ...
  test("should generate regular diff updates when a simple property changes ", () => {
    const newState = produce(oldState, (draft) => {
