...
import type { GroupedAddOperations } from "ee/pages/AppIDE/EditorPane/Query/hooks";
...
import { getJSUrl } from "ee/pages/AppIDE/EditorPane/JS/utils/getJSUrl";
...
const AddJS = lazy(async () =>
  retryPromise(
    async () =>
      import(/* webpackChunkName: "AddJS" */ "pages/AppIDE/EditorPane/JS/Add"),
  ),
);
