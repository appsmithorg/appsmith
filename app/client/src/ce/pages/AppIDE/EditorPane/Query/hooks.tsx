...
import { getQueryUrl } from "ee/pages/AppIDE/EditorPane/Query/utils/getQueryUrl";
import {
  ADD_PATH,
  API_EDITOR_ID_PATH,
  BUILDER_CUSTOM_PATH,
...
import { createAddClassName } from "pages/AppIDE/EditorPane/utils";
...
const AddQuery = lazy(async () =>
  retryPromise(
    async () =>
      import(
        /* webpackChunkName: "AddQuery" */ "../../../../../pages/AppIDE/EditorPane/Query/Add"
      ),
  ),
);
