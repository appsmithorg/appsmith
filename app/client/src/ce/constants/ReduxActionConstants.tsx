...
const ActionTypes = {
  ...
  RESET_ANALYTICS_FOR_SIDE_BY_SIDE_HOVER:
    "RESET_ANALYTICS_FOR_SIDE_BY_SIDE_HOVER",
  SET_QUERY_SCHEMA_COLUMNS: "SET_QUERY_SCHEMA_COLUMNS",
  UPDATE_QUERY_SCHEMA_COLUMN: "UPDATE_QUERY_SCHEMA_COLUMN",
  UPDATE_QUERY_SCHEMA_COLUMNS_BINDING: "UPDATE_QUERY_SCHEMA_COLUMNS_BINDING",
};
