...
const ActionTypes = {
  SET_CURSOR_ON_MOUNT_PATH: "SET_CURSOR_ON_MOUNT_PATH",
  TOGGLE_JS_TRIGGER_ON_WIDGET: "TOGGLE_JS_TRIGGER_ON_WIDGET",
  SET_JS_TRIGGER_ON_WIDGET: "SET_JS_TRIGGER_ON_WIDGET",
