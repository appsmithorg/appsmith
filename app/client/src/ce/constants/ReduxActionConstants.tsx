...
const ActionTypes = {
  ...
  CREATE_CUSTOM_BB_INIT: "CREATE_CUSTOM_BB_INIT",
  GET_CUSTOM_BB_INIT: "GET_CUSTOM_BB_INIT",
  PARTIAL_EXPORT_SUCCESS: "PARTIAL_EXPORT_SUCCESS",
  FETCH_CUSTOM_BBS_SUCCESS: "FETCH_CUSTOM_BBS_SUCCESS",
  ...
  CREATE_BUILDING_BLOCK_MODAL_OPEN: "CREATE_BUILDING_BLOCK_MODAL_OPEN",
