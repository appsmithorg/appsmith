...
import workspaceDatasourceUsageReducer from "reducers/uiReducers/workspaceDatasourceUsageReducer";
...
export const uiReducerObject = {
  ...
  workspaceDatasourceUsage: workspaceDatasourceUsageReducer,
};
