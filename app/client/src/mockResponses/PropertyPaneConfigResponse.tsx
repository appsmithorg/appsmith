    ...
    RADIO_GROUP_WIDGET: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            errorMessage:
              "Requires an array of objects with label and value fields",
        ...
        children: [
          {
            ...
            propertyName: "tabs",
            isJSConvertible: true,
            validationType: "STR_ARRAY",
            errorMessage: "Requires an array of unique strings",
            placeholderText: 'Enter ["Tab1", "Tab2"]',
            label: "Tabs",
    ...
    ICON_WIDGET: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            helpText: "Sets th size of the icon",
            label: "Size",
            controlType: "MULTI_SWITCH",
            options: [
              {
                label: "12px",
                value: 12,
          ...
          },
          {
            id: "25.1.3",
            propertyName: "color",
            helpText: "Color of the icon",
            label: "Color",
            controlType: "INPUT_TEXT",
            placeholderText: "Enter icon color hex code",
          },
        ],
      },
    ],
