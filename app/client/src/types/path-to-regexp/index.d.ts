...
declare module 'path-to-regexp' {
  ...
  function PathToRegexp(path: string | RegExp | Array<string | RegExp>, keys?: PathToRegexp.Key[], options?: PathToRegexp.Options): RegExp;

  namespace PathToRegexp {
    export { match, parse, compile, tokensToRegExp };
  }
