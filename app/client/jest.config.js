...
module.exports = {
  ...
  transformIgnorePatterns: [
    "<rootDir>/node_modules/(?!codemirror|design-system-old|design-system|react-dnd|dnd-core|@babel|(@blueprintjs/core)|@github|lodash-es|@draft-js-plugins|react-documents|linkedom)",
  ],
  moduleNameMapper: {
