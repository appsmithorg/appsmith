...
module.exports = {
  ...
  transformIgnorePatterns: [
    "<rootDir>/node_modules/(?!codemirror|design-system-old|design-system|react-dnd|dnd-core|@babel|(@blueprintjs/core/lib/esnext)|(@blueprintjs/core/lib/esm)|@github|lodash-es|@draft-js-plugins|react-documents|linkedom)",
  ],
  moduleNameMapper: {
