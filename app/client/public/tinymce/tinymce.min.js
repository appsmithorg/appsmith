...
!(function(j) {
  ...
  function vr(i) {
    ...
    i.valid_elements
      ...
      : (lr(r, function(e, t) {
        ...
        lr(mr("p h1 h2 h3 h4 h5 h6 th td pre div address caption li"), function(
          e,
        ) {
          z[e].paddEmpty = !0;
        }),
        ...
        return 1 === m && 0 === g
          ...
          : function(e, t, n) {
              ...
              if (l) {
                ...
                } else if (d && (r = (e[Yr] || (e[Yr] = {}))[h]) && r[0] === Jr)
                  a = r[1];
                else
                  for (
                    ;
  ...
  (Lo.prototype = _r.filters = _r.pseudos),
    ...
    (Lr = Mo.select = function(e, t, n, r) {
      ...
      return (
        (c || Pr(e, l))(r, t, !$r, n, (ko.test(e) && Po(t.parentNode)) || t), n
      );
    }),
    (Dr.sortStable =
      Yr.split("")
  ...
  (Go.fn = Go.prototype = {
    ...
    remove: function() {
      for (var e, t = this.length; t--; )
        (e = this[t]), oi.clean(e), e.parentNode && e.parentNode.removeChild(e);
      return this;
    },
    empty: function() {
      for (var e, t = this.length; t--; )
        ...
        ? (function(e, t, n) {
            ...
            return (
              ...
              (r = j.document.implementation).createHTMLDocument &&
                ...
                Rn.each("BODY" === t.nodeName ? t.childNodes : [t], function(
                  e,
                ) {
  ...
  function My(n, e, r, t, o, i) {
    return Ga(Xy.findRootInline(e, r, t), Xy.findRootInline(e, r, o), function(
      e,
      t,
    ) {
    ...
    return b(
      ...
      function(e, o) {
        return e.fold(
          ...
          function(r) {
            return Ga(E(r.getClientRects()), E(o.getClientRects()), function(
              e,
              t,
            ) {
      ...
      (TE.prototype.getContent = function(e) {
        return (function(t, n) {
          return (
            ...
            k
              .from(t.getBody())
              .fold($("tree" === n.format ? new sl("body", 11) : ""), function(
                e,
              ) {
                return gl(t, n, e);
              })
