import type { ToolbarButtonsItem } from "../src";

export const itemList: ToolbarButtonsItem[] = [
...
export const longItemList: ToolbarButtonsItem[] = [
  { id: 1, label: "Aerospace" },
  { id: 2, label: "Mechanical" },
  { id: 3, label: "Civil" },
  { id: 4, label: "Biomedical" },
...
export const itemListWithIcons: ToolbarButtonsItem[] = [
