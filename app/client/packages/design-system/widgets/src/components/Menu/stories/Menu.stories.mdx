...
import ScissorsCutFillIcon from "remixicon-react/ScissorsCutFillIcon";
...
<Story name="Icon">
  <Menu>
    <Button>My trigger</Button>
    <MenuList disabledKeys={["cut"]}>
      <Item key="copy" icon={FileCopyLineIcon}>
        Copy
      </Item>
      <Item key="cut" icon={ScissorsCutFillIcon}>
        Cut
      </Item>
      <Item
        key="delete"
