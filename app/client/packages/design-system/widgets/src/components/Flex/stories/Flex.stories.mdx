...
export const Template = (args) => (
  <Flex {...args}>
    <div className={styles["demo-block"]} data-variant="negative" />
    <div className={styles["demo-block"]} data-variant="positive" />
    <div className={styles["demo-block"]} data-variant="warning" />
  </Flex>
);
...
<Story name="Nesting">
  <Flex direction="column" gap="spacing-2" width="100%">
    <div className={styles["demo-block"]} data-variant="accent" />
