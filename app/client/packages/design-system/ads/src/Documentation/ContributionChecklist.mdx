...
\<Checkbox>
  Identify the number of places the component will be used. The proposed
  component is more likely to be picked up if it is used across multiple
  contexts in the platform, or more than three discrete times in the same
  context.
</Checkbox>\<Checkbox>
...
</Checkbox>\<Checkbox>The component is created</Checkbox>
<div
  style={{
    paddingLeft: "12px",
    display: "flex",
