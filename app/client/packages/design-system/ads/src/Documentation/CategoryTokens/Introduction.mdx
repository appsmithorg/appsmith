...
<Meta title="Docs/Category Tokens/Introduction" name="Introduction" />
...
*```atom-category-component-kind-surface-state-presenational_attribute```*
...
<table>
  ...
  <tr>
    ...
    <td>Indicates the presenational attribute of the component (background, foreground, border etc).</td>
  </tr>
</table>
**Example:**
\
