...
- *Small*: Compact design for limited space. Use icons that are simple and easily recognizable.
- *Medium*: Balanced between space and usability. Use clear icons that maintain clarity when scaled down.
- *Large*: Prominent for easy interaction. You may use detailed icons for clear representation.
