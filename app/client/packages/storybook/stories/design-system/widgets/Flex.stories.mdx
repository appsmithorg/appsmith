...
export const StyledResponsivePositiveBlock = styled(StyledResponsiveBlock)`
  background: var(--color-bg-positive);
`;

export const StyledResponsiveNeutralBlock = styled(StyledResponsiveBlock)`
  background: var(--color-bg-neutral);
`;

export const StyledResponsiveNegativeBlock = styled(StyledResponsiveBlock)`
  background: var(--color-bg-negative);
`;

export const StyledResponsiveAccentBlock = styled(StyledResponsiveBlock)`
  background: var(--color-bg-accent);
`;
...
<Story name="Auto layout">
  <Flex isContainer width="100%" direction="column" gap="spacing-4">
    <Flex wrap gap="spacing-4">
      <Flex
        flex="1"
        width="25%"
        minWidth={{
