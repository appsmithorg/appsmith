...
public class DataTypeStringUtilsTest {
    ...
    public void checkDateDataType() {
        ...
        AppsmithType appsmithType =
                DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, date);
        DataType dataType = appsmithType.type();
    ...
    public void checkNullDataType() {
        ...
        AppsmithType appsmithType =
                DataTypeServiceUtils.getAppsmithType(ClientDataType.NULL, nullData);
        DataType dataType = appsmithType.type();
    ...
    public void testJsonStrictParsing() {
        ...
        assertThat(DataType.STRING)
                .isEqualByComparingTo(
                        DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "Abracadabra")
                                .type());
        ...
        assertThat(DataType.STRING)
                .isEqualByComparingTo(
                        DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "\"literal\"")
                                .type());
        ...
        assertThat(DataType.STRING)
                .isEqualByComparingTo(
                        DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "{\"a\": str}")
                                .type());
        ...
        assertThat(DataType.STRING)
                .isEqualByComparingTo(
                        DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "{\"a\" = 13}")
                                .type());
        assertThat(DataType.STRING)
                .isEqualByComparingTo(
                        DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "{\"a\" => 13}")
        ...
        assertThat(DataType.STRING)
                .isEqualByComparingTo(
                        DataTypeServiceUtils.getAppsmithType(
                                        ClientDataType.STRING, "{\"a\": 1; \"b\": 2}")
                                .type());

        assertThat(DataType.STRING)
                .isEqualByComparingTo(
                        DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "{\"a\": }")
                                .type());
        assertThat(DataType.STRING)
                .isEqualByComparingTo(
                        DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "{\"a\": ,}")
        ...
        assertThat(DataType.JSON_OBJECT)
                .isEqualByComparingTo(
                        DataTypeServiceUtils.getAppsmithType(ClientDataType.OBJECT, "{\"a\": 0}")
                                .type());
        assertThat(DataType.JSON_OBJECT)
                .isEqualByComparingTo(
                        DataTypeServiceUtils.getAppsmithType(ClientDataType.OBJECT, "{\"a\": \"\"}")
                                .type());
        assertThat(DataType.JSON_OBJECT)
                .isEqualByComparingTo(
                        DataTypeServiceUtils.getAppsmithType(ClientDataType.OBJECT, "{\"a\": []}")
    ...
    public void testGetDisplayDataTypes_withNestedObjectsInList_returnsWithTable() {
        ...
        assertThat(displayDataTypes)
                .anyMatch(
                        parsedDataType ->
                                parsedDataType.getDataType().equals(DisplayDataType.TABLE));
    }
