...
public void checkTimeStampDataType() {
	...
	AppsmithType appsmithType =
		DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, timestamp);
...
public void checkBooleanDataType() {
	...
	AppsmithType appsmithType =
		DataTypeServiceUtils.getAppsmithType(ClientDataType.BOOLEAN, boolInput);
	DataType dataType = appsmithType.type();
...
public void checkStringDataType() {
	// Starting the string with number because earlier this was incorrectly being identified as
	// JSON.
	String stringData =
		"2.1 In order to understand recursion, one must first understand recursion. -Anonymous";
	AppsmithType appsmithType =
		DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, stringData);
	DataType dataType = appsmithType.type();
...
public void checkIntegerDataType() {
	String intData = "1234";
	AppsmithType appsmithType =
		DataTypeServiceUtils.getAppsmithType(ClientDataType.NUMBER, intData);
	DataType dataType = appsmithType.type();
...
public void checkSimpleArrayDataType() {
	...
	AppsmithType appsmithType =
		DataTypeServiceUtils.getAppsmithType(ClientDataType.ARRAY, arrayData);
	DataType dataType = appsmithType.type();
...
public void checkJsonDataType() {
	String jsonData = "{\n" + "  \"key1\": \"value\"\n" + "}";
	AppsmithType appsmithType =
		DataTypeServiceUtils.getAppsmithType(ClientDataType.OBJECT, jsonData);
	DataType dataType = appsmithType.type();
...
public void testJsonStrictParsing() {
	...
	assertThat(DataType.STRING)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "){}").type());
	assertThat(DataType.STRING)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "]{}").type());
	assertThat(DataType.STRING)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "}{}").type());
	// Top-level values of any type. With strict parsing, the top-level value must be an object or
	// an array.
	assertThat(DataType.STRING)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "").type());
	assertThat(DataType.NULL)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.NULL, "null").type());
	assertThat(DataType.STRING)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "Abracadabra").type());
	assertThat(DataType.INTEGER)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.NUMBER, "13").type());
	assertThat(DataType.STRING)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "\"literal\"").type());

	// End of line comments starting with // or # and ending with a newline character.
	assertThat(DataType.STRING)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "{//comment\n}").type());
	assertThat(DataType.STRING)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "{#comment\n}").type());
	...
	assertThat(DataType.STRING)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "{/*comment*/}").type());

	// Strings that are unquoted or 'single quoted'.
	assertThat(DataType.STRING)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "{\"a\": str}").type());

	// Array elements separated by ; instead of ,.
	assertThat(DataType.STRING)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "{\"a\": [1;2]}").type());
	// Unnecessary array separators. These are interpreted as if null was the omitted value.

	// Names and values separated by = or => instead of :.
	assertThat(DataType.STRING)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "{\"a\" = 13}").type());
	assertThat(DataType.STRING)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "{\"a\" => 13}").type());
	...
	assertThat(DataType.STRING)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "{\"a\": }").type());
	assertThat(DataType.STRING)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.STRING, "{\"a\": ,}").type());
	...
	assertThat(DataType.JSON_OBJECT)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.OBJECT, "{} ").type());
	assertThat(DataType.JSON_OBJECT)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.OBJECT, "{\"a\": null} \n \n")
				.type());
	assertThat(DataType.JSON_OBJECT)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.OBJECT, "{\"a\": 0}").type());
	assertThat(DataType.JSON_OBJECT)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.OBJECT, "{\"a\": \"\"}").type());
	assertThat(DataType.JSON_OBJECT)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.OBJECT, "{\"a\": []}").type());
	assertThat(DataType.ARRAY)
		.isEqualByComparingTo(
			DataTypeServiceUtils.getAppsmithType(ClientDataType.ARRAY, "[]").type());
}
...
public void
	...
	final String replacedValue =
		jsonSmartReplacementPlaceholderWithValue(
