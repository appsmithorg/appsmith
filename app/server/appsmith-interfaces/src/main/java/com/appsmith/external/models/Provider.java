...
public class Provider extends BaseDomain {
    ...
    String credentialSteps; // How to generate/get the credentials to run the APIs which belong to
    // this provider
    ...
    /**
     * TODO : Once the marketplace is up, remove the default values from here. Let the Marketplace
     * handle the defaults.
     */
