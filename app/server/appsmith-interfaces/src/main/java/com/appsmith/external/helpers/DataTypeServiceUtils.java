...
public class DataTypeServiceUtils {
  ...
  /**
   * Identifies the AppsmithType from the given client-side data type and the evaluated value of the
   * parameter with the help of the default AppsmithTypes
   *
  ...
  /**
   * Identifies the AppsmithType from the given client-side data type and the evaluated value of the
   * parameter with the help of the provided plugin-specific types
   *
   * @param clientDataType the identified data type by the client-side
   * @param value the evaluated value of the binding parameter
   * @param pluginSpecificTypes a mapping of client-side data type and the server-side Appsmith
   *     types
   *     <p>A consumer of this function has to provide the pluginSpecificTypes in the following way
   *     <pre>{@code
