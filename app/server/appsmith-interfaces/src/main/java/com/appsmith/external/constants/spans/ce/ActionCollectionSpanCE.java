...
public class ActionCollectionSpanCE {
    ...
    public static final String GENERATE_ACTION_COLLECTION_BY_VIEW_MODE = APPSMITH_SPAN_PREFIX + "generate.actionCollectionByViewMode";
    public static final String POPULATE_ACTION_COLLECTION_BY_VIEW_MODE = APPSMITH_SPAN_PREFIX + "populate.actionCollectionByViewMode";
    public static final String SAVE_ACTION_COLLECTION_LAST_EDIT_INFO = APPSMITH_SPAN_PREFIX + "save.actionCollectionLastEditInfo";
