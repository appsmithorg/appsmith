...
public class DatasourceStructure {
    ...
    default int compareTo(Key other) {
      if (this instanceof PrimaryKey && other instanceof ForeignKey) {
        ...
        if (this instanceof ForeignKey && other instanceof PrimaryKey) {
          ...
          if (this instanceof PrimaryKey && other instanceof PrimaryKey) {
  ...
  public static class Column implements Comparable<Column> {
    ...
    String type;
    String defaultValue;
    // This field will be true for columns with auto-increment, default-expr with next value
    // method etc.
  ...
  public static class Template {
     ...
     *
     * <p>For integrations that use UQI interface, a config map is used to indicate the required
     * template.
     */
