...
public abstract class BasePluginErrorMessages {
    ...
    public static final String SSH_CONNECTION_FAILED_ERROR_MSG = "Failed to create SSH connection. Please check your datasource" +
            " configuration.";
    ...
    public static final String DS_INVALID_SSH_HOSTNAME_ERROR_MSG = "SSH host value cannot contain `/` or `:` " +
            "characters.";
}
