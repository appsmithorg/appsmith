...
public class Datasource extends BranchAwareDomain implements Forkable {
   ...
   * workspace to another. It creates a new object from the source datasource object Removes the id
   * and updated at from the object Based on forkWithConfiguration field present in the source app,
   * it sets the authentication for the datasource Returns the new datasource object
   */
  @Override
  public Datasource fork(Boolean forkWithConfiguration, String toWorkspaceId) {
    ...
    */
    ...
    boolean isConfigured =
        (newDs.getDatasourceConfiguration() != null
