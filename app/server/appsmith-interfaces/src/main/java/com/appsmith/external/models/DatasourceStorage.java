...
public class DatasourceStorage extends BaseDomain {
    ...
    @Transient String workspaceId;

    @Transient String templateName;

    @Transient Boolean isAutoGenerated;

    @Transient Boolean isRecentlyCreated;

    @Transient Boolean isTemplate;

    @Transient Boolean isMock;
