...
public interface CrudTemplateService {
     ...
     * table This generic implementation makes sure that CRUD generation for each plugin goes
     * through by default The guideline to follow to figure out if this implementation applies to
     * the plugin is: - The plugin follows pre-UQI data structure for queries - The plugin has a
     * datasource structure that is used to generate query templates
     *
                ...
                if (property.getKey() != null
                    ...
                    if (property.getValue() instanceof String) {
                        final String replacedValue =
                                replaceMappedColumnInStringValue(
                                        mappedColumns, property.getValue());
