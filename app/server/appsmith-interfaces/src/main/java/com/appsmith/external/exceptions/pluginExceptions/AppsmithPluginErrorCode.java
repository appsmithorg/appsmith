...
public enum AppsmithPluginErrorCode {
    ...
    JSON_PROCESSING_ERROR(
            "PE-JSN-4000", "JSON processing error either at serializing or deserializing"),
    ...
    PLUGIN_GET_STRUCTURE_TIMEOUT_ERROR(
            "PE-DSE-5001", "Timed out when fetching datasource structure"),
    PLUGIN_DATASOURCE_TEST_GENERIC_ERROR(
            "PE-DSE-5002", "Plugin failed to test with the given configuration"),
    PLUGIN_DATASOURCE_ARGUMENT_ERROR(
            "PE-DSE-5003", "One or more arguments in datasource configuration is invalid"),
