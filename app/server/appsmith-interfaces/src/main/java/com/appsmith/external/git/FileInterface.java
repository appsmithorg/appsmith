...
/**
* This method is use to store the serialised application to git repo, directory path structure we
* are going to follow :
...
*     <p>Application will be stored in the following structure : repo --Application
*     ----Datasource --datasource1Name --datasource2Name ----Actions (Only requirement here is
*     the filename should be unique) --action1_page1 --action2_page2 ----Pages --page1 --page2
*/
...
*/
Mono<Path> initializeReadme(Path baseRepoSuffix, String viewModeUrl, String editModeUrl)
	throws IOException;
