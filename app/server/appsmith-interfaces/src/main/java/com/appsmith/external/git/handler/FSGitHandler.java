package com.appsmith.external.git.handler;
...
/**
 * This class is a replica of gitExecutor, the methods would be re-evaluated as we will enter the git epic domain
 */
public interface FSGitHandler {
    ...
    Mono<GitLogDTO> getLastCommitDetails(Path suffix);
    ...
    Mono<List<GitRefDTO>> listBranches(Path repoSuffix);

    Mono<List<GitRefDTO>> listTags(Path repoSuffix);
    /**
     ...
     * @return created branch name
     */
    Mono<String> checkoutTag(Path repoSuffix, String tagName);
