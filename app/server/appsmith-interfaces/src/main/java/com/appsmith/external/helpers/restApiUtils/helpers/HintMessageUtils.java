...
protected static String HINT_MESSAGE_FOR_DUPLICATE_ATTRIBUTE_IN_DATASOURCE_CONFIG =
	"API queries linked to this datasource may not run as expected because this datasource has"
		+ " duplicate definition(s) for {0}(s): {1}. Please remove the duplicate definition(s) to"
		+ " resolve this warning. Please note that some of the authentication mechanisms also"
		+ " implicitly define a {0}.";
...
protected static String
	HINT_MESSAGE_FOR_DUPLICATE_ATTRIBUTE_IN_ACTION_DEFINED_IN_DATASOURCE_CONFIG =
		"Your API query may not run as expected because its datasource has duplicate"
			+ " definition(s) for {0}(s): {1}. Please remove the duplicate definition(s) from the"
			+ " datasource to resolve this warning.";

protected static String HINT_MESSAGE_FOR_DUPLICATE_ATTRIBUTE_IN_ACTION_CONFIG =
	"Your API query may not run as expected because it has duplicate definition(s) for {0}(s):"
		+ " {1}. Please remove the duplicate definition(s) from the ''{2}'' tab to resolve this"
		+ " warning.";
...
protected static String
	HINT_MESSAGE_FOR_DUPLICATE_ATTRIBUTE_WITH_INSTANCE_ACROSS_ACTION_AND_DATASOURCE_CONFIG =
		"Your API query may not run as expected because it has duplicate definition(s) for"
			+ " {0}(s): {1}. Please remove the duplicate definition(s) from the ''{2}'' section"
			+ " of either the API query or the datasource. Please note that some of the"
...
public Set<String> getDatasourceHintMessages(DatasourceConfiguration datasourceConfiguration) {
	...
	/**
	 * Get datasource specific hint message for duplicate headers. ActionConfiguration parameter is
	 * passed as `null` so that the hint message that gets generated is only relevant for the
	 * datasource.
	 */
	 ...
	 * parameter is passed as `null` so that the hint message that gets generated is only relevant
	 * for the datasource.
	 */
...
public Set<String> getActionHintMessages(
	 ...
	 * related hint messages - so that it can be displayed on the query editor page too. Same won't
	 * apply to other datasources - i.e. datasource attributes generally remain confined to the
	 * datasource.
	 */
	 ...
	 * configuration apart from the action configuration since an API inherits all the headers
	 * defined in its datasource.
	 */
	 ...
	 * datasource configuration apart from the action configuration since an API inherits all the
	 * params defined in its datasource.
	 */
