...
public class Condition {
    ...
    public static Boolean isValid(Condition condition) {
        ...
        if (condition == null
                || (StringUtils.isEmpty(condition.getPath())
    ...
    /**
     * To generate condition list based on selected condition Mandatory inputs validated are path
     * and operator Value is optional and considered as a null input
     *
