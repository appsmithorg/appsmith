...
public static void copyNestedNonNullProperties(Object source, Object target) {
	...
	// For properties like `class` that don't have a set method, we can't copy so we just ignore
	// them.
	...
	if (targetValue != null
		...
		// Go deeper *only* if the property belongs to Appsmith's models, and both the source and
		// target values
		// are not null.
