...
PLUGIN_QUERY_TIMEOUT_ERROR(
	...
	"{0} timed out in {1} milliseconds. Please increase timeout. This can be found in Settings"
		+ " tab of {0}.",
	AppsmithErrorAction.DEFAULT,
...
PLUGIN_DATASOURCE_TEST_GENERIC_ERROR(
	...
	"Plugin failed to test with the given configuration. Please reach out to Appsmith customer"
...
PLUGIN_UQI_WHERE_CONDITION_UNKNOWN(
	...
	"{0} is not a known conditional operator. Please reach out to Appsmith customer support to"
		+ " report this",
	AppsmithErrorAction.LOG_EXTERNALLY,
