...
public interface GitExecutor {
     ...
     * @return success message
     */
    Mono<MergeStatusDTO> pullApplication(Path repoPath, String remoteUrl, String branchName, String privateKey, String publicKey);

    /**
     * @param repoSuffix repo suffix path in local repo
     * @return List of branches for the application
     */
    Mono<List<GitBranchListDTO>> listBranches(Path repoSuffix, String defaultBranch);
