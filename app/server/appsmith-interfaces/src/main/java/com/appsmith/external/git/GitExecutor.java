...
public interface GitExecutor {
     ...
     *
     * @param repoSuffix Path used to generate the repo url specific to the application which needs to pushed to remote
     ...
     */
    Mono<String> pushApplication(Path repoSuffix, String remoteUrl, String publicKey, String privateKey, String branchName);
     ...
     * @param isChangeOnlyDueToMigration  check if only migration changes are present since last commit
     * @return Map of file names those are added, removed, modified
     */
    Mono<GitStatusDTO> getStatus(Path repoPath, String branchName, boolean isChangeOnlyDueToMigration);
