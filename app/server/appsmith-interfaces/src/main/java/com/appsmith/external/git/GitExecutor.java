...
public interface GitExecutor {
     ...
     *
     * @param suffix suffixedPath used to generate the base repo path this includes orgId,
     *     defaultAppId, repoName
     ...
     *
     * @param branchSuffix Path used to generate the repo url specific to the application which
     *     needs to pushed to remote
     ...
     *
     * @param repoSuffix suffixedPath used to generate the base repo path this includes orgId,
     *     defaultAppId, repoName
     ...
     *     defaultAppId, repoName
     * @param remoteUrl ssh url of the git repo(we support cloning via ssh url only with deploy key)
     * @param branchName remoteBranchName from which commits will be fetched and merged to the
     *     current branch
     * @param privateKey generated by us and specific to the defaultApplication
     * @param publicKey generated by us and specific to the defaultApplication
     * @return success message
     ...
     * @param repoSuffix suffixedPath used to generate the base repo path this includes orgId,
     *     defaultAppId, repoName
     * @param sourceBranch name of the branch whose commits will be referred amd merged to
     *     destinationBranch
     ...
     *     destinationBranch
     * @param destinationBranch Merge operation is performed on this branch
     * @return Whether the two branches can be merged or not with list of files where the conflicts
     *     are present
     */
     ...
     * @throws IOException
     */
    Mono<Boolean> resetToLastCommit(Path repoSuffix, String branchName)
