...
public class HeaderUtils {
  ...
  /**
   * If the headers list of properties contains a `Content-Type` header, verify if the value of that
   * header is a valid media type.
   *
    ...
    if (!isEmpty(datasourceConfiguration.getProperties())) {
      ...
      for (Property property : datasourceConfiguration.getProperties()) {
        if (IS_SEND_SESSION_ENABLED_KEY.equals(property.getKey())) {
          ...
          if (SESSION_SIGNATURE_KEY_KEY.equals(property.getKey())) {
