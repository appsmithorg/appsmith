...
public class HeaderUtils {
    ...
    public void setContentTypeHeader(ActionConfiguration actionConfiguration){
        ...
        if(actionConfiguration.getHeaders() == null){
            //fetching the auto generated content type header
            String autoGeneratedContentTypeHeader = getRequestContentTypeFromHeaders(
                    actionConfiguration.getAutoGeneratedHeaders());

            actionConfiguration.setHeaders(List.of(new Property(HttpHeaders.CONTENT_TYPE
                    ,autoGeneratedContentTypeHeader)));
            return;
        }

        if(!actionConfiguration.getHeaders().stream().filter(s -> s.getKey().
    ...
    private boolean isHeaderPresent(List<Property> headers,String headerName){
