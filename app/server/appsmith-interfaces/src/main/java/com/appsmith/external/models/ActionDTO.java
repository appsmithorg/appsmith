...
public class ActionDTO implements Identifiable {
    ...
    /**
     * If the Datasource is null, create one and set the autoGenerated flag to true. This is
     * required because spring-data cannot add the createdAt and updatedAt properties for null
     * embedded objects. At this juncture, we couldn't find a way to disable the auditing for nested
     * objects.
     *
     * @return
     */
