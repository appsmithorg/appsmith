...
public class ActionDTO {
  ...
  // The FQN for an action will also include any collection it is a part of as
  ...
  // This is a list of keys that the client whose values the client needs to send during action
  // execution.
  ...
  // This field will be used to store the default/root actionId and applicationId for actions
  // generated for git
  ...
  /**
   * If the Datasource is null, create one and set the autoGenerated flag to true. This is required
   * because spring-data cannot add the createdAt and updatedAt properties for null embedded
   * objects. At this juncture, we couldn't find a way to disable the auditing for nested objects.
   *
   * @return
   */
  @JsonView(Views.Public.class)
