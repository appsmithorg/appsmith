...
public class GitConstants {
  ...
  // pageName{{seperator}}entityName this is needed to filter the entities to save in appropriate
  // page directory
  ...
  public static final String EMPTY_COMMIT_ERROR_MESSAGE =
  ...
  public static final String CONFLICTED_SUCCESS_MESSAGE =
      "branch has been created from conflicted state. Please "
  ...
  public static final String GIT_PROFILE_ERROR =
      "Unable to find git author configuration for logged-in user. You can"
