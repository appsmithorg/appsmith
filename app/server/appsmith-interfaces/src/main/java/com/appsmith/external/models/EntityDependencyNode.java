...
public boolean isValidDynamicBinding() {
	...
	if (Boolean.FALSE.equals(this.isAsync)) {
		if (Boolean.TRUE.equals(this.isFunctionCall)
			&& !this.validEntityName.equals(this.referenceString)) {
		result = false;
		}
	...
	// TODO: This one feels a little hacky. Should we introduce another property that handles
	// whether the node is coming from a binding or i
