...
public enum AppsmithPluginError {
    ...
    PLUGIN_TIMEOUT_ERROR(500, 5002, "Plugin execution for query \"{0}\" timed out in {1}ms. Please increase timeout duration in your action settings or check your backend action endpoint."),
    ;
