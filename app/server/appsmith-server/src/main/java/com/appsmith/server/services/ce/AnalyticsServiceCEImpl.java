...
public class AnalyticsServiceCEImpl implements AnalyticsServiceCE {
        ...
        IdentifyMessage.builder()
            ...
            .traits(
                Map.of(
                    "isInstance",
                    true,
                    // Is this "identify" data-point for a user or an instance?
                    ROLE,
        ...
        .map(
            tuple -> {
              ...
              if (FieldName.ANONYMOUS_USER.equals(finalUserId)) {
                userIdToSend =
                    StringUtils.defaultIfEmpty(userIdFromClient, FieldName.ANONYMOUS_USER);
              }
  ...
  public <T extends BaseDomain> Mono<T> sendObjectEvent(
        ...
        .flatMap(
            tuple -> {
              ...
              boolean isEventActionExecution =
                  object instanceof NewAction && event == AnalyticsEvents.EXECUTE_ACTION;
              ...
              final String username =
                  (object instanceof User objectAsUser ? objectAsUser : user).getUsername();
              ...
              if (analyticsProperties.containsKey(FieldName.CLOUD_HOSTED_EXTRA_PROPS)) {
                if (commonConfig.isCloudHosting()) {
                  Map<String, Object> extraPropsForCloudHostedInstance =
                      (Map<String, Object>)
                          analyticsProperties.get(FieldName.CLOUD_HOSTED_EXTRA_PROPS);
