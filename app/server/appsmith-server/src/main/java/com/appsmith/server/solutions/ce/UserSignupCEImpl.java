        ...
        userService
            ...
            .flatMap(
                user -> {
                  ...
                  Mono<Long> installationSetupAnalyticsMono =
                      Mono.zip(getInstanceIdMono, getExternalAddressMono)
                          .flatMap(
                              tuple -> {
                                ...
                                // ip is a reserved keyword for
                                // tracking events in Mixpanel
                                // though this is allowed in
                                // Segment. Instead of showing the
                                // ip as is Mixpanel provides
                                // derived property.
                                // As we want derived props
                                // alongwith the ip address we are
                                // sharing the ip
