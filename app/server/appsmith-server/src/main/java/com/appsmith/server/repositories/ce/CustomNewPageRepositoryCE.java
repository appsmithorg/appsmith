...
public interface CustomNewPageRepositoryCE extends AppsmithRepository<NewPage> {
    ...
    Optional<NewPage> findByNameAndViewMode(
    ...
    List<NewPage> findAllPageDTOsByIds(
