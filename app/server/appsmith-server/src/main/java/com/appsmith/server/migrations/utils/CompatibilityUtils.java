...
/**
* This method checks for whether the noCursorTimeout can be applied on this instance of MongoDB,
* and returns the correct query accordingly.
*
* @param mongoTemplate Meant to share the bean with this utility
* @param originalQuery The original idempotent query to be run without optimization, idempotency
*     is a must
...
public static <T extends BaseDomain> Query optimizeQueryForNoCursorTimeout(
	...
	Query queryBatchedPerformantLimit1 = Query.of(queryBatchedPerformant).limit(1);
