...
@ChangeUnit(
        ...
        author = "")
public class Migration114EEUpdatePolicyForUserMissedDuringSuperUserCreationReadDeletePermission {

    private final MongoTemplate mongoTemplate;

    public Migration114EEUpdatePolicyForUserMissedDuringSuperUserCreationReadDeletePermission(
