...
public class UrlCE {
    ...
    final public static String ENVIRONMENT_URL = BASE_URL + VERSION + "/environments";
    final public static String ENVIRONMENT_VARIABLE_URL = BASE_URL + VERSION + "/environment-variables";
