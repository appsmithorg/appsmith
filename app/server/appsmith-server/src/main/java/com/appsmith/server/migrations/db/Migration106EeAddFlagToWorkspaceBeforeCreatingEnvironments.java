...
public class Migration106EeAddFlagToWorkspaceBeforeCreatingEnvironments {
    ...
    public void executeMigration() {
        ...
        mongoTemplate.updateMulti(new Query().addCriteria(notDeletedAndNotNullDefaultPermissionGroupCriteria()),
                new Update().set(migrationFlag, false),
                Workspace.class);
    }

    public static Criteria notDeletedAndNotNullDefaultPermissionGroupCriteria() {
