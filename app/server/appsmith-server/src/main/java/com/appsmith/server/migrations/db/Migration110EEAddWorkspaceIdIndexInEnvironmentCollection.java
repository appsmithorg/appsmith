...
@ChangeUnit(order = "110-ee", id = "add-ws-id-index-to-environment")
public class Migration110EEAddWorkspaceIdIndexInEnvironmentCollection {

    private final MongoTemplate mongoTemplate;

    private static final String workspaceIdIndexName = "environment_wsId_deleted_deletedAt";

    public Migration110EEAddWorkspaceIdIndexInEnvironmentCollection(MongoTemplate mongoTemplate) {
