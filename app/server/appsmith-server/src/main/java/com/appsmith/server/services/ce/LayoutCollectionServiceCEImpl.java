...
public class LayoutCollectionServiceCEImpl implements LayoutCollectionServiceCE {
            ...
            tuple -> {
              ...
              final Map<String, String> actionIds =
                  actions.stream()
                      .collect(
                          toMap(
                              actionDTO -> actionDTO.getDefaultResources().getActionId(),
                              ActionDTO::getId));
                        ...
                        actions.forEach(
                            actionDTO -> {
                              ...
                              if (StringUtils.isEmpty(
                                ...
                                actionDTO
                                    .getDefaultResources()
                                    .setCollectionId(actionCollection1.getId());
                              }
                            });
                        return actions;
                      })
        ...
        .flatMap(
            branchedActionCollection -> {
              ...
              if (branchedActionCollection.getDefaultToBranchedArchivedActionIdsMap() != null) {
                actionIds.putAll(
                    branchedActionCollection.getDefaultToBranchedArchivedActionIdsMap());
              }
        ...
        .flatMap(
            tuple -> {
              ...
              return actionUpdatesFlux
                  ...
                  .flatMap(
                      actionDTOs ->
                          actionCollectionService.update(collectionId, actionCollectionDTO))
                      ...
                      page -> {
                        ...
                        return Flux.fromIterable(page.getLayouts())
                            .flatMap(
                                layout -> {
                                  layout.setDsl(
                                      layoutActionService.unescapeMongoSpecialCharacters(layout));
  ...
  public Mono<ActionCollectionDTO> updateUnpublishedActionCollection(
                    ...
                    .flatMap(
                        actionDTO -> {
                          ...
                          if (actionDTO.getId() == null) {
                            ...
                            actionDTO
                                .getDatasource()
                                .setWorkspaceId(actionCollectionDTO.getWorkspaceId());
                            actionDTO
                                .getDatasource()
                                .setPluginId(actionCollectionDTO.getPluginId());
                            ...
                            return branchedActionIdMono.flatMap(
                                actionId ->
                                    layoutActionService.updateSingleAction(actionId, actionDTO));
                          }
                        })
                    .collect(
                        toMap(
    ...
    return branchedActionCollectionMono
        ...
        .flatMap(
            actionCollection ->
                actionCollectionService.update(actionCollection.getId(), actionCollection))
        .flatMap(actionCollectionRepository::setUserPermissionsInObject)
        .flatMap(
            savedActionCollection ->
                layoutActionService
        ...
        .flatMap(
            savedActionCollection ->
                analyticsService.sendUpdateEvent(
                    savedActionCollection,
                    actionCollectionService.getAnalyticsProperties(savedActionCollection)))
        .flatMap(
            actionCollection ->
                actionCollectionService
                    .generateActionCollectionByViewMode(actionCollection, false)
            ...
            (branchedActionCollection, newPage) -> {
              ...
              if (newPage.getUnpublishedPage().getLayouts().size() > 0) {
                ...
                branchedActionCollection.setErrorReports(
                    newPage.getUnpublishedPage().getLayouts().get(0).getLayoutOnLoadActionErrors());
              }
