...
public static String extractConflictingObjectName(String duplicateKeyErrorMessage) {
	...
	log.warn(
		"DuplicateKeyException regex needs attention. It's unable to extract object name from the"
			+ " error message. Possible reason: the underlying library may have changed the format"
