...
public class NewPageImportableServiceImpl extends NewPageImportableServiceCEImpl implements ImportableService<NewPage> {
    public NewPageImportableServiceImpl(
            NewPageService newPageService, ApplicationPageService applicationPageService, ActionService actionService) {
        super(newPageService, applicationPageService, actionService);
    }
}
