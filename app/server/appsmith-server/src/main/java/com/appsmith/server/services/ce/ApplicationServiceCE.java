...
public interface ApplicationServiceCE extends CrudService<Application, String> {
    ...
    Mono<Application> findByIdAndBranchName(
    ...
    Mono<Application> findByIdAndWorkspaceId(
    ...
    Flux<Application> findAllApplicationsByDefaultApplicationId(
    ...
    Mono<Application> getApplicationByDefaultApplicationIdAndDefaultBranch(
            String defaultApplicationId);

    Mono<Application> findByIdAndExportWithConfiguration(
    ...
    Mono<Application> findByNameAndWorkspaceId(
