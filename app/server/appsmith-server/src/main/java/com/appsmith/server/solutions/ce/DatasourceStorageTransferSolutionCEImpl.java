...
@Slf4j
public class DatasourceStorageTransferSolutionCEImpl
        implements DatasourceStorageTransferSolutionCE {
    ...
    @Override
    public DatasourceStorage initializeDatasourceStorage(
    ...
    @Transactional
    @Override
    public Mono<DatasourceStorage> transferAndGetDatasourceStorage(
            Datasource datasource, String environmentId) {
        return this.transferDatasourceStorage(datasource, environmentId);
    }

    @NotNull private Mono<DatasourceStorage> transferDatasourceStorage(
            Datasource datasource, String environmentId) {
        final DatasourceStorage datasourceStorage =
                this.initializeDatasourceStorage(datasource, environmentId);
    ...
    @Transactional
    @Override
    public Mono<DatasourceStorage> transferToFallbackEnvironmentAndGetDatasourceStorage(
