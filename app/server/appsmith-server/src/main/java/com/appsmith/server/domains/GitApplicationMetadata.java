...
// Git branch corresponding to this application, we have one to one mapping for application in DB
// with git-branch
...
// Git credentials used to push changes to remote repo and will be stored with default application
// only to optimise
