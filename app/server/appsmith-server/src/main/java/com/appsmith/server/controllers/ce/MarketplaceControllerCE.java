...
public class MarketplaceControllerCE {
    ...
    public MarketplaceControllerCE(
            ObjectMapper objectMapper, MarketplaceService marketplaceService) {
    ...
    Mono<ResponseDTO<SearchResponseDTO>> searchAPIOrProviders(
        ...
        return marketplaceService
                .searchProviderByName(searchKey)
                .map(
                        result -> {
                            SearchResponseDTO searchResponseDTO = new SearchResponseDTO();
                            searchResponseDTO.setProviders(result);
                            return new ResponseDTO<>(
                                    HttpStatus.OK.value(), searchResponseDTO, null);
                        });
    }
