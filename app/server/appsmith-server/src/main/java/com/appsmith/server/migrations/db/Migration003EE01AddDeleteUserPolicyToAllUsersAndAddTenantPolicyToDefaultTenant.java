...
@ChangeUnit(
        order = "003-ee-01",
        id = "migration-add-delete-user-policy-to-all-users-add-tenant-policy-to-default-tenant")
public class Migration003EE01AddDeleteUserPolicyToAllUsersAndAddTenantPolicyToDefaultTenant {
    private final PolicySolution policySolution;
    private final MongoTemplate mongoTemplate;

    public Migration003EE01AddDeleteUserPolicyToAllUsersAndAddTenantPolicyToDefaultTenant(
