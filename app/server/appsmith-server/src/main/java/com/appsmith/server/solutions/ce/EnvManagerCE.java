...
public interface EnvManagerCE {
    ...
    Mono<Void> applyChanges(Map<String, String> changes, String origin);

    Mono<Void> applyChangesFromMultipartFormData(MultiValueMap<String, Part> formData, String origin);
