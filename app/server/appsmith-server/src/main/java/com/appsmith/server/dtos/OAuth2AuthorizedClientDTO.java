...
public class OAuth2AuthorizedClientDTO {
    ...
    public static OAuth2AuthorizedClientDTO fromOAuth2AuthorizedClient(
    ...
    public OAuth2AuthorizedClient makeOAuth2AuthorizedClient() {
        ...
        if (OAuth2AccessToken.TokenType.BEARER.getValue().equals(accessToken.tokenType)) {
            ...
            throw new IllegalArgumentException(
                    "Could not deserialize OAuth2AuthorizedClient, unknown token type: "
        ...
        return new OAuth2AuthorizedClient(
                ClientRegistration.withRegistrationId(clientRegistration.registrationId)
                        ...
                        // TODO: Don't recreate this object, use one of the static constants already
                        // in that class.
                        .clientAuthenticationMethod(
                                new ClientAuthenticationMethod(
                                        clientRegistration.clientAuthenticationMethod))
                        // TODO: Don't recreate this object, use one of the static constants already
                        // in that class.
                        ...
                        .userInfoAuthenticationMethod(
                                new AuthenticationMethod(
                                        clientRegistration.userInfoAuthenticationMethod))
