    ...
    public Mono<Layout> createLayout(String pageId, Layout layout) {
        ...
        return pageMono.map(
                        page -> {
                            ...
                            // Adding an Id to the layout to ensure that a layout can be referred to
                            // by its ID as well.
    ...
    public Mono<Layout> getLayout(String pageId, String layoutId, Boolean viewMode) {
        return newPageService
                .findByIdAndLayoutsId(
                        pageId, layoutId, pagePermission.getReadPermission(), viewMode)
                .switchIfEmpty(
                        Mono.error(
                                new AppsmithException(
                                        AppsmithError.INVALID_PARAMETER,
