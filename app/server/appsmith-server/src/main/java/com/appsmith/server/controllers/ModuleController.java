...
public class ModuleController {
    ...
    @JsonView(Views.Public.class)
    @PutMapping("/refactor")
    public Mono<ResponseDTO<ModuleDTO>> refactorModuleName(
        ...
        return crudModuleService
                .updateModuleName(refactorEntityNameDTO, refactorEntityNameDTO.getModuleId(), branchName)
                .map(updatedModule -> new ResponseDTO<>(HttpStatus.OK.value(), updatedModule, null));
    }
}
