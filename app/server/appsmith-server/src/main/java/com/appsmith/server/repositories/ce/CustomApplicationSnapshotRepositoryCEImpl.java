...
public class CustomApplicationSnapshotRepositoryCEImpl
        extends BaseAppsmithRepositoryImpl<ApplicationSnapshot>
    ...
    public Mono<ApplicationSnapshot> findWithoutData(String applicationId) {
        ...
        criteriaList.add(
                Criteria.where(fieldName(QApplicationSnapshot.applicationSnapshot.applicationId))
                        .is(applicationId));
        criteriaList.add(
                Criteria.where(fieldName(QApplicationSnapshot.applicationSnapshot.chunkOrder))
                        .is(1));
