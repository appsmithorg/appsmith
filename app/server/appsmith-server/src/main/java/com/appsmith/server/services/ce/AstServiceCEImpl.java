...
public Flux<Tuple2<String, Set<String>>> getPossibleReferencesFromDynamicBinding(
	...
	*/
	...
	// If RTS server is not accessible for this instance, it means that this is a slim container set
	// up
			...
			return webClient
				...
				.onErrorResume(
					error -> {
						...
						// If there is a problem with parsing and refactoring this binding, we just
