...
public class ImportExportUtils {
  ...
  /**
   * Method to provide non-cryptic and user-friendly error message with actionable input for
   * Import-Export flows
   *
  ...
  public static String getErrorMessage(Throwable throwable) {
    ...
    // TODO provide actionable insights for different error messages generated from
    // import-export flow
    // Filter out transactional error as these are cryptic and don't provide much info on the
    // error
