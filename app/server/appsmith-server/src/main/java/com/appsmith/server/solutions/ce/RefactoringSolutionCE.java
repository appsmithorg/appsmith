...
Mono<LayoutDTO> refactorActionName(
...
/**
* This method is responsible for the core logic of refactoring a valid name inside an Appsmith
* page. This includes refactoring inside the DSL, in actions, and JS objects.
*
...
* @return A tuple of the updated layout after refactoring and a set of all the paths in the page
*     that ended up getting refactored
*/
Mono<Tuple2<LayoutDTO, Set<String>>> refactorName(
