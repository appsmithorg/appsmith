...
@GetMapping("")
public Mono<ResponseDTO<List<ItemDTO>>> getAll(
...
public Mono<ResponseDTO<ActionDTO>> addItemToPage(
	@RequestBody AddItemToPageDTO addItemToPageDTO) {
	log.debug(
	...
	return service
		.addItemToPage(addItemToPageDTO)
