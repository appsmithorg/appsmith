...
@Component
public class UsagePulseRepositoryCake extends BaseCake<UsagePulse, UsagePulseRepository> {
    private final UsagePulseRepository repository;

    public UsagePulseRepositoryCake(UsagePulseRepository repository) {
        super(repository);
        this.repository = repository;
    }

    public QueryAllParams<UsagePulse> queryBuilder() {
        return repository.queryBuilder();
    }

    // From CrudRepository
    public Flux<UsagePulse> saveAll(Iterable<UsagePulse> entities) {
    ...
    public Mono<Void> bulkInsert(UsagePulseRepositoryCake baseRepository, List<UsagePulse> domainList) {
    ...
    public Mono<UsagePulse> findById(String id, AclPermission permission) {
    ...
    public Mono<UsagePulse> getById(String id) {
    ...
    public Mono<UsagePulse> setUserPermissionsInObject(UsagePulse obj, User user) {
    ...
    public Mono<UsagePulse> setUserPermissionsInObject(UsagePulse obj, java.util.Collection<String> permissionGroups) {
    ...
    public Mono<UsagePulse> updateAndReturn(String id, BridgeUpdate updateObj, AclPermission permission) {
    ...
    public Mono<UsagePulse> updateById(String id, UsagePulse resource, AclPermission permission) {
        return ReactiveContextUtils.getCurrentUser()
