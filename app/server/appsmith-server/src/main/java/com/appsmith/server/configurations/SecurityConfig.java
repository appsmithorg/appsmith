...
public class SecurityConfig {
    ...
    @Autowired private ServerAuthenticationSuccessHandler authenticationSuccessHandler;

    @Autowired private ServerAuthenticationFailureHandler authenticationFailureHandler;

    @Autowired private ServerAuthenticationEntryPoint authenticationEntryPoint;
    ...
    @Autowired private RedirectHelper redirectHelper;

    /**
     * This routerFunction is required to map /public/** endpoints to the src/main/resources/public
     * folder This is to allow static resources to be served by the server. Couldn't find an easier
     * way to do this, hence using RouterFunctions to implement this feature.
     *
     * <p>Future folks: Please check out links: -
     ...
     * - Class ResourceHandlerRegistry for details. If you figure out a cleaner approach, please
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        ...
        return http
                // The native CSRF solution doesn't work with WebFlux, yet, but only for WebMVC. So
                // we make our own.
                .csrf()
                .disable()
                ...
                .matchers(
                        ...
                        ServerWebExchangeMatchers.pathMatchers(
                                HttpMethod.POST, USER_URL + "/super"),
                        ServerWebExchangeMatchers.pathMatchers(
                                HttpMethod.POST, USER_URL + "/forgotPassword"),
                        ServerWebExchangeMatchers.pathMatchers(
                                HttpMethod.GET, USER_URL + "/verifyPasswordResetToken"),
                        ServerWebExchangeMatchers.pathMatchers(
                                HttpMethod.PUT, USER_URL + "/resetPassword"),
                        ServerWebExchangeMatchers.pathMatchers(
                                HttpMethod.GET, USER_URL + "/invite/verify"),
                        ServerWebExchangeMatchers.pathMatchers(
                                HttpMethod.PUT, USER_URL + "/invite/confirm"),
                        ServerWebExchangeMatchers.pathMatchers(HttpMethod.GET, USER_URL + "/me"),
                        ServerWebExchangeMatchers.pathMatchers(
                                HttpMethod.GET, USER_URL + "/features"),
                ...
                .and()
                .httpBasic(
                        httpBasicSpec -> httpBasicSpec.authenticationFailureHandler(failureHandler))
                .formLogin(
                        formLoginSpec ->
                                formLoginSpec
                        ...
                        oAuth2LoginSpec ->
                                oAuth2LoginSpec
                                        ...
                                        .authorizationRequestResolver(
                                                new CustomServerOAuth2AuthorizationRequestResolver(
    ...
    /**
     * This bean configures the parameters that need to be set when a Cookie is created for a logged
     * in user
     *
     * @return
     */
    ...
    public WebSessionIdResolver webSessionIdResolver() {
        ...
        // If the max age is not set, some browsers will default to deleting the cookies on session
        // close.
