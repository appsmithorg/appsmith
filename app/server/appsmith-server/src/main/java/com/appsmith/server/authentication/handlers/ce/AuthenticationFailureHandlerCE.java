...
public Mono<Void> onAuthenticationFailure(
	...
	// On authentication failure, we send a redirect to the client's login error page. The browser
	// will re-load the
	...
	// This is valid for OAuth2 login failures. We derive the client login URL from the state
	// query parameter
