...
public class GitFileUtils {
   ...
   * be : ./container-volumes/git-repo/workspaceId/defaultApplicationId/repoName/{application_data}
   *
  ...
  public Mono<Path> saveApplicationToLocalRepo(
    ...
    */
    Stopwatch stopwatch =
        new Stopwatch(AnalyticsEvents.GIT_SERIALIZE_APP_RESOURCES_TO_LOCAL_FILE.getEventName());
    ...
    applicationJson.getActionList().stream()
        ...
        .forEach(
            newAction -> {
              ...
              String body =
                  newAction.getUnpublishedAction().getActionConfiguration().getBody() != null
                      ? newAction.getUnpublishedAction().getActionConfiguration().getBody()
                      : "";
  ...
  public Mono<ApplicationJson> reconstructApplicationJsonFromGitRepo(
    ...
    Stopwatch stopwatch =
        new Stopwatch(AnalyticsEvents.GIT_DESERIALIZE_APP_RESOURCES_FROM_FILE.getEventName());
  ...
  public Mono<Path> initializeReadme(Path baseRepoSuffix, String viewModeUrl, String editModeUrl)
    ...
    return fileUtils
        ...
        .onErrorResume(
            e -> Mono.error(new AppsmithException(AppsmithError.GIT_FILE_SYSTEM_ERROR, e)));
  }
  ...
  private ApplicationJson getApplicationJsonFromGitReference(
          ...
          .forEach(
              applicationPage ->
                  applicationPages.add(
                      gson.fromJson(gson.toJson(applicationPage), ApplicationPage.class)));
    ...
    pages.forEach(
        newPage -> {
          ...
          newPage.setPublishedPage(
              gson.fromJson(gson.toJson(newPage.getUnpublishedPage()), PageDTO.class));
        });
    ...
    applicationJson.setDatasourceList(
        getApplicationResource(applicationReference.getDatasources(), Datasource.class));
