...
@ChangeUnit(order = "020-ee-01", id = "update-default-appsmith-logo-asset", author = "")
@RequiredArgsConstructor
@Slf4j
public class Migration020EE01UpdateDefaultAppsmithLogo {
    ...
    public void updateDefaultLogoAsset() {
        ...
        query.addCriteria(Criteria.where(Tenant.Fields.tenantConfiguration).exists(true));
