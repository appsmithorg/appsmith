...
/**
* Used to check if a particular feature is enabled for a given user. Useful in contexts where we
* already have the User object and simply wish to do a boolean check
*
* @param featureEnum
* @param user
* @return Boolean
