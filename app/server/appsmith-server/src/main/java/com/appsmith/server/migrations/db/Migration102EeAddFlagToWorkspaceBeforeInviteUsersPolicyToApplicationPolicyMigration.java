...
@ChangeUnit(
        order = "102-EE",
        id = "add-flag-to-workspace-before-invite-users-policy-to-application-policy-migration",
        author = " ")
public class Migration102EeAddFlagToWorkspaceBeforeInviteUsersPolicyToApplicationPolicyMigration {
    ...
    private static final String migrationId =
            "add-flag-to-workspace-before-invite-users-policy-to-application-policy-migration";
    ...
    public Migration102EeAddFlagToWorkspaceBeforeInviteUsersPolicyToApplicationPolicyMigration(
    ...
    public void setFlagInWorkspaceForEnvironmentMigration() {
        ...
        Criteria criteriaWorkspacesToBeUpdatedWithFlag = where(migrationFlag)
                .exists(false)
                .andOperator(
                        notDeleted(),
        ...
        log.debug(
                "Count of workspaces where flag needs to be set: {}. Query used: {}",
                countWorkspacesToBeUpdated,
                queryWorkspacesToBeUpdatedWithFlag);
        while (migrationAttempt <= migrationRetries && countWorkspacesUpdated != countWorkspacesToBeUpdated) {
            ...
            UpdateResult updateResult = mongoTemplate.updateMulti(
                    queryWorkspacesToBeUpdatedWithFlag, updateSetMigrationFlag, Workspace.class);
        ...
        log.debug(
                "Count of workspaces where flag has been set: {}. Query used: {}",
                countWorkspacesUpdated,
                queryWorkspacesUpdatedWithFlag);
