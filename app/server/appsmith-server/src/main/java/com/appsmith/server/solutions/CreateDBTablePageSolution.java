...
public class CreateDBTablePageSolution {
    ...
    private String templateAutogeneratedKey;
        ...
        return Flux.fromIterable(templateActionList)
            .flatMap(templateAction -> {
                ...
                if (actionBody != null) {
                    ...
                    String temp = mappedColumns.get(templateAutogeneratedKey);
                    if (templateAutogeneratedKey != null && INSERT_QUERY.equals(actionDTO.getName())) {
    ...
    private Map<String, String> mapKeys(Table sourceTable, Table destTable) {
        ...
        */
        ...
        AtomicReference<String> sourceKey = new AtomicReference<>();
        AtomicReference<String> destKey = new AtomicReference<>();
        ...
        if (DatasourceStructure.TableType.TABLE.equals(sourceTable.getType())) {
            ...
            if (primaryKey != null) {
                ...
                destKey.set(key.getColumnNames().get(0));
                primaryKeyNameMap.put(sourceKey.get(), destKey.get());
                ...
                templateAutogeneratedKey = destTable.getColumns()
                    .stream()
                    .filter(column -> column.getIsAutogenerated() != null && column.getIsAutogenerated() && destKey.get().equals(column.getName()))
                    .findAny()
                    .map(column -> sourceKey.get())
                    .orElse(null);
            }
        }
        // Map keys for NoSQL datasources like MongoDB
        else if (DatasourceStructure.TableType.COLLECTION.equals(sourceTable.getType())) {
            sourceKey.set(FieldName.MONGO_UNESCAPED_ID);
            ...
            destKey.set(autogeneratedColumns
                .stream()
                .filter(column -> sourceKey.get().equals(column.getName()))
                .findAny()
                .map(Column::getName)
                .orElse(null));
            ...
            if (destKey.get() != null) {
                ...
                primaryKeyNameMap.put(sourceKey.get(), autogeneratedColumns.get(0).getName());
            }
        }
            ...
            for (Object obj : children) {
                ...
                if (!CollectionUtils.isEmpty(data)) {
                    ...
                    if (FieldName.TABLE_WIDGET.equals(widgetType)
                        ...
                        if (templateAutogeneratedKey != null && TEMPLATE_AUTOGENERATED_INSERT_COLUMN.equals(widgetName)) {
