...
public class AuthenticationServiceCEImpl implements AuthenticationServiceCE {
  ...
  public Mono<String> getAuthorizationCodeURLForGenericOauth2(
      String datasourceId, String pageId, ServerHttpRequest httpRequest) {
        ...
        .switchIfEmpty(
            Mono.error(
                new AppsmithException(
                    AppsmithError.NO_RESOURCE_FOUND, FieldName.DATASOURCE, datasourceId)))
        ...
        .flatMap(
            (datasource -> {
              ...
              if (oAuth2.getCustomAuthenticationParameters() != null) {
                oAuth2
                    .getCustomAuthenticationParameters()
              ...
              if (!datasource1.getIsValid()) {
                return Mono.error(
                    new AppsmithException(
                        ...
                        datasource1.getInvalids().iterator().next()));
              }
  ...
  /**
   * This is the method that handles callback for generic OAuth2. We will be retrieving and storing
   * token information here and redirecting back to a sensible url for clients to see the response
   * in
   *
        ...
        .flatMap(
            datasource -> {
              ...
              if (oAuth2.isUseSelfSignedCert()) {
                httpClient.secure(
                    SSLHelper.sslCheckForHttpClient(datasource.getDatasourceConfiguration()));
              }
              ...
              if (Boolean.FALSE.equals(oAuth2.getIsAuthorizationHeader())) {
                ...
                if (Boolean.TRUE.equals(oAuth2.getIsAuthorizationHeader())) {
                  byte[] clientCredentials =
                      (oAuth2.getClientId() + ":" + oAuth2.getClientSecret()).getBytes();
                  ...
                  return Mono.error(
                      new AppsmithException(
                          AppsmithError.INVALID_PARAMETER, "isAuthorizationHeader"));
                }
              }
              return builder
                  .build()
                  ...
                  .flatMap(
                      response -> {
                        ...
                        if (issuedAtResponse != null) {
                          issuedAt =
                              Instant.ofEpochMilli(Long.parseLong((String) issuedAtResponse));
                        }
                        ...
                        if (expiresAtResponse != null) {
                          ...
                          if (expiresInResponse != null) {
                            expiresAt =
                                issuedAt.plusSeconds(
                                    Long.parseLong(String.valueOf(expiresInResponse)));
                          }
                        }
  ...
  public Mono<String> getAppsmithToken(
    ...
    Mono<Datasource> datasourceMono =
        datasourceService.findById(datasourceId, datasourcePermission.getEditPermission()).cache();
                    ...
                    .map(
                        tuple -> {
                          ...
                          String defaultPageId =
                              StringUtils.hasLength(defaultResourceIds.getPageId())
                                  ? defaultResourceIds.getPageId()
                                  : page.getId();

                          String defaultApplicationId =
                              StringUtils.hasLength(defaultResourceIds.getApplicationId())
                          ...
                          integrationDTO.setScope(
                              ((OAuth2) datasource.getDatasourceConfiguration().getAuthentication())
                                  .getScope());
                      ...
                      tuple -> {
                        ...
                        datasource
                            ...
                            .setAuthenticationStatus(
                                AuthenticationDTO.AuthenticationStatus.IN_PROGRESS);
                        return datasourceService
            ...
            datasource -> {
              ...
              try {
                uriBuilder
                    .uri(
                        new URI(
                            cloudServicesConfig.getBaseUrl() + "/api/v1/integrations/oauth/token"))
                  ...
                  .flatMap(
                      authenticationResponse -> {
                        ...
                        if (tokenResponse != null && tokenResponse.containsKey("scope")) {
                          if (!new HashSet<>(
                                  Arrays.asList(
                                      String.valueOf(tokenResponse.get("scope")).split(" ")))
