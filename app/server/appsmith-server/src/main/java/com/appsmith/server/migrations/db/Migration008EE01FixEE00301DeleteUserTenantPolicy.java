...
@ChangeUnit(order = "008-ee-01", id = "migration-fix-migration-102-EE-tenant-read-all-users-policy-to-default-tenant")
public class Migration008EE01FixEE00301DeleteUserTenantPolicy {
    private final PolicySolution policySolution;
    private final MongoTemplate mongoTemplate;

    public Migration008EE01FixEE00301DeleteUserTenantPolicy(
