...
private static final String newPermissionGroupIndexNameDefaultDomainIdDefaultDomainType =
...
public void createNewIndexDefaultDomainIdDefaultDomainTypeAndDropOldIndexDefaultWorkspaceId() {
	dropIndexIfExists(
		mongoTemplate, PermissionGroup.class, oldPermissionGroupIndexNameDefaultWorkspaceIdDeleted);
	dropIndexIfExists(
		mongoTemplate,
