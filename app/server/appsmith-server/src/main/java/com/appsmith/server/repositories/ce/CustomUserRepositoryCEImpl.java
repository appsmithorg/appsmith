...
public class CustomUserRepositoryCEImpl extends BaseAppsmithRepositoryImpl<User>
  ...
  /**
   * Fetch minmal information from *a* user document in the database, limit to two documents, filter
   * anonymousUser If no documents left return true otherwise return false.
   *
