...
public void supportNonHostedPluginsForAirgap() {
	...
	// In earlier PR we opted out for plugins which can't be self-hosted for airgap thinking that as
	// public internet
	// is not available. But we are seeing multiple level of airgapping is needed where customers
	// still want the
