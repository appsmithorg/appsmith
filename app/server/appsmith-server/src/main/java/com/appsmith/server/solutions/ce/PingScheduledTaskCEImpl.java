...
public class PingScheduledTaskCEImpl implements PingScheduledTaskCE {
    ...
    /**
     * Gets the external IP address of this server and pings a data point to indicate that this
     * server instance is live. We use an initial delay of two minutes to roughly wait for the
     * application along with the migrations are finished and ready.
     */
