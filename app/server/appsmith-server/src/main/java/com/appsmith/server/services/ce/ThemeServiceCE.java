...
public interface ThemeServiceCE extends CrudService<Theme, String> {
  ...
  /**
   * Returns a themeId that was fetched earlier and stored to cache. If cache is empty, it'll fetch
   * from DB, store in cache and return
   *
  ...
  /**
   * Duplicates a theme if the theme is customized one. If the source theme is a system theme, it'll
   * skip creating a new theme and return the system theme instead.
   *
