...
@ChangeUnit(order = "070", id = "move-form-login-disabled-to-organization-configuration")
public class Migration070MoveFormLoginDisabledToOrganizationConfiguration {
