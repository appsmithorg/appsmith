...
public class DatasourceStorageServiceCEImpl
  ...
  @Override
  public Mono<DatasourceStorage> findByDatasourceIdOrSave(
  ...
  private Mono<DatasourceStorage> saveDatasourceConfigurationFromDatasource(
      Datasource datasource, String environmentId) {
    if (datasource.getDatasourceConfiguration() == null) {
      // here, we don't have datasource configuration in datasource collection or
      // datasourceStorage collection
