...
protected Mono<DatasourceContext<?>> createNewDatasourceContext(
	...
	return datasourceMono
		.zipWhen(
			...
			// Datasource Context has not been created for this resource on this machine. Create
			// one now.
...
public boolean isValidDatasourceContextAvailable(
	...
	return datasourceContextMap.get(datasourceContextIdentifier) != null
		// The following condition happens when there's a timeout in the middle of destroying a
		// connection and
...
public Mono<DatasourceContext<?>> getDatasourceContext(
	...
	log.debug(
		"This is a dry run or an embedded datasource. The datasource context would not exist in"
			+ " this scenario");
