...
public class Migration075AddIsAIAssistantEnabledToOrganizationConfiguration {
    ...
    public void executeMigration() {
        ...
        Criteria missingFlagOnExistingConfig = new Criteria()
                .andOperator(
                        Criteria.where(Organization.Fields.organizationConfiguration)
                                .ne(null),
                        Criteria.where("organizationConfiguration.aiAssistantConfig.isAIAssistantEnabled")
                                .exists(false));
                ...
                new Update()
                        .set(
                                ...
                                new org.bson.Document(
                                        "aiAssistantConfig", new org.bson.Document("isAIAssistantEnabled", false))),
                Organization.class);
        ...
        UpdateResult missingResult = mongoTemplate.updateMulti(
                ...
                new Update().set("organizationConfiguration.aiAssistantConfig.isAIAssistantEnabled", false),
                Organization.class);
