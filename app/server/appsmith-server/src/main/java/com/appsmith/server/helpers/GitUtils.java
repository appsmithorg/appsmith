...
public class GitUtils {
  ...
  /**
   * This method checks if the provided git-repo is public or private by checking the response from
   * the get request if we get 200 or 202 then repo is public otherwise it's private
   *
