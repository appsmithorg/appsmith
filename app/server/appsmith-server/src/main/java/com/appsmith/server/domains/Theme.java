...
// name will be used internally to identify system themes for import, export application and theme
// migration
// it'll never change. We need to remove this from API response in future when FE uses displayName
// everywhere
...
@JsonProperty(
	"isSystemTheme") // manually setting property name to make sure it's compatible with Gson
@JsonView({Views.Public.class})
