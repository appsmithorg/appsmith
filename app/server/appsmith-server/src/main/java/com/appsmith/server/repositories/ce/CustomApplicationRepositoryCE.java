...
public interface CustomApplicationRepositoryCE extends AppsmithRepository<Application> {
    ...
    Flux<Application> findByMultipleWorkspaceIds(
            Set<String> workspaceIds, AclPermission permission);

    /**
     * Finds all the applications that are directly assigned to the user. This method would not
    ...
    Mono<UpdateResult> setGitAuth(
            String applicationId, GitAuth gitAuth, AclPermission aclPermission);
    ...
    Flux<Application> getApplicationByGitDefaultApplicationId(
