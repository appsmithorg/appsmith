...
public Mono<ResponseDTO<Boolean>> forgotPasswordRequest(
	...
	// We shouldn't leak information on whether this operation was successful or not to the client.
	// This can enable
	// username scraping, where the response of this API can prove whether an email has an account
	// or not.
	return service
