                    ...
                    if (updatedActionDTO.getDatasource() != null
                        ...
                        return datasourceService
                                .findById(
                                        ...
                                        datasourcePermission.getExecutePermission())
                                .switchIfEmpty(Mono.justOrEmpty(updatedActionDTO.getDatasource()))
                    ...
                    .zipWith(Mono.defer(() -> {
                        ...
                        if (action.getDatasource() != null
                            ...
                            return datasourceService
                                    ...
                                    .switchIfEmpty(Mono.justOrEmpty(action.getDatasource()))
    ...
    public Mono<ActionDTO> populateHintMessages(ActionDTO action) {
        ...
        if (action.getDatasource().getDatasourceConfiguration() != null) {
            ...
            dsConfigMono = datasourceService
                    ...
                    .onErrorResume(e -> {
                        log.warn(
                                "Failed to fetch datasource config for hint generation (datasourceId={}): {}",
