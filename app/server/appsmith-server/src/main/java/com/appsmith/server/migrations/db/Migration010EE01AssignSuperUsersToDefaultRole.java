 ...
 */
@Slf4j
@ChangeUnit(order = "010-ee-01", id = "assign-super-users-to-default-role", author = "", runAlways = true)
public class Migration010EE01AssignSuperUsersToDefaultRole {
    private final MongoTemplate mongoTemplate;
    private final CacheableRepositoryHelper cacheableRepositoryHelper;

    public Migration010EE01AssignSuperUsersToDefaultRole(
