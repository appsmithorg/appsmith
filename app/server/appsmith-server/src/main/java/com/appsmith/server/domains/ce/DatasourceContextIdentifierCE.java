...
public boolean equals(Object obj) {
	...
	boolean areBothEnvironmentIdSameOrNull =
		hasLength(this.getEnvironmentId())
			? this.getEnvironmentId().equals(keyObj.getEnvironmentId())
			: !hasLength(keyObj.getEnvironmentId());
