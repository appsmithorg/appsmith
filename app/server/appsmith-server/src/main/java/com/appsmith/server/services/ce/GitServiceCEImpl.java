        ...
        */
        ...
        Mono<GitStatusDTO> statusMono = getGitApplicationMetadata(defaultApplicationId)
                .flatMap(gitApplicationMetadata -> {
                    Mono<Tuple2<Application, ApplicationJson>> applicationJsonTuple = applicationService
                            .findByBranchNameAndDefaultApplicationId(
                ...
                .flatMap(tuple -> {
                    Mono<GitStatusDTO> branchedStatusMono = gitExecutor
                            ...
                            .flatMap(rebaseStatus -> {
                                if (rebaseStatus.equals(Boolean.FALSE)) {
                                    return Mono.error(new AppsmithException(
                                            AppsmithError.GIT_ACTION_FAILED,
                                            "rebase branch",
                                            "Unable to rebase branch - " + branchName));
                                }
