...
public class Migration012RenameIndexesWithLongNames {
    ...
    public void rollBackExecution() {
        // Rollback behaviour is undefined. This migration is idempotent, and only does indexes, so
        // should be fine going back.
    }
    ...
    public void executeMigration() {
        ...
        if (dropIndexIfExists(
                mongoTemplate,
                Application.class,
                "defaultCollectionId_branchName_deleted_compound_index")) {
            ensureIndexes(
                    mongoTemplate,
                    ActionCollection.class,
                    makeIndex(
                                    "defaultResources.collectionId",
                                    "defaultResources.branchName",
                                    "deleted")
        ...
        if (dropIndexIfExists(
                mongoTemplate,
                Application.class,
                "defaultApplicationId_branchName_deleted_compound_index")) {
            ensureIndexes(
                    mongoTemplate,
                    Application.class,
                    makeIndex(
        ...
        if (dropIndexIfExists(
                mongoTemplate,
                ActionCollection.class,
                "unpublishedCollectionPageId_deleted_compound_index")) {
            ensureIndexes(
                    mongoTemplate,
                    ActionCollection.class,
                    makeIndex(
        ...
        if (dropIndexIfExists(
                mongoTemplate,
                ActionCollection.class,
                "publishedCollectionPageId_deleted_compound_index")) {
            ensureIndexes(
                    mongoTemplate,
                    ActionCollection.class,
                    makeIndex(
        ...
        dropIndexIfExists(
                mongoTemplate,
                ActionCollection.class,
                "defaultApplicationId_gitSyncId_deleted_compound_index");
        dropIndexIfExists(
                mongoTemplate,
                NewAction.class,
                "defaultApplicationId_gitSyncId_deleted_compound_index");
        ...
        DatabaseChangelog2.doAddPermissionGroupIndex(
                mongoTemplate); // Idempotent index-only migration, do it again.
        ...
        Index newIndexDefaultDomainIdDefaultDomainTypeDeletedDeletedAt =
                makeIndex(
        ...
        ensureIndexes(
                mongoTemplate,
                PermissionGroup.class,
                newIndexDefaultDomainIdDefaultDomainTypeDeletedDeletedAt);
