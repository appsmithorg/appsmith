        ...
        return configService
                ...
                .flatMap(
                        key -> {
                            ...
                            if (Boolean.FALSE.equals(isClearCache)
                                    && gitLimitCache.containsKey(key)) {
                            ...
                            return WebClientUtils.create(baseUrl + "/api/v1/git/limit/" + key)
                                    ...
                                    .map(
                                            limit -> {
                                                GitConnectionLimitDTO gitConnectionLimitDTO =
                                                        new GitConnectionLimitDTO();
                                    ...
                                    .doOnError(
                                            error ->
                                                    log.error(
                                                            "Error fetching config from cloud"
                                                                    + " services",
                                                            error));
                        });
    }
