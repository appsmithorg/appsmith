...
public class ExamplesWorkspaceClonerCEImpl implements ExamplesWorkspaceClonerCE {
    ...
    public Mono<List<String>> cloneApplications(
        ...
        return datasourceFlux
                .flatMap(datasource -> {
                    ...
                    // exportWithConfiguration is dependent on application, here we are calling cloneDatasource
                                            ...
                                            if (datasourceInsideAction != null) {
                                                if (datasourceInsideAction.getId() != null) {
                                                    ...
                                                    if (!cloneDatasourceMonos.containsKey(datasourceId)) {
                                                        ...
                                                        Boolean exportWithConfig = Boolean.FALSE;
                                                        if (Boolean.TRUE.equals(application.getExportWithConfiguration())){
                                                            exportWithConfig = Boolean.TRUE;
                                                        }
                                                        cloneDatasourceMonos.put(datasourceId, cloneDatasource(datasourceId, toWorkspaceId, exportWithConfig).cache());
                                                    }
    ...
    // exportWithConfiguration parameter if TRUE, returns the datasource with credentials else returns datasources without credentials
    private Mono<Datasource> cloneDatasource(String datasourceId, String toWorkspaceId, Boolean exportWithConfiguration) {
                ...
                .flatMap(tuple -> {
                    ...
                    return Flux.fromIterable(existingDatasources)
                            ...
                            .switchIfEmpty(Mono.defer(() -> {
                                ...
                                if (!Boolean.TRUE.equals(exportWithConfiguration)){
