...
public class CreateDBTablePageSolutionCEImpl implements CreateDBTablePageSolutionCE {
    ...
    private static final Set<String> BLACKLISTED_QUERIES_FOR_REPLACEMENT = Set.of(INSERT_QUERY);
        ...
        return Flux.fromIterable(templateActionList)
                .flatMap(templateAction -> {
                    ...
                    if (actionBody != null) {
                        ...
                        actionBody = actionBody.replaceFirst(TEMPLATE_TABLE_NAME, tableName);
                        // Apply replacement logic for actionBody only for selected queries
                        if (!BLACKLISTED_QUERIES_FOR_REPLACEMENT.contains(actionDTO.getName())) {
                            final Matcher matcher = WORD_PATTERN.matcher(actionBody);
