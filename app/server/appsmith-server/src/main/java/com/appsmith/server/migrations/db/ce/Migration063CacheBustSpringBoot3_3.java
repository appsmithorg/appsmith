...
public class Migration063CacheBustSpringBoot3_3 {
    ...
    public void execute(
        ...
        deleteKeysAcrossCluster(reactiveRedisTemplate, "spring:session:sessions:*", authorizedClientsKey)
                .block();
    }

    public Mono<Void> deleteKeysAcrossCluster(
            ReactiveRedisTemplate<String, Object> reactiveRedisTemplate, String pattern, String hashField) {
