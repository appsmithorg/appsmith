...
public class GitControllerCE {
    ...
    public Mono<ResponseDTO<Map<String, GitProfile>>> saveGitProfile(
        ...
        log.debug(
                "Going to add repo specific git profile for application: {}", defaultApplicationId);
    ...
    public Mono<ResponseDTO<GitProfile>> getDefaultGitConfigForUser() {
        return service.getDefaultGitProfileOrCreateIfEmpty()
                .map(
                        gitConfigResponse ->
                                new ResponseDTO<>(HttpStatus.OK.value(), gitConfigResponse, null));
    }
    ...
    public Mono<ResponseDTO<String>> push(
            ...
            @RequestHeader(name = FieldName.BRANCH_NAME, required = false) String branchName) {
        log.debug(
                "Going to push application application {}, branch : {}",
                defaultApplicationId,
                branchName);
    ...
    public Mono<ResponseDTO<Application>> checkoutBranch(
        ...
        log.debug(
                "Going to checkout to branch {} application {} ", branchName, defaultApplicationId);
    ...
    public Mono<ResponseDTO<GitPullDTO>> pull(
            ...
            @RequestHeader(name = FieldName.BRANCH_NAME, required = false) String branchName) {
        log.debug(
                "Going to pull the latest for application {}, branch {}",
                defaultApplicationId,
                branchName);
    ...
    public Mono<ResponseDTO<List<GitBranchDTO>>> branch(
        ...
        return service.listBranchForApplication(
    ...
    public Mono<ResponseDTO<Application>> deleteBranch(
        ...
        log.debug(
                "Going to delete branch {} for defaultApplicationId {}",
                branchName,
                defaultApplicationId);
    ...
    public Mono<ResponseDTO<List<GitDeployKeyDTO>>> getSupportedKeys() {
        ...
        return Mono.just(GitDeployKeyGenerator.getSupportedProtocols())
                .map(
                        gitDeployKeyDTOS ->
                                new ResponseDTO<>(HttpStatus.OK.value(), gitDeployKeyDTOS, null));
    }
