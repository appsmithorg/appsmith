...
@Component
public class CollectionRepositoryCake extends BaseCake<Collection, CollectionRepository> {
    ...
    public QueryAllParams<Collection> queryBuilder() {
    ...
    public Mono<Void> bulkInsert(CollectionRepositoryCake baseRepository, List<Collection> domainList) {
    ...
    public Mono<Void> bulkUpdate(CollectionRepositoryCake baseRepository, List<Collection> domainList) {
    ...
    public Mono<Collection> findById(String id, AclPermission permission) {
    ...
    public Mono<Collection> getById(String id) {
    ...
    public Mono<Collection> setUserPermissionsInObject(Collection obj, User user) {
        return Mono.fromSupplier(() -> repository.setUserPermissionsInObject(obj, user))
                .subscribeOn(Schedulers.boundedElastic());
    }

    /** @see com.appsmith.server.repositories.AppsmithRepository#setUserPermissionsInObject(BaseDomain, java.util.BaseDomain<String>) */
    public Mono<Collection> setUserPermissionsInObject(Collection obj, java.util.Collection<String> permissionGroups) {
    ...
    public Mono<Collection> updateAndReturn(String id, BridgeUpdate updateObj, AclPermission permission) {
    ...
    public Mono<Collection> updateById(String id, Collection resource, AclPermission permission) {
        return ReactiveContextUtils.getCurrentUser()
