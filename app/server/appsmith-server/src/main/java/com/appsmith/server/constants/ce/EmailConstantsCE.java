...
public class EmailConstantsCE {
    ...
    public static final String INVITE_EXISTING_USER_TO_WORKSPACE_TEMPLATE = "email/inviteExistingUserToWorkspaceTemplate.html";
    public static final String INVITE_NEW_USER_TO_WORKSPACE_TEMPLATE = "email/inviteWorkspaceTemplate.html";
    public static final String SIGNUP_NEW_USER_CLIENT_URL_FORMAT = "%s/user/signup?email=%s";
    public static final String FORGOT_PASSWORD_TEMPLATE = "email/forgotPasswordTemplate.html";
    ...
    public static final String WORKSPACE_URL_FORMAT = "%s/applications#%s";
