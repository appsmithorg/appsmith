...
public enum AppsmithErrorCode {
    ...
    PAGE_DOESNT_BELONG_TO_USER_WORKSPACE("AE-APP-4006", "Page doesnt belong to user workspace"),
    UNSUPPORTED_OPERATION("AE-APP-4007", "Unsupported operation"),
    DEPRECATED_API("AE-APP-4008", "Deprecated api"),
    USER_DOESNT_BELONG_ANY_WORKSPACE("AE-APP-4009", "User doesnt belong any workspace"),
    USER_DOESNT_BELONG_TO_WORKSPACE("AE-APP-4010", "User doesnt belong to workspace"),
    ...
    GIT_FILE_SYSTEM_ERROR("AE-APP-5013", "Git file system error"),
    GIT_EXECUTION_TIMEOUT("AE-APP-5014", "Git execution timeout"),
    SSH_KEY_GENERATION_ERROR("AE-APP-5015", "Ssh key generation error"),
    GIT_GENERIC_ERROR("AE-APP-5016", "Git generic error"),
