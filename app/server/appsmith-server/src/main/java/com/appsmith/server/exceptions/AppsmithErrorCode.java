...
public enum AppsmithErrorCode {
    ...
    ASSIGN_UNASSIGN_MISSING_PERMISSION("AE-ACL-4008", "Assign or unassign operation failed"),
    INVALID_PARAMETER("AE-APP-4000", "Invalid parameter"),
    UNKNOWN_SERVER_VARIABLE_TYPE("AE-APP-4001", "Unknown server variable type"),
