...
public class UserDataServiceCEImpl extends BaseService<UserDataRepository, UserData, String>
  ...
  public Mono<UserData> getForUser(String userId) {
    // If an entry for this userId doesn't exist in the database, we return an empty object,
    // since data in this
    // collection is treated to be sparse. That is, missing objects in the database are the same
    // as empty objects.
