...
public class UserDataServiceCEImpl extends BaseService<UserDataRepository, UserData, String>
    ...
    public Mono<User> ensureViewedCurrentVersionReleaseNotes(User user) {
        return getForUser(user)
                .flatMap(
                        userData -> {
                            if (userData != null
                                    && userData.getReleaseNotesViewedVersion() == null) {
                        ...
                        tuple -> {
                            ...
                            return Mono.zip(
                                    analyticsService.identifyUser(
                                            user, userData, application.getWorkspaceId()),
                ...
                .flatMap(
                        userData -> {
                            ...
                            userData.setRecentlyUsedTemplateIds(
                                    addIdToRecentList(
                                            userData.getRecentlyUsedTemplateIds(), templateId, 5));
    ...
    public Mono<UpdateResult> removeRecentWorkspaceAndApps(String userId, String workspaceId) {
        return applicationRepository
                ...
                .flatMap(
                        appIdsList ->
                                repository.removeIdFromRecentlyUsedList(
                                        userId, workspaceId, appIdsList));
    }
}
