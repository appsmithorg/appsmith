...
public interface AuthenticationValidatorCE {
   ...
   * @param environmentId - environmentId, Id of the environment on which the datasource is getting
   *     validated, this variable is unused in the CE version of the code.
