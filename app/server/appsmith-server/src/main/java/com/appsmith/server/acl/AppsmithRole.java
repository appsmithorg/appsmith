...
public enum AppsmithRole {
  ...
  ORGANIZATION_DEVELOPER(
      ...
      Set.of(
          READ_WORKSPACES, WORKSPACE_MANAGE_APPLICATIONS,
          WORKSPACE_MANAGE_DATASOURCES, WORKSPACE_READ_APPLICATIONS,
          WORKSPACE_PUBLISH_APPLICATIONS, WORKSPACE_INVITE_USERS,
          WORKSPACE_CREATE_APPLICATION, WORKSPACE_CREATE_DATASOURCE,
