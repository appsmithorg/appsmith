...
public class ApplicationControllerCE
  ...
  public Mono<ResponseDTO<Application>> shareApplication(
    ...
    return service
        .changeViewAccess(defaultApplicationId, branchName, applicationAccessDTO)
  ...
  public Mono<ResponseDTO<Application>> getApplicationInViewMode(
      ...
      @RequestHeader(name = FieldName.BRANCH_NAME, required = false) String branchName) {
    return service
        .getApplicationInViewMode(defaultApplicationId, branchName)
        .map(application -> new ResponseDTO<>(HttpStatus.OK.value(), application, null));
  }
  ...
  public Mono<ResponseDTO<ApplicationSnapshot>> getSnapshotWithoutApplicationJson(
    ...
    return applicationSnapshotService
        ...
        .map(
            applicationSnapshot ->
                new ResponseDTO<>(HttpStatus.OK.value(), applicationSnapshot, null));
  }
  ...
  public Mono<ResponseDTO<GitAuth>> generateSSHKeyPair(
    ...
    return service
        .createOrUpdateSshKeyPair(applicationId, keyType)
        .map(created -> new ResponseDTO<>(HttpStatus.CREATED.value(), created, null));
  }
  ...
  public Mono<ResponseDTO<Application>> update(
    ...
    return service
        .update(defaultApplicationId, resource, branchName)
  ...
  public Mono<ResponseDTO<Void>> deleteAppNavigationLogo(
      ...
      @RequestHeader(name = FieldName.BRANCH_NAME, required = false) String branchName) {
    return service
        .deleteAppNavigationLogo(branchName, defaultApplicationId)
