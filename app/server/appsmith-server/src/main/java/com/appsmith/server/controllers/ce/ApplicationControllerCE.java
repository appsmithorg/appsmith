...
public class ApplicationControllerCE
        extends BaseController<ApplicationService, Application, String> {
    ...
    public Mono<ResponseDTO<Application>> create(
            @Valid @RequestBody Application resource,
            @RequestParam String workspaceId,
            ServerWebExchange exchange) {
        if (workspaceId == null) {
            return Mono.error(
                    new AppsmithException(AppsmithError.INVALID_PARAMETER, "workspace id"));
        }
    ...
    public Mono<ResponseDTO<Application>> makeDefault(
        ...
        return applicationPageService
                ...
                .map(
                        updatedApplication ->
                                new ResponseDTO<>(HttpStatus.OK.value(), updatedApplication, null));
    }
    ...
    public Mono<ResponseDTO<ApplicationImportDTO>> forkApplication(
        ...
        return applicationForkingService
                ...
                .map(
                        fetchedResource ->
                                new ResponseDTO<>(HttpStatus.OK.value(), fetchedResource, null));
    }
    ...
    public Mono<ResponseEntity<Object>> getApplicationFile(
        ...
        return importExportApplicationService
                .getApplicationFile(id, branchName)
                .map(
                        fetchedResource -> {
                            ...
                            return new ResponseEntity<>(
                                    applicationResource, responseHeaders, HttpStatus.OK);
                        });
    }
    ...
    public Mono<ResponseDTO<ApplicationSnapshot>> getSnapshotWithoutApplicationJson(
        ...
        return applicationSnapshotService
                ...
                .map(
                        applicationSnapshot ->
                                new ResponseDTO<>(
                                        HttpStatus.OK.value(), applicationSnapshot, null));
    }
                        ...
                        file ->
                                importExportApplicationService
                                        .extractFileAndUpdateNonGitConnectedApplication(
                                                workspaceId, file, applicationId, branchName))
                .map(
                        fetchedResource ->
                                new ResponseDTO<>(HttpStatus.OK.value(), fetchedResource, null));
    }
    ...
    public Mono<ResponseDTO<Application>> update(
            ...
            @RequestHeader(name = FieldName.BRANCH_NAME, required = false) String branchName) {
        log.debug(
                "Going to update resource from base controller with id: {}", defaultApplicationId);
    ...
    public Mono<ResponseDTO<List<DatasourceDTO>>> getUnConfiguredDatasource(
            @PathVariable String workspaceId, @RequestParam String defaultApplicationId) {
        return importExportApplicationService
                .findDatasourceDTOByApplicationId(defaultApplicationId, workspaceId)
                .map(result -> new ResponseDTO<>(HttpStatus.OK.value(), result, null));
    }

    @JsonView(Views.Public.class)
    @PostMapping(
            value = "/{defaultApplicationId}/logo",
    ...
    public Mono<ResponseDTO<Application>> uploadAppNavigationLogo(
        ...
        return fileMono.flatMap(
                        part ->
                                service.saveAppNavigationLogo(
                                        branchName, defaultApplicationId, part))
    ...
    public Mono<ResponseDTO<List<Application>>> getAll(
        ...
        return Mono.just(
                new ResponseDTO<>(
                        ...
                        null,
                        AppsmithError.UNSUPPORTED_OPERATION.getMessage()));
    }
}
