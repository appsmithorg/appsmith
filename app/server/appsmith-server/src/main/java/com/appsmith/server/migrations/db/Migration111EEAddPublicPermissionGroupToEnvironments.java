...
@ChangeUnit(order = "111-ee", id = "add-public-perm-to-envs")
public class Migration111EEAddPublicPermissionGroupToEnvironments {

    private final MongoTemplate mongoTemplate;

    public Migration111EEAddPublicPermissionGroupToEnvironments(MongoTemplate mongoTemplate) {
