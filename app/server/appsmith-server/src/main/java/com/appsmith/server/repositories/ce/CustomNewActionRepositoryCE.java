...
public interface CustomNewActionRepositoryCE extends AppsmithRepository<NewAction> {
    ...
    Mono<NewAction> findByUnpublishedNameAndPageId(
    ...
    Flux<NewAction> findByPageIdAndViewMode(
            String pageId, Boolean viewMode, AclPermission aclPermission);

    Flux<NewAction> findUnpublishedActionsByNameInAndPageId(
    ...
    Flux<NewAction> findByApplicationId(
            String applicationId, AclPermission aclPermission, Sort sort);

    Flux<NewAction> findByApplicationId(
            String applicationId, Optional<AclPermission> aclPermission, Optional<Sort> sort);

    Flux<NewAction> findByApplicationIdAndViewMode(
