...
/**
* This method will create a new snapshot of the provided applicationId and branch name and store
* in the ApplicationSnapshot collection.
*
* @param applicationId ID of the application, default application ID if application is connected
*     to Git
