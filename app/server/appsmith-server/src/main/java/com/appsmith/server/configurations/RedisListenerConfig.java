...
public class RedisListenerConfig {
    ...
    /**
     * This is the listener that will receive all the messages from the Redis channel topic
     * configured in topic(). Currently the only topic we are listening to is for install plugin
     * requests.
     *
     * @param factory
     * @return
    ...
    public ReactiveRedisMessageListenerContainer container(ReactiveRedisConnectionFactory factory) {
        ...
        container
                ...
                .map(
                        redisPluginObj ->
                                pluginService.redisInstallPlugin(
                                        (InstallPluginRedisDTO) redisPluginObj))
