...
public class DatasourceStructureSolutionCEImpl implements DatasourceStructureSolutionCE {
    ...
    public Mono<DatasourceStructure> getStructure(
                        ...
                        .onErrorResume(
                                error ->
                                        analyticsService
                                                .sendObjectEvent(
                                                        AnalyticsEvents
                                                                .DS_SCHEMA_FETCH_EVENT_FAILED,
                                                        datasourceStorage,
                                                        getAnalyticsPropertiesForTestEventStatus(
                                                                datasourceStorage, false, error))
                        ...
                        .flatMap(
                                structure ->
                                        analyticsService
                                                .sendObjectEvent(
                                                        AnalyticsEvents
                                                                .DS_SCHEMA_FETCH_EVENT_SUCCESS,
                                                        datasourceStorage,
                                                        getAnalyticsPropertiesForTestEventStatus(
                                                                datasourceStorage, true, null))
                                                .then(
        ...
        // This mono, when computed, will load the structure of the datasourceStorage by calling the
        // plugin method.
