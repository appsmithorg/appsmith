...
public class DatabaseChangelog0 {
    ...
    /**
     * This migration initializes the correct version of instance schema migrations in the config
     * collection for this Appsmith instance Future migrations that need to handle migrations for
     * schema versions will check the current state and manage the migration accordingly
     */
    ...
    public void initializeSchemaVersion(MongoTemplate mongoTemplate) {
        ...
        if (instanceIdConfig != null) {
            ...
            mongoTemplate.insert(
                    new Config(
                            new JSONObject(Map.of("value", 1)), Appsmith.INSTANCE_SCHEMA_VERSION));
        } else {
            ...
            mongoTemplate.insert(
                    new Config(
                            new JSONObject(
                                    Map.of("value", CommonConfig.LATEST_INSTANCE_SCHEMA_VERSION)),
