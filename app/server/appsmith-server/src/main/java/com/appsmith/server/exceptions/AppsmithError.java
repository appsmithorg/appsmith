...
public enum AppsmithError {
    ...
    SSH_KEY_GENERATION_ERROR(504, 4045, "Failed to generate SSH keys. Please contact Appsmith support team", AppsmithErrorAction.DEFAULT, null, ErrorType.GIT_CONFIGURATION_ERROR),
    ;
