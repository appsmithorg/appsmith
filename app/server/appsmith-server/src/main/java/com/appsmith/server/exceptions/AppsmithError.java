...
public enum AppsmithError {
    ...
    GIT_FILE_IN_USE(500, 5020, "Your Git repo is in use by another member of your team. Usually, this takes a few seconds. Please try again a little later.", AppsmithErrorAction.DEFAULT, null, ErrorType.GIT_ACTION_EXECUTION_ERROR, null),
