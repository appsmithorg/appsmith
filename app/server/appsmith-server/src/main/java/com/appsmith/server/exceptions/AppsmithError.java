...
public enum AppsmithError {
    ...
    REMOVE_LAST_ORG_ADMIN_ERROR(400, 4038, "The last admin can not be removed from an workspace", AppsmithErrorAction.DEFAULT, null, ErrorType.INTERNAL_ERROR, null),
