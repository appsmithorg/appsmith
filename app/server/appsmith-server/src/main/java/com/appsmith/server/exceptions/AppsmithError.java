...
public enum AppsmithError {
    ...
    SAML_ALREADY_CONFIGURED(500, 5030, "SAML configuration already exists. Please disconnect SAML before trying to configure it again", AppsmithErrorAction.DEFAULT, null, ErrorType.INTERNAL_ERROR, null),
    GIT_FILE_IN_USE(500, 5040, "File lock in use. Please wait for a few seconds and try again", AppsmithErrorAction.DEFAULT, null, ErrorType.GIT_ACTION_EXECUTION_ERROR, null),
