...
public enum AppsmithError {
    ...
    INVALID_CURL_INPUT_PARAMETER(400, AppsmithErrorCode.INVALID_PARAMETER.getCode(), "Input CURL statement is empty / null. Please edit the input box to provide a valid CURL statement.", AppsmithErrorAction.DEFAULT, "Invalid parameter", ErrorType.ARGUMENT_ERROR, null),
