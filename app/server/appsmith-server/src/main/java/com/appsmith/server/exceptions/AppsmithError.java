...
public enum AppsmithError {
    ...
    INVALID_PROPERTIES_CONFIGURATION(500, AppsmithErrorCode.INVALID_PROPERTIES_CONFIGURATION.getCode(), "Property configuration is wrong or malformed.", AppsmithErrorAction.DEFAULT, "Invalid application property configuration", ErrorType.INTERNAL_ERROR, null),
    ;
