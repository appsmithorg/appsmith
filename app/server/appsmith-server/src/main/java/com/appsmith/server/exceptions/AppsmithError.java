...
public enum AppsmithError {
    ...
    MIGRATION_ERROR(500, 5020, "This action is already migrated", AppsmithErrorAction.DEFAULT, null, ErrorType.INTERNAL_ERROR, null),
    ...
    SAML_ALREADY_CONFIGURED(500, 5026, "SAML configuration already exists. Please disconnect SAML before trying to configure it again", AppsmithErrorAction.DEFAULT, null, ErrorType.INTERNAL_ERROR, null),
    GIT_FILE_IN_USE(500, 5027, "File lock in use. Please wait for a few seconds and try again", AppsmithErrorAction.DEFAULT, null, ErrorType.GIT_ACTION_EXECUTION_ERROR, null),
    ;
