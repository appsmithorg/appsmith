...
public enum AppsmithError {
    ...
    GIT_FILE_IN_USE(500, 5020, "File lock in use. Please wait for few seconds and try again", AppsmithErrorAction.DEFAULT, null, ErrorType.GIT_ACTION_EXECUTION_ERROR, null),
