...
public class GitServiceTest {
  ...
  public void setup() throws IOException, GitAPIException {
    ...
    Mockito.when(
            gitCloudServicesUtils.getPrivateRepoLimitForOrg(eq(workspaceId), Mockito.anyBoolean()))
  ...
  private Application createApplicationConnectedToGit(
      String name, String branchName, String workspaceId) throws IOException, GitAPIException {
        ...
        .expectErrorMatches(
            throwable ->
                throwable instanceof AppsmithException
                    && throwable
                        .getMessage()
                        .contains(AppsmithError.INVALID_PARAMETER.getMessage("Remote Url")))
        .verify();
  }
        ...
        .expectErrorMatches(
            throwable ->
                throwable instanceof AppsmithException
                    && throwable
                        .getMessage()
                        .contains(AppsmithError.INVALID_PARAMETER.getMessage("origin")))
        .verify();
  }
        ...
        .expectErrorMatches(
            throwable ->
                throwable instanceof AppsmithException
                    && throwable
                        .getMessage()
                        .equals(AppsmithError.INVALID_GIT_SSH_URL.getMessage()))
        .verify();
  }
        ...
        .expectErrorMatches(
            throwable ->
                throwable instanceof AppsmithException
                    && throwable
                        .getMessage()
                        .equals(AppsmithError.GIT_GENERIC_ERROR.getMessage("error message")))
        .verify();
  }
        ...
        .expectErrorMatches(
            error ->
                error instanceof AppsmithException
                    && error
                        .getMessage()
                        .equals(AppsmithError.GIT_APPLICATION_LIMIT_ERROR.getMessage()))
        .verify();
  }
        ...
        applicationPageService
            ...
            .flatMap(
                application -> {
                  ...
                  application
                      .getPages()
                      .forEach(page -> page.setDefaultPageId(page.getId() + "randomId"));
                  return Mono.zip(
    ...
    StepVerifier.create(
        ...
        .assertNext(
            tuple -> {
              ...
              application
                  .getPages()
                  .forEach(page -> assertThat(page.getDefaultPageId()).isEqualTo(page.getId()));
              application
                  .getPublishedPages()
                  .forEach(page -> assertThat(page.getDefaultPageId()).isEqualTo(page.getId()));
  ...
  public void pullChanges_upstreamChangesAvailable_pullSuccess()
    ...
    Application application =
        createApplicationConnectedToGit("UpstreamChangesInRemote", "upstreamChangesInRemote");
  ...
  public void commitApplication_localRepoNotAvailable_throwRepoNotFoundException()
    ...
    Mockito.when(
        ...
        .thenReturn(
            Mono.error(
                new RepositoryNotFoundException(AppsmithError.REPOSITORY_NOT_FOUND.getMessage())));
  ...
  public void commitApplication_pushFails_verifyAppNotPublished_throwUpstreamChangesFoundException()
    ...
    Mono<String> commitMono =
        gitService.commitApplication(commitDTO, preCommitApplication.getId(), DEFAULT_BRANCH);
            ...
            throwable ->
                throwable instanceof AppsmithException
                    && throwable
                        .getMessage()
                        .contains(
                            AppsmithError.INVALID_PARAMETER.getMessage(FieldName.BRANCH_NAME)))
        .verify();
  }
                    ...
                    && throwable
                        ...
                        .contains(
                            AppsmithError.DUPLICATE_KEY_USER_ERROR.getMessage(
                                "remotes/origin/" + createGitBranchDTO.getBranchName(),
    ...
    StepVerifier.create(
        ...
        .assertNext(
            tuple -> {
              ...
              application
                  .getPages()
                  .forEach(page -> assertThat(page.getDefaultPageId()).isNotEqualTo(page.getId()));
              application
                  .getPublishedPages()
                  .forEach(page -> assertThat(page.getDefaultPageId()).isNotEqualTo(page.getId()));
              ...
              pageList.forEach(
                  newPage -> {
                    ...
                    newPage.getUnpublishedPage().getLayouts().stream()
                        .filter(
                            layout ->
                                !CollectionUtils.isNullOrEmpty(layout.getLayoutOnLoadActions()))
                        .forEach(
                            layout ->
                                layout
                                    .getLayoutOnLoadActions()
              ...
              actionCollectionList.forEach(
                  actionCollection -> {
                    ...
                    unpublishedCollection
                        .getDefaultToBranchedActionIdsMap()
                        .forEach((key, value) -> assertThat(key).isNotEqualTo(value));
            ...
            throwable ->
                throwable instanceof AppsmithException
                    && throwable
                        .getMessage()
                        .contains(
                            AppsmithError.INVALID_PARAMETER.getMessage("Invalid workspace id")))
        .verify();
  }
        ...
        .assertNext(
            applicationImportDTO -> {
              ...
              assertThat(application.getGitApplicationMetadata().getIsRepoPrivate())
                  .isEqualTo(true);
              assertThat(application.getGitApplicationMetadata().getGitAuth().getPublicKey())
  ...
  public void importApplicationFromGit_validRequestWithDuplicateDatasourceOfSameType_Success() {
    ...
    final String testWorkspaceId = workspaceService.create(workspace).map(Workspace::getId).block();
  ...
  public void
    ...
    GitConnectDTO gitConnectDTO =
        getConnectRequest(
            "git@github.com:test/testGitImportRepoCancelledMidway.git", testUserProfile);
    GitAuth gitAuth = gitService.generateSSHKey(null).block();
            ...
            .flatMap(
                ignore -> {
                  ...
                  return applicationService
                      ...
                      .filter(
                          application1 ->
                              "testGitImportRepoCancelledMidway".equals(application1.getName()))
                      .next();
                });
        ...
        .expectErrorMatches(
            throwable ->
                throwable instanceof AppsmithException
                    && throwable
                        .getMessage()
                        .contains("Datasource already exists with the same" + " name"))
        .verify();
  }
  ...
  public void deleteBranch_staleBranchNotInDB_Success() throws IOException, GitAPIException {
    Application application =
        createApplicationConnectedToGit("deleteBranch_staleBranchNotInDB_Success", "master");
        ...
        .expectErrorMatches(
            throwable ->
                throwable instanceof AppsmithException
                    && throwable
                        .getMessage()
                        .contains("delete branch. Branch does not exists in" + " the repo"))
        .verify();
  }
        ...
        .assertNext(
            applicationList -> {
              ...
              applicationList.forEach(
                  application1 ->
                      branchNames.add(application1.getGitApplicationMetadata().getBranchName()));
