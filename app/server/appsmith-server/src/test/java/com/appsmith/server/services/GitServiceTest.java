...
public class GitServiceTest {
    ...
    private static final String EMPTY_COMMIT_ERROR_MESSAGE =
    ...
    public void setup() throws IOException, GitAPIException {
        ...
        Mockito.when(
                        gitCloudServicesUtils.getPrivateRepoLimitForOrg(
                                eq(workspaceId), Mockito.anyBoolean()))
        ...
        gitConnectedApplication =
                createApplicationConnectedToGit("gitConnectedApplication", DEFAULT_BRANCH);
    ...
    private Application createApplicationConnectedToGit(
            String name, String branchName, String workspaceId)
            throws IOException, GitAPIException {
        ...
        Mockito.when(gitFileUtils.checkIfDirectoryIsEmpty(Mockito.any(Path.class)))
                .thenReturn(Mono.just(true));
        Mockito.when(
                        gitFileUtils.initializeReadme(
                                Mockito.any(Path.class), Mockito.anyString(), Mockito.anyString()))
                .thenReturn(Mono.just(Paths.get("textPath")));
        Mockito.when(
                        gitFileUtils.saveApplicationToLocalRepo(
                                Mockito.any(Path.class),
    ...
    public void connectApplicationToGit_EmptyRemoteUrl_ThrowInvalidParameterException() {
        ...
        Mono<Application> applicationMono =
                gitService.connectApplicationToGit("testID", gitConnectDTO, "baseUrl");
    ...
    public void connectApplicationToGit_EmptyOriginHeader_ThrowInvalidParameterException() {
        ...
        GitConnectDTO gitConnectDTO =
                getConnectRequest("git@github.com:test/testRepo.git", testUserProfile);
        Mono<Application> applicationMono =
                gitService.connectApplicationToGit("testID", gitConnectDTO, null);
    ...
    @WithUserDetails(value = "api_user")
    public void
            connectApplicationToGit_InvalidGitApplicationMetadata_ThrowInvalidGitConfigurationException() {
                ...
                .expectErrorMatches(
                        throwable -> {
                            ...
                            assertThat(throwable.getMessage())
                                    .contains(
                                            AppsmithError.INVALID_GIT_SSH_CONFIGURATION.getMessage(
                                                    "origin"));
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void connectApplicationToGit_InvalidRemoteUrl_ThrowInvalidRemoteUrl()
            throws IOException {
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void connectApplicationToGit_InvalidRemoteUrlHttp_ThrowInvalidRemoteUrl()
        ...
        GitConnectDTO gitConnectDTO =
                getConnectRequest("https://github.com/test/testRepo.git", testUserProfile);
    ...
    public void connectApplicationToGit_InvalidFilePath_ThrowIOException() throws IOException {
        ...
        GitConnectDTO gitConnectDTO =
                getConnectRequest("git@github.com:test/testy.git", testUserProfile);
        Mono<Application> applicationMono =
                gitService.connectApplicationToGit(application1.getId(), gitConnectDTO, "baseUrl");
                ...
                .expectErrorMatches(
                        throwable ->
                                throwable instanceof AppsmithException
                                        && throwable
                                                .getMessage()
                                                .contains("Error while accessing the file system"))
                .verify();
    }
                        ...
                        throwable ->
                                throwable instanceof AppsmithException
                                        && throwable
                                                .getMessage()
                                                .contains(
                                                        AppsmithError.INVALID_GIT_REPO
                                                                .getMessage()))
                .verify();
    }
    ...
    public void connectApplicationToGit_cloneException_throwGitException() throws IOException {
        ...
        GitConnectDTO gitConnectDTO =
                getConnectRequest("git@github.com:test/testRepo.git", testUserProfile);
        Mono<Application> applicationMono =
                gitService.connectApplicationToGit(
                        gitConnectedApplication.getId(), gitConnectDTO, "baseUrl");
                        ...
                        throwable ->
                                throwable instanceof AppsmithException
                                        && throwable
                                                .getMessage()
                                                .equals(
                                                        AppsmithError.GIT_GENERIC_ERROR.getMessage(
                                                                "error message")))
                .verify();
    }
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void connectApplicationToGit_WithEmptyPublishedPages_CloneSuccess()
            throws IOException, GitAPIException {
        ...
        StepVerifier.create(applicationMono)
                .assertNext(
                        application -> {
                            GitApplicationMetadata gitApplicationMetadata1 =
                                    application.getGitApplicationMetadata();
                            assertThat(gitApplicationMetadata1.getRemoteUrl())
                                    .isEqualTo(gitConnectDTO.getRemoteUrl());
                            assertThat(gitApplicationMetadata1.getBranchName())
                                    .isEqualTo("defaultBranchName");
    ...
    public void connectApplicationToGit_WithoutGitProfileUsingDefaultProfile_CloneSuccess()
        ...
        GitConnectDTO gitConnectDTO =
                getConnectRequest("git@github.com:test/testRepo.git", gitProfile);
        Mono<Application> applicationMono =
                gitService.connectApplicationToGit(application1.getId(), gitConnectDTO, "baseUrl");
    ...
    @WithUserDetails(value = "api_user")
    public void
            connectApplicationToGit_WithoutGitProfileUsingLocalProfile_ThrowAuthorNameUnavailableError() {

        GitProfile gitProfile = new GitProfile();
        gitProfile.setAuthorName(null);
        gitProfile.setAuthorEmail(null);
        // Use repo specific git profile but as this is empty default profile will be used as a
        // fallback
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void connectApplicationToGit_WithNonEmptyPublishedPages_CloneSuccess()
            throws IOException, GitAPIException {
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void connectApplicationToGit_moreThanThreePrivateRepos_throwException()
            throws IOException, GitAPIException {
    ...
    @WithUserDetails(value = "api_user")
    public void
            connectApplicationToGit_toggleAccessibilityToPublicForConnectedApp_connectSuccessful()
                    throws IOException, GitAPIException {
        Workspace workspace = new Workspace();
        ...
        Application application1 =
                this.createApplicationConnectedToGit(
                        "private_repo_1", "master", limitPrivateRepoTestWorkspaceId);
        this.createApplicationConnectedToGit(
                "private_repo_2", "master", limitPrivateRepoTestWorkspaceId);
        ...
        application1
                ...
                .setBrowserSupportedRemoteUrl("https://www.google.com/");
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void connectApplicationToGit_WithValidCustomGitDomain_CloneSuccess()
            throws IOException, GitAPIException {
        ...
        GitConnectDTO gitConnectDTO =
                getConnectRequest(
                        "git@github.test.net:user/test/tests/testRepo.git", testUserProfile);
        Mono<Application> applicationMono =
                gitService.connectApplicationToGit(application1.getId(), gitConnectDTO, "baseUrl");
    ...
    public void updateGitMetadata_EmptyData_Success() {
        ...
        Mono<Application> applicationMono =
                gitService.updateGitMetadata(application1.getId(), gitApplicationMetadata1);
                ...
                .expectErrorMatches(
                        throwable ->
                                throwable instanceof AppsmithException
                                        && throwable
                                                .getMessage()
                                                .contains("Git metadata values cannot be null"))
                .verify();
    }
    ...
    public void detachRemote_applicationWithActionAndActionCollection_Success() {
        ...
        Mono<Application> applicationMono =
                applicationPageService
                        ...
                        .flatMap(
                                application -> {
                                    // Update the defaultIds for resources to mock merge action from
                                    // other branch
                                    application
                                            .getPages()
                                            .forEach(
                        ...
                        .flatMap(
                                tuple -> {
                                    ...
                                    actionCollectionDTO.setDefaultToBranchedActionIdsMap(
                                            Map.of("branchedId", "collectionId"));
        ...
        Mono<Application> resultMono =
                applicationMono.flatMap(
                        application -> gitService.detachRemote(application.getId()));
                ...
                .assertNext(
                        tuple -> {
                            ...
                            application
                                    ...
                                    .forEach(
                                            page ->
                                                    assertThat(page.getDefaultPageId())
                ...
                .expectErrorMatches(
                        throwable ->
                                throwable instanceof AppsmithException
                                        & throwable
                                                .getMessage()
                                                .contains("Git configuration is invalid"))
                .verify();
    }
                                        ...
                                        && throwable
                                                ...
                                                .equals(
                                                        AppsmithError.INVALID_GIT_CONFIGURATION
                                                                .getMessage(GIT_CONFIG_ERROR)))
                .verify();
    }

    @Test
    @WithUserDetails(value = "api_user")
    public void listBranchForApplication_applicationWithInvalidGitConfig_throwError()
            throws IOException {
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void listBranchForApplication_defaultBranchNotChangesInRemote_Success()
            throws IOException, GitAPIException {
        List<GitBranchDTO> branchList = new ArrayList<>();
        GitBranchDTO gitBranchDTO = new GitBranchDTO();
        gitBranchDTO.setBranchName("defaultBranch");
        ...
        Application application1 =
                createApplicationConnectedToGit(
                        "listBranchForApplication_pruneBranchNoChangesInRemote_Success",
                        "defaultBranch");
    ...
    public void listBranchForApplication_defaultBranchChangesInRemoteExistsInDB_Success()
        ...
        Application application1 =
                createApplicationConnectedToGit(
                        "listBranchForApplication_pruneBranchWithBranchNotExistsInDB_Success",
                        "defaultBranch");
        // Create branch
        Application application2 =
                createApplicationConnectedToGit(
                        "listBranchForApplication_defaultBranchChangesInRemoteExistsInDB_Success",
                        "feature1");
        ...
        Mono<Application> applicationUpdatedMono =
                gitService
    ...
    public void listBranchForApplication_defaultBranchChangesInRemoteDoesNotExistsInDB_Success()
        ...
        Mockito.when(
                        gitFileUtils.reconstructApplicationJsonFromGitRepo(
                                Mockito.anyString(),
                                Mockito.anyString(),
                                Mockito.anyString(),
                                Mockito.anyString()))
        ...
        Application application1 =
                createApplicationConnectedToGit(
                        "listBranchForApplication_defaultBranchChangesInRemoteDoesNotExistsInDB_Success",
                        "defaultBranch");
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void pullChanges_upstreamChangesAvailable_pullSuccess()
            throws IOException, GitAPIException {
        Application application =
                createApplicationConnectedToGit(
                        "UpstreamChangesInRemote", "upstreamChangesInRemote");
                ...
                .assertNext(
                        gitPullDTO -> {
                            assertThat(gitPullDTO.getMergeStatus().getStatus())
                                    .isEqualTo("2 commits pulled");
                            assertThat(gitPullDTO.getApplication()).isNotNull();
                            assertThat(gitPullDTO.getApplication().getId())
                                    .isEqualTo(application.getId());
                        })
                .verifyComplete();
    }
    ...
    public void pullChanges_FileSystemAccessError_throwError() throws IOException, GitAPIException {
        Application application =
                createApplicationConnectedToGit("FileSystemAccessError", "fileSystemErr");
        MergeStatusDTO mergeStatusDTO = new MergeStatusDTO();
        mergeStatusDTO.setStatus("2 commits pulled");
        mergeStatusDTO.setMergeAble(true);
                ...
                .expectErrorMatches(
                        throwable ->
                                throwable instanceof AppsmithException
                                        && throwable
                                                .getMessage()
                                                .contains("Error accessing the file System"))
                .verify();
    }

    @Test
    @WithUserDetails(value = "api_user")
    public void pullChanges_noUpstreamChanges_nothingToPullMessage()
            throws IOException, GitAPIException {
        Application application =
                createApplicationConnectedToGit("noChangesInRemotePullException", "syncedBranch");
        ...
        StepVerifier.create(applicationMono)
                .assertNext(
                        gitPullDTO -> {
                            assertThat(gitPullDTO.getMergeStatus().getStatus())
                                    .isEqualTo(
                                            "Nothing to fetch from remote. All changes are upto"
                                                    + " date.");
                        })
                .verifyComplete();
    }
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void isBranchMergeable_nonConflictingChanges_canBeMerged()
            throws IOException, GitAPIException {

        Application application = createApplicationConnectedToGit("noConflictsApp", "main");
        Application application1 =
                createApplicationConnectedToGit("noConflictsApp", "branchWithNoConflicts");
        ...
        Mono<MergeStatusDTO> applicationMono =
                gitService.isBranchMergeable(application.getId(), gitMergeDTO);
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void isBranchMergeable_conflictingChanges_canNotBeMerged()
            throws IOException, GitAPIException {

        Application application =
                createApplicationConnectedToGit("conflictingChanges", "branchWithConflicts");

        application
                .getGitApplicationMetadata()
                .setDefaultApplicationId(gitConnectedApplication.getId());
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void isBranchMergeable_remoteAhead_remoteAheadErrorMessage()
            throws IOException, GitAPIException {

        Application application1 =
                createApplicationConnectedToGit(
                        gitConnectedApplication.getName(), "upstreamChangesBeforeMerge");
        GitApplicationMetadata gitApplicationMetadata = application1.getGitApplicationMetadata();
    ...
    @WithUserDetails(value = "api_user")
    public void
            isBranchMergeable_checkMergingWithRemoteBranch_throwsUnsupportedOperationException() {
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void checkoutRemoteBranch_notPresentInLocal_newApplicationCreated()
    ...
    public void checkoutBranch_branchNotProvided_throwInvalidParameterError() {
        ...
        Mono<Application> applicationMono =
                gitService.checkoutBranch(gitConnectedApplication.getId(), null);
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void commitApplication_noChangesInLocal_emptyCommitMessage()
            throws GitAPIException, IOException {
        ...
        Mono<String> commitMono =
                gitService.commitApplication(
                        commitDTO, gitConnectedApplication.getId(), DEFAULT_BRANCH);
    ...
    public void commitApplication_applicationNotConnectedToGit_throwInvalidGitConfigException() {
        ...
        Mono<String> commitMono =
                gitService.commitApplication(commitDTO, application.getId(), DEFAULT_BRANCH);
                ...
                .thenReturn(
                        Mono.error(
                                new RepositoryNotFoundException(
                                        AppsmithError.REPOSITORY_NOT_FOUND.getMessage())));
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void commitAndPushApplication_commitAndPushChanges_success()
            throws GitAPIException, IOException {
        ...
        StepVerifier.create(
                        commitAndPushMono.zipWhen(
                                status ->
                                        applicationService.findByIdAndBranchName(
                                                gitConnectedApplication.getId(), DEFAULT_BRANCH)))
                .assertNext(
                        tuple -> {
                            ...
                            assertThat(application.getClientSchemaVersion())
                                    .isEqualTo(JsonSchemaVersions.clientVersion);
                            assertThat(application.getServerSchemaVersion())
    ...
    @WithUserDetails(value = "api_user")
    public void
            commitApplication_pushFails_verifyAppNotPublished_throwUpstreamChangesFoundException()
                    throws GitAPIException, IOException {
        ...
        Application preCommitApplication =
                applicationService
                        .getApplicationByDefaultApplicationIdAndDefaultBranch(
        ...
        Mono<String> commitMono =
                gitService.commitApplication(
                        commitDTO, preCommitApplication.getId(), DEFAULT_BRANCH);

        Mono<Application> committedApplicationMono =
                applicationService.getApplicationByDefaultApplicationIdAndDefaultBranch(
                        preCommitApplication.getId());
        ...
        StepVerifier.create(committedApplicationMono)
                .assertNext(
                        application -> {
                            ...
                            publishedPages.forEach(
                                    publishedPage -> {
                                        assertThat(
                                                        publishedPage
                                                                .getId()
                                                                .equals(createdPage.getId()))
                                                .isFalse();
                                    });
                        })
                .verifyComplete();
    ...
    public void commitApplication_protectedBranch_pushFails() throws GitAPIException, IOException {
        ...
        Application testApplication =
                createApplicationConnectedToGit(
                        "commitApplication_protectedBranch_pushFails", DEFAULT_BRANCH);
        Application preCommitApplication =
                applicationService
                        .getApplicationByDefaultApplicationIdAndDefaultBranch(
                                testApplication.getId())
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void createBranch_validCreateBranchRequest_newApplicationCreated()
            throws GitAPIException, IOException {
                        ...
                        .flatMap(
                                application ->
                                        Mono.zip(
                                                ...
                                                pluginRepository.findByPackageName(
                                                        "installed-plugin"),
                                                newPageService.findPageById(
                                                        application.getPages().get(0).getId(),
                                                        READ_PAGES,
                ...
                .assertNext(
                        tuple -> {
                            ...
                            assertThat(application.getId())
                                    .isNotEqualTo(gitData.getDefaultApplicationId());
                            assertThat(gitData.getDefaultApplicationId())
                                    .isEqualTo(parentApplication.getId());
                            assertThat(gitData.getBranchName())
    ...
    public void createBranch_SrcHasCustomTheme_newApplicationCreatedWithThemesCopied()
        ...
        Mono<Tuple2<Application, Application>> createBranchMono =
                applicationPageService
                        .createApplication(testApplication)
                        .flatMap(
                                application ->
        ...
        StepVerifier.create(createBranchMono)
                .assertNext(
                        tuple -> {
                            ...
                            assertThat(srcApp.getEditModeThemeId())
                                    .isNotEqualTo(branchedApp.getEditModeThemeId());
                            assertThat(srcApp.getPublishedModeThemeId())
                                    .isNotEqualTo(branchedApp.getPublishedModeThemeId());
                        })
                .verifyComplete();
    }
        ...
        Mono<Tuple2<Application, Application>> createBranchMono =
                applicationPageService
                        ...
                        .flatMap(
                                application ->
                                        gitService.connectApplicationToGit(
                                                application.getId(), gitConnectDTO, "origin"))
                        .flatMap(
                                application ->
                                        gitService
                                                .createBranch(
                        ...
                        .flatMap(
                                branchedApplication -> {
                                    Application.NavigationSetting appNavigationSetting =
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void createBranch_BranchUploadLogo_SrcBranchRemainsUnchanged()
            throws GitAPIException, IOException {
        GitBranchDTO createGitBranchDTO = new GitBranchDTO();
        createGitBranchDTO.setBranchName("valid_branch");
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void createBranch_BranchDeleteLogo_SrcLogoRemainsUnchanged()
            throws GitAPIException, IOException {
        GitBranchDTO createGitBranchDTO = new GitBranchDTO();
        createGitBranchDTO.setBranchName("valid_branch");
                ...
                .assertNext(
                        tuple -> {
                            ...
                            assertThat(
                                    ...
                                    .isNull();
                            assertThat(
                                            srcApp.getUnpublishedApplicationDetail()
                                                    .getNavigationSetting())
                                    .isNotNull();
                            assertThat(
                                            srcApp.getUnpublishedApplicationDetail()
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void createBranch_BranchSetPageIcon_SrcBranchPageIconRemainsNull()
            throws GitAPIException, IOException {
        GitBranchDTO createGitBranchDTO = new GitBranchDTO();
        createGitBranchDTO.setBranchName("valid_branch");
                ...
                applicationPageService
                        ...
                        .flatMap(
                                applicationTuple -> {
                                    ...
                                    return Mono.zip(
                                            applicationPageService.createPageWithBranchName(
                                                    newBranchPage, otherBranchName),
                                            applicationPageService.createPageWithBranchName(
                                                    newSrcPage, srcBranchName));
                                });
    ...
    public void connectApplicationToGit_cancelledMidway_cloneSuccess() throws IOException {
        ...
        Mono<Application> gitConnectedAppFromDbMono =
                Mono.just(application1)
                        .flatMap(
                                application -> {
                                    try {
                                        // Before fetching the git connected application, sleep for
                                        // 5 seconds to ensure that the clone
                                        // completes
                                        Thread.sleep(5000);
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void commitAndPushApplication_cancelledMidway_pushSuccess()
            throws GitAPIException, IOException {
        ...
        Mono<Application> appFromDbMono =
                Mono.just(gitConnectedApplication)
                        .flatMap(
                                application -> {
                                    try {
                                        // Before fetching the git connected application, sleep for
                ...
                .assertNext(
                        application -> {
                            assertThat(application.getPages())
                                    .isEqualTo(application.getPublishedPages());
                        })
                .verifyComplete();
    }
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void createBranch_cancelledMidway_newApplicationCreated()
            throws GitAPIException, IOException {
        ...
        Application application1 =
                createApplicationConnectedToGit(
                        "createBranch_cancelledMidway_newApplicationCreated", "master");
        gitService
                .createBranch(
                        application1.getId(),
                        createGitBranchDTO,
        ...
        Mono<Application> branchedAppMono =
                Mono.just(application1)
                        .flatMap(
                                application -> {
                                    try {
    ...
    public void importApplicationFromGit_InvalidRemoteUrl_ThrowError() {
        ...
        Mono<ApplicationImportDTO> applicationMono =
                gitService.importApplicationFromGit("testID", gitConnectDTO);
    ...
    public void importApplicationFromGit_emptyWorkspaceId_ThrowError() {
        GitConnectDTO gitConnectDTO =
                getConnectRequest("git@github.com:test/testRepo.git", testUserProfile);
        Mono<ApplicationImportDTO> applicationMono =
                gitService.importApplicationFromGit(null, gitConnectDTO);
    ...
    public void importApplicationFromGit_privateRepoLimitReached_ThrowApplicationLimitError() {
        ...
        Mono<ApplicationImportDTO> applicationMono =
                gitService1.importApplicationFromGit(workspaceId, gitConnectDTO);
    ...
    public void importApplicationFromGit_emptyRepo_ThrowError() {
        ...
        Mono<ApplicationImportDTO> applicationMono =
                gitService.importApplicationFromGit(workspaceId, gitConnectDTO);
                ...
                .expectErrorMatches(
                        throwable ->
                                throwable instanceof AppsmithException
                                        && throwable
                                                .getMessage()
                                                .contains("Cannot import app from an empty repo"))
                .verify();
    }
    ...
    public void importApplicationFromGit_validRequestWithDuplicateApplicationName_Success() {
        GitConnectDTO gitConnectDTO =
                getConnectRequest("git@github.com:test/testGitRepo.git", testUserProfile);
        GitAuth gitAuth = gitService.generateSSHKey(null).block();
    ...
    public void importApplicationFromGit_validRequestWithDuplicateDatasourceOfSameType_Success() {
        ...
        GitConnectDTO gitConnectDTO =
                getConnectRequest("git@github.com:test/testGitImportRepo.git", testUserProfile);
        GitAuth gitAuth = gitService.generateSSHKey(null).block();
    ...
    @WithUserDetails(value = "api_user")
    public void
            importApplicationFromGit_validRequestWithDuplicateDatasourceOfSameTypeCancelledMidway_Success() {
        Workspace workspace = new Workspace();
        ...
        GitConnectDTO gitConnectDTO =
                getConnectRequest(
                        "git@github.com:test/testGitImportRepoCancelledMidway.git",
                        testUserProfile);
        GitAuth gitAuth = gitService.generateSSHKey(null).block();
        ...
        Mockito.when(
                        gitCloudServicesUtils.getPrivateRepoLimitForOrg(
                                eq(testWorkspaceId), Mockito.anyBoolean()))
                .thenReturn(Mono.just(3));
        Mockito.when(
                        gitExecutor.cloneApplication(
                                Mockito.any(Path.class),
                        ...
                        .flatMap(
                                ignore -> {
                                    ...
                                    return applicationService
                                            ...
                                            .filter(
                                                    application1 ->
                                                            "testGitImportRepoCancelledMidway"
                                                                    .equals(application1.getName()))
                                            .next();
                                });
                ...
                .assertNext(
                        application -> {
                            assertThat(application.getName())
                                    .isEqualTo("testGitImportRepoCancelledMidway");
                            assertThat(application.getGitApplicationMetadata()).isNotNull();
                            assertThat(application.getGitApplicationMetadata().getBranchName())
                                    .isEqualTo("defaultBranch");
                            assertThat(
    ...
    @WithUserDetails(value = "api_user")
    public void
            importApplicationFromGit_validRequestWithDuplicateDatasourceOfDifferentType_ThrowError() {
        GitConnectDTO gitConnectDTO =
                getConnectRequest("git@github.com:test/testGitImportRepo1.git", testUserProfile);
        gitService.generateSSHKey(null).block();
        ApplicationJson applicationJson = createAppJson(filePath).block();
                        ...
                        throwable ->
                                throwable instanceof AppsmithException
                                        && throwable
                                                .getMessage()
                                                .contains(
                                                        "Datasource already exists with the same"
                                                                + " name"))
                .verify();
    }
    ...
    public void importApplicationFromGit_validRequestWithEmptyRepo_ThrowError() {
        GitConnectDTO gitConnectDTO =
                getConnectRequest("git@github.com:test/emptyRepo.git", testUserProfile);
        GitAuth gitAuth = gitService.generateSSHKey(null).block();
    ...
    public void deleteBranch_staleBranchNotInDB_Success() throws IOException, GitAPIException {
        Application application =
                createApplicationConnectedToGit(
                        "deleteBranch_staleBranchNotInDB_Success", "master");
    ...
    public void deleteBranch_existsInDB_Success() throws IOException, GitAPIException {
        Application application =
                createApplicationConnectedToGit("deleteBranch_existsInDB_Success", "master");
    ...
    public void deleteBranch_branchDoesNotExist_ThrowError() throws IOException, GitAPIException {
        Application application =
                createApplicationConnectedToGit(
                        "deleteBranch_branchDoesNotExist_ThrowError", "master");
        application.getGitApplicationMetadata().setDefaultBranchName("test");
        applicationService.save(application).block();
        Mockito.when(gitExecutor.deleteBranch(Mockito.any(Path.class), Mockito.anyString()))
                .thenReturn(Mono.just(false));
                        ...
                        throwable ->
                                throwable instanceof AppsmithException
                                        && throwable
                                                .getMessage()
                                                .contains(
                                                        "delete branch. Branch does not exists in"
                                                                + " the repo"))
                .verify();
    }
    ...
    public void deleteBranch_defaultBranch_ThrowError() throws IOException, GitAPIException {
        Application application =
                createApplicationConnectedToGit("deleteBranch_defaultBranch_ThrowError", "master");
        application.getGitApplicationMetadata().setDefaultBranchName("master");
        applicationService.save(application).block();
        Mockito.when(gitExecutor.deleteBranch(Mockito.any(Path.class), Mockito.anyString()))
                .thenReturn(Mono.just(false));
                ...
                .expectErrorMatches(
                        throwable ->
                                throwable instanceof AppsmithException
                                        && throwable
                                                .getMessage()
                                                .contains("Cannot delete default branch"))
                .verify();
    }
    ...
    public void deleteBranch_defaultBranchUpdated_Success() throws IOException, GitAPIException {
        Application application =
                createApplicationConnectedToGit(
                        "deleteBranch_defaultBranchUpdated_Success1", "master");
        application.getGitApplicationMetadata().setDefaultBranchName("f1");
        applicationService.save(application).block();

        Application branchApp =
                createApplicationConnectedToGit("deleteBranch_defaultBranchUpdated_Success2", "f1");
                ...
                .assertNext(
                        application1 -> {
                            ...
                            assertThat(application1.getName())
                                    .isEqualTo("deleteBranch_defaultBranchUpdated_Success1");
                        })
                .verifyComplete();
    }

    // We are only testing git level operations from this testcase. For testcases related to
    // scenarios like
    // 1. Resource is added
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void discardChanges_upstreamChangesAvailable_discardSuccess()
            throws IOException, GitAPIException {
        Application application =
                createApplicationConnectedToGit("discard-changes", "discard-change-branch");
        MergeStatusDTO mergeStatusDTO = new MergeStatusDTO();
        mergeStatusDTO.setStatus("2 commits pulled");
        mergeStatusDTO.setMergeAble(true);
        ...
        StepVerifier.create(applicationMono)
                .assertNext(
                        application1 -> {
                            assertThat(application1.getPages())
                                    .isNotEqualTo(application.getPages());
                        })
                .verifyComplete();
    }
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void discardChanges_cancelledMidway_discardSuccess()
            throws IOException, GitAPIException {
        Application application =
                createApplicationConnectedToGit(
                        "discard-changes-midway", "discard-change-midway-branch");
        MergeStatusDTO mergeStatusDTO = new MergeStatusDTO();
        mergeStatusDTO.setStatus("Nothing to fetch from remote. All changes are upto date.");
        mergeStatusDTO.setMergeAble(true);
        ...
        // Wait for git clone to complete
        Mono<Application> applicationFromDbMono =
                Mono.just(application)
                        .flatMap(
                                application1 -> {
                                    try {
    ...
    public void deleteBranch_cancelledMidway_success() throws GitAPIException, IOException {
        ...
        Application application =
                createApplicationConnectedToGit(
                        "deleteBranch_defaultBranchUpdated_Success", DEFAULT_BRANCH);
        application.getGitApplicationMetadata().setDefaultBranchName(DEFAULT_BRANCH);
        applicationService.save(application).block();

        Application branchApp =
                createApplicationConnectedToGit(
                        "deleteBranch_defaultBranchUpdated_Success2", TO_BE_DELETED_BRANCH);
        ...
        Mono<List<Application>> applicationsFromDbMono =
                Mono.just(application)
                        .flatMapMany(
                                DBApplication -> {
                                    try {
                                        // Before fetching the git connected application, sleep for
                                        // 5 seconds to ensure that the delete
                                        // completes
                                        Thread.sleep(5000);
                                    } catch (InterruptedException e) {
                                        e.printStackTrace();
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void commitAndPushApplication_WithMultipleUsers_success()
            throws GitAPIException, IOException {
        GitCommitDTO commitDTO = new GitCommitDTO();
        commitDTO.setDoPush(true);
        commitDTO.setCommitMessage("test commit");
    ...
    @Test
    @WithUserDetails(value = "api_user")
    public void getGitConnectedApps_privateRepositories_Success()
            throws GitAPIException, IOException {
        ...
        Mockito.when(
                        gitCloudServicesUtils.getPrivateRepoLimitForOrg(
                                eq(localWorkspaceId), Mockito.anyBoolean()))
                .thenReturn(Mono.just(-1));
