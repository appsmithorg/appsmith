	...
	Map.of(
		...
		"UpdateQuery",
			"UPDATE sampleTable SET\n"
				...
				+ " update_form.formData.field2 : update_form.sourceData.field2}}',\n"
				+ "    \"field3\" = '{{update_form.fieldState.field3.isVisible ?"
				+ " update_form.formData.field3 : update_form.sourceData.field3}}',\n"
				+ "\t\t\"field4\" = '{{update_form.fieldState.field4.isVisible ?"
				+ " update_form.formData.field4 : update_form.sourceData.field4}}'\n"
...
public void setup() {
	...
	// have more number of columns than the user provided table which leads to deleting the column
	// names from action configuration
