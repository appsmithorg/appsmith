...
public class WorkspaceServiceTest {
    ...
    public void createDefaultWorkspace() {
        ...
        Mono<User> userMono = userRepository.findByEmail("api_user@test.com").cache();
        ...
        StepVerifier.create(Mono.zip(Mono.just(workspace), userMono, defaultPermissionGroupMono, userPermissionGroupsSetMono))
                .assertNext(tuple -> {
                    ...
                    assertThat(workspace1.getEmail()).isEqualTo("api_user@test.com");
    ...
    public void validCreateWorkspaceTest() {
        ...
        Mono<User> userMono = userRepository.findByEmail("api_user@test.com");
    ...
    @Test
    @WithMockUser(username = "api_user@test.com")
    ...
    public void getAllMembersForWorkspace() {
        ...
        StepVerifier
                ...
                .assertNext(users -> {
                    ...
                    assertThat(userAndGroupDTO.getUsername()).isEqualTo("api_user@test.com");
    ...
    public void addUserToWorkspaceAsAdminAndCheckApplicationAndDatasourcePermissions() {
        ...
        Mono<User> api_userMono = userService.findByEmail("api_user@test.com");
    ...
    public void delete_WithoutManagePermission_ThrowsException() {
        ...
        Policy readWorkspacePolicy = Policy.builder()
                ...
                .users(Set.of("api_user@test.com", "test_user@example.com"))
                .build();
