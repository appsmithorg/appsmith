...
public void testCreateMockDataSetsMongo() {
	...
	StepVerifier.create(mockDataService.createMockDataSet(mockDataSource))
		.assertNext(
			createdDatasource -> {
			...
			DBAuth auth =
				(DBAuth) createdDatasource.getDatasourceConfiguration().getAuthentication();
...
public void testCreateMockDataSetsDuplicateName() {
	...
	Mono<Datasource> datasourceMono =
		mockDataService
			.createMockDataSet(mockDataSource)
