...
public class MockDataServiceTest {
                ...
                .assertNext(
                        mockDataSets -> {
                            ...
                            assertThat(mockDataSets.getMockdbs())
                                    .anyMatch(
                                            data ->
                                                    data.getName().equals("Movies")
                                                            && data.getPackageName()
                                                                    .equals("mongo-plugin"))
                                    .anyMatch(
                                            data ->
                                                    data.getName().equals("Users")
                                                            && data.getPackageName()
                                                                    .equals("postgres-plugin"));
                        })
                .verifyComplete();
    }
    ...
    public void testCreateMockDataSetsMongo() {
        ...
        StepVerifier.create(mockDataService.createMockDataSet(mockDataSource, environmentId))
                .assertNext(
                        createdDatasource -> {
                            assertThat(createdDatasource.getId()).isNotEmpty();
                            assertThat(createdDatasource.getPluginId())
                                    .isEqualTo(pluginMono.getId());
    ...
    public void testCreateMockDataSetsDuplicateName() {
        ...
        Mono<DatasourceDTO> datasourceMono =
                mockDataService
                        .createMockDataSet(mockDataSource, environmentId)
                        .flatMap(
                                datasource ->
                                        mockDataService.createMockDataSet(
                                                mockDataSource, environmentId));
