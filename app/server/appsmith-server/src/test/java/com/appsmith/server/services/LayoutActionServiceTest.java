...
public class LayoutActionServiceTest {
    ...
    public void setup() {
        ...
        jsDatasource.setWorkspaceId(orgId);
    ...
    public void refactorDuplicateActionName() {
        ...
        duplicateNameCompleteAction.setWorkspaceId(duplicateName.getOrganizationId());
    ...
    public void testRefactorCollection_withModifiedName_ignoresName() {
        ...
        originalActionCollectionDTO.setOrganizationId(testApp.getWorkspaceId());
