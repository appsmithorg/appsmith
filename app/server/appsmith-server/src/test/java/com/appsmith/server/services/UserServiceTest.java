...
public class UserServiceTest {
    ...
    @MockBean PasswordResetTokenRepository passwordResetTokenRepository;
    ...
    @SpyBean CommonConfig commonConfig;
    ...
    public void checkEmailParamsForExistingUser() {
        ...
        Map<String, String> params =
                userService.getEmailParams(workspace, inviter, inviteUrl, false);
    ...
    public void checkEmailParamsForNewUser() {
        ...
        Map<String, String> params =
                userService.getEmailParams(workspace, inviter, inviteUrl, true);
    ...
    public void updateInvalidUserWithAnything() {
        ...
        Mono<User> userMono1 =
                Mono.just(existingUser)
                        .flatMap(user -> userService.update(user.getId(), updateUser));
                                        ...
                                        && throwable
                                                ...
                                                .equals(
                                                        AppsmithError.NO_RESOURCE_FOUND.getMessage(
                                                                FieldName.USER,
                                                                "Random-UserId-%Not-In_The-System_For_SUre")))
                .verify();
    }
                        ...
                        throwable ->
                                throwable instanceof AppsmithException
                                        && throwable
                                                .getMessage()
                                                .equals(
                                                        AppsmithError.INVALID_CREDENTIALS
                                                                .getMessage()))
                .verify();
    }
    ...
    public void createNewUserValid() {
        ...
        Mono<PermissionGroup> permissionGroupMono =
                userCreateMono.flatMap(
                        user -> {
                            ...
                            assertThat(userPolicies)
                                    .containsAll(
                                            Set.of(
                                                    ...
                                                    readUserPolicy,
                                                    resetPasswordPolicy));
                            assertThat(permissionGroup.getAssignedToUserIds())
                                    .containsAll(Set.of(user.getId()));
                        })
                .verifyComplete();
    }
                ...
                .flatMap(
                        workspace1 -> {
                            ...
                            inviteUsersDTO.setPermissionGroupId(
                                    workspace1.getDefaultPermissionGroups().stream()
                                            .findFirst()
                                            .get());

                            return userAndAccessManagementService.inviteUsers(
                                    inviteUsersDTO, "http://localhost:8080");
                        })
                .block();
    ...
    public void getAllUsersTest() {
        Flux<User> userFlux =
                userService.get(CollectionUtils.toMultiValueMap(new LinkedCaseInsensitiveMap<>()));
    ...
    public void updateNameRoleAndUseCaseOfUser() {
        ...
        final Mono<Tuple2<User, UserData>> resultMono =
                userService
                        .updateCurrentUser(updateUser, null)
                        .flatMap(
                                user ->
    ...
    public void createUserAndSendEmail_WhenUserExistsWithEmailInOtherCase_ThrowsException() {
        ...
        StepVerifier.create(userAndSendEmail)
                .expectErrorMessage(
                        AppsmithError.USER_ALREADY_EXISTS_SIGNUP.getMessage(
    ...
    public void forgotPasswordTokenGenerate_AfterTrying3TimesIn24Hours_ThrowsException() {
        ...
        Mockito.when(passwordResetTokenRepository.findByEmail(testEmail))
    ...
    public void verifyPasswordResetToken_WhenTokenDoesNotExist_ThrowsException() {
        ...
        StepVerifier.create(
                        userService.verifyPasswordResetToken(
                                getEncodedToken(testEmail, "123456789")))
    ...
    private void testResetPasswordTokenMatch(String token1, String token2, boolean expectedResult) {
        ...
        StepVerifier.create(
                        userService.verifyPasswordResetToken(getEncodedToken(testEmail, token2)))
    ...
    /**
     * This test case asserts that on every user creation, User Management role is auto-created and
    ...
    public void testCreateNewUser_assertUserManagementRole() {
        ...
        assertThat(
                        createdUser.getPolicies().stream()
                                .anyMatch(
                                        policy ->
                                                policy.getPermission()
                                                        .equals(MANAGE_USERS.getValue())))
                .isTrue();
        Policy manageUserPolicy =
                createdUser.getPolicies().stream()
                        .filter(
