...
public class PageServiceTest {
        ...
        .assertNext(
            tuple -> {
              ...
              assertThat(page.getPolicies())
                  .containsOnly(
                      managePagePolicy, readPagePolicy, deletePagePolicy, createPageActionsPolicy);
  ...
  public void clonePage() {
    ...
    Mono<List<NewAction>> actionsMono =
        pageMono
            .flatMapMany(page1 -> newActionService.findByPageId(page1.getId(), READ_ACTIONS))
            .collectList();

    Mono<List<ActionCollection>> actionCollectionMono =
        pageMono
            .flatMapMany(page1 -> actionCollectionService.findByPageId(page1.getId()))
            .collectList();
    ...
    StepVerifier.create(
        ...
        .assertNext(
            tuple -> {
              ...
              assertThat(parentPageCollections.get(0).getUnpublishedCollection().getPageId())
    ...
    StepVerifier.create(
        ...
        .assertNext(
            tuple -> {
              ...
              assertThat(
                      actions.stream()
                          .filter(
                              clonedAction ->
                                  "PageAction"
                                      .equals(clonedAction.getUnpublishedAction().getName()))
                          .findFirst()
                          .get()
                          .getUnpublishedAction()
                          .getExecuteOnLoad())
              ...
              assertThat(collection.getUnpublishedCollection().getDefaultResources().getPageId())
                  .isEqualTo(clonedPage.getDefaultResources().getPageId());
