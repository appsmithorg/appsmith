...
import com.appsmith.server.actions.base.ActionServiceCEImpl;
...
public class ActionServiceUnitTest {
    ...
    ActionServiceCEImpl newActionService;
    ...
    @BeforeEach
    public void setup() {
        newActionService = new ActionServiceCEImpl(
                scheduler,
                validator,
                mongoConverter,
    ...
    public void testMissingPluginIdAndTypeFixForNonJSPluginType() {
        ...
        Mono<Action> updatedActionFlux = newActionService.sanitizeAction(action);
