...
public class DatasourceServiceTest {
        ...
        StepVerifier.create(datasourceMono)
                .assertNext(createdDatasource -> {
                    ...
                    assertThat(createdDatasource
                                    ...
                                    .getName())
                            .isEqualTo("ssl_key_file_id2");
                    assertThat(createdDatasource.getDatasourceConfiguration().getAuthentication() instanceof OAuth2)
                            .isTrue();
                })
                .verifyComplete();
    }
    ...
    public void testDatasourceValid() {
        ...
        Mono<DatasourceTestResult> testResultMono = datasourceDTOMono.flatMap(
                datasource1 -> datasourceService.testDatasource(datasource1, defaultEnvironmentId));
    ...
    public void testDatasourceEmptyFields() {
        ...
        Mono<DatasourceTestResult> testResultMono = datasourceDTOMono.flatMap(datasource1 -> {
