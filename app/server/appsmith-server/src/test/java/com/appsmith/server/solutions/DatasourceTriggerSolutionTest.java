...
public class DatasourceTriggerSolutionTest {
    ...
    @MockBean DatasourceStructureSolution datasourceStructureSolution;

    @MockBean PluginExecutorHelper pluginExecutorHelper;

    @MockBean PluginExecutor pluginExecutor;

    @Autowired DatasourceTriggerSolution datasourceTriggerSolution;
    ...
    public void datasourceTriggerTest() {
        ...
        DatasourceStructure.Table table1 =
                new DatasourceStructure.Table(
                        TABLE, null, "Table1", List.of(table1Columns), null, null);
        ...
        DatasourceStructure.Table table2 =
                new DatasourceStructure.Table(
                        TABLE, null, "Table2", List.of(table2Columns), null, null);
        ...
        Mono<TriggerResultDTO> tableNameMono =
                datasourceTriggerSolution.trigger(
                        datasourceId,
                        null,
                        new TriggerRequestDTO(
                                "ENTITY_SELECTOR", Map.of(), ClientDataDisplayType.DROP_DOWN));

        Mono<TriggerResultDTO> columnNamesMono =
                datasourceTriggerSolution.trigger(
                        datasourceId,
                        null,
                        new TriggerRequestDTO(
