...
public class UserWorkspaceServiceUnitTest {
  ...
  public void getWorkspaceMembers_WhenRoleIsNull_ReturnsEmptyList() {
    ...
    /**
     * Removing the Default Workspace ID from auto-created permission groups so that while fetching
     * the Users and Groups, we should get empty list.
     */
  ...
  public void getWorkspaceMembers_WhenNoOrgFound_ThrowsException() {
    ...
    StepVerifier.create(workspaceMembers)
        .expectErrorMessage(
            AppsmithError.NO_RESOURCE_FOUND.getMessage(FieldName.WORKSPACE, sampleWorkspaceId))
        .verify();
  }
