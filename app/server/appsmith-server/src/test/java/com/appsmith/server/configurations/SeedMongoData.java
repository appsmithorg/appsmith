    ...
    ApplicationRunner init(
        ...
        Object[][] userData = {
            ...
            },
            {
                ...
                new HashSet<>(
                        Arrays.asList(
                                userManageWorkspacePolicy, readApiUserPolicy, manageApiUserPolicy))
            },
            {
                "admin test",
                ADMIN_USER_EMAIL,
                                            ...
                                            .flatMap(
                                                    savedPermissionGroup -> {
                                                        Map<String, Policy> crudUserPolicies =
                                                                policyUtils
                                                                        .generatePolicyFromPermissionGroupForObject(
                                                                                savedPermissionGroup,
                                                                                user.getId());

                                                        User updatedWithPolicies =
                                                                policyUtils
                                                                        .addPoliciesToExistingObject(
                                                                                crudUserPolicies,
                                                                                user);
        ...
        Flux<Workspace> workspaceFlux =
                mongoTemplate
                        ...
                        .map(
                                plugin ->
                                        new WorkspacePlugin(
                                                plugin.getId(), WorkspacePluginStatus.FREE))
                        ...
                        .map(
                                tuple -> {
                                    ...
                                    userRole.setRole(
                                            AppsmithRole.generateAppsmithRoleFromName(roleName));
                                    ...
                                    log.debug(
                                            "In the workspaceFlux. Create Workspace: {}",
                                            workspace);
                                    return workspace;
                                })
                        ...
                        workspace ->
                                userFlux.flatMap(
                                        user -> {
                                            ...
                                            log.debug(
                                                    "AddUserWorkspace User: {}, Workspace: {}",
                                                    user,
                                                    workspace);
