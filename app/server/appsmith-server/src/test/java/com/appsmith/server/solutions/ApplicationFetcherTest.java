...
public class ApplicationFetcherTest {
    ...
    public void getAllApplications_WhenUnpublishedPageExists_ReturnsApplications() {
        ...
        Mono<UserHomepageDTO> homepageDTOMono =
                workspaceService
                        .create(newWorkspace)
                        .flatMap(
                                workspace -> {
                ...
                .assertNext(
                        userHomepageDTO -> {
                            ...
                            assertThat(orgApps.getApplications().get(0).getPublishedPages().size())
                                    .isEqualTo(1);
                            assertThat(orgApps.getApplications().get(0).getPages().size())
                                    .isEqualTo(2);
                        });
    }
}
