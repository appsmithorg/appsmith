        ...
        pageMono
            .flatMap(
                page1 -> {
                  ...
                  // Action aPostActionWithAutoExec depends on
                  // [aPostSecondaryAction, aPostTertiaryAction]
                  action = new ActionDTO();
                  ...
                  action
                      ...
                      .setBody(
                          "this won't be auto-executed:"
                              + " {{aPostSecondaryAction.data}}, but this"
                              + " one will be:"
                ...
                tuple2 -> {
                  ...
                  obj.putAll(
                      Map.of(
                          ...
                          // only add sync function call dependencies in
                          // the dependency tree. sync call would be done
                          // during eval.
                          "collection4Key",
    ...
    StepVerifier.create(testMono)
        .assertNext(
            layoutDTO -> {
              ...
              // Since this is still a bad mustache binding, we couldn't have
              // extracted the action name
