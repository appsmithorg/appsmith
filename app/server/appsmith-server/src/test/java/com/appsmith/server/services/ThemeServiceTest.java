  ...
  public void
    ...
    Mono<Theme> createAndApplyCustomThemeMono =
        themeService
            ...
            .flatMap(
                theme ->
                    themeService.changeCurrentTheme(theme.getId(), savedApplication.getId(), null))
            .flatMap(
                theme -> {
  ...
  public void publishTheme_WhenCustomThemeIsSet_ThemeCopiedForPublishedMode() {
    ...
    Mono<Theme> createAndApplyCustomThemeMono =
        themeService
            ...
            .flatMap(
                theme -> themeService.changeCurrentTheme(theme.getId(), application.getId(), null));
    // publish the theme
                ...
                tuple -> {
                  ...
                  Policy readThemePolicy =
                      theme.getPolicies().stream()
                          .filter(
                              themePolicy ->
                                  themePolicy.getPermission().equals(READ_THEMES.getValue()))
                          .findFirst()
                          .get();
        ...
        .assertNext(
            tuple4 -> {
              ...
              assertThat(availableThemes.size())
                  .isEqualTo(systemThemesCount + 1); // one custom theme + existing system
              // themes
              ...
              assertThat(application.getEditModeThemeId())
                  .isNotEqualTo(
                      persistedThemeWithReadPermission.getId()); // a new copy should be created
            })
        .verifyComplete();
  }
