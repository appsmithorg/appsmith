...
public class ThemeServiceTest {
    ...
    @Autowired private UserWorkspaceService userWorkspaceService;
    ...
    public void getApplicationTheme_WhenThemeIsSet_ThemesReturned() {
        ...
        // Publish app
        Mono<Application> publishApp =
                applicationPageService.publish(savedApplication.getId(), TRUE);
        // apply classic theme to the application
        Mono<Theme> applyClassicTheme =
                themeService.changeCurrentTheme(
                        classicTheme.getId(), savedApplication.getId(), null);

        Mono<Tuple2<Theme, Theme>> applicationThemesMono =
                applySharpTheme
                        .then(publishApp)
                        .then(applyClassicTheme)
                        .then(
                                Mono.zip(
                                        themeService.getApplicationTheme(
    ...
    public void getApplicationTheme_WhenUserHasNoPermission_ExceptionThrows() {
        ...
        Mono<Tuple2<Theme, Theme>> applicationThemesMono =
                Mono.zip(
                        themeService.getApplicationTheme(
                                savedApplication.getId(), ApplicationMode.EDIT, null),
                        themeService.getApplicationTheme(
                                savedApplication.getId(), ApplicationMode.PUBLISHED, null));

        StepVerifier.create(applicationThemesMono)
                .expectErrorMessage(
                        AppsmithError.NO_RESOURCE_FOUND.getMessage(
                                FieldName.APPLICATION, savedApplication.getId()))
                .verify();
    }
    ...
    public void changeCurrentTheme_WhenUserHasPermission_ThemesSetInEditMode() {
        ...
        Mono<Theme> applyRoundedTheme =
                themeService.changeCurrentTheme(
                        roundedTheme.getId(), savedApplication.getId(), null);

        Mono<Application> applicationPostThemeUpdatesMono =
                applyClassicTheme
                ...
                .assertNext(
                        objects -> {
                            ...
                            assertThat(oldApplication.getEditModeThemeId())
                                    .isEqualTo(oldApplication.getPublishedModeThemeId());
                            // edit mode and published mode has different theme id in updated
                            // application
                            assertThat(updatedApplication.getEditModeThemeId())
                                    .isNotEqualTo(updatedApplication.getPublishedModeThemeId());
                            // edit mode theme id has changed from old application to new
                            // application
                            assertThat(oldApplication.getEditModeThemeId())
                                    .isNotEqualTo(updatedApplication.getEditModeThemeId());
                            // published mode theme id remains same in old application and new
                            // application
    ...
    public void changeCurrentTheme_WhenUserHasNoPermission_ThrowsException() {
        ...
        Mono<Theme> changeCurrentThemeMono =
                themeService.changeCurrentTheme(
                        savedApplication.getEditModeThemeId(), savedApplication.getId(), null);

        StepVerifier.create(changeCurrentThemeMono).expectError(AppsmithException.class).verify();
    }
    ...
    @Test
    public void
            changeCurrentTheme_WhenSystemThemeSetOverCustomTheme_NewThemeNotCreatedAndOldOneDeleted() {

        Application savedApplication = createApplication();

        Theme customTheme = new Theme();
        customTheme.setName("my-custom-theme");
        Mono<Theme> createAndApplyCustomThemeMono =
                themeService
                        ...
                        .flatMap(
                                theme ->
                                        themeService.changeCurrentTheme(
                                                theme.getId(), savedApplication.getId(), null))
                        .flatMap(
                                theme -> {
                                    // Mark this custom theme as not an application theme
                                    // Don't know why a theme will not be associated with an
                                    // application if it is not a system theme
                                    theme.setApplicationId(null);
                                    return themeService.save(theme);
                                });

        Mono<Theme> applyDefaultThemeMono =
                themeService
                        .getDefaultThemeId()
                        .flatMap(
                                themeId ->
                                        themeService.changeCurrentTheme(
                                                themeId, savedApplication.getId(), null));

        Mono<Theme> newApplicationThemeMono =
                createAndApplyCustomThemeMono
                        .then(applyDefaultThemeMono)
                        .then(
                                themeService.getApplicationTheme(
                                        savedApplication.getId(), ApplicationMode.EDIT, null));

        Mono<Theme> oldApplicationThemeMono =
                themeService
                ...
                .assertNext(
                        themeTuple2 -> {
                            ...
                            assertThat(oldTheme.getId())
                                    .isNotNull(); // TODO : Change assertion to null if it should be
                            // deleted.
                        })
                .verifyComplete();
    }
    ...
    public void cloneThemeToApplication_WhenSrcThemeIsSystemTheme_NoNewThemeCreated() {
        ...
        Mono<Tuple2<Theme, Theme>> newAndOldThemeMono =
                themeService
    ...
    public void cloneThemeToApplication_WhenSrcThemeIsCustomTheme_NewThemeCreated() {
        ...
        Theme customTheme = new Theme();
        customTheme.setName("my-custom-theme");
        Mono<Theme> createCustomThemeMono =
                themeService
                        .persistCurrentTheme(savedApplication.getId(), null, customTheme)
                        .flatMap(
                                theme -> {
    ...
    public void cloneThemeToApplication_WhenSrcThemeIsCustomSavedTheme_NewCustomThemeCreated() {
        ...
        Theme customTheme = new Theme();
        customTheme.setName("my-custom-theme");
        Mono<Theme> createCustomTheme =
                themeService.persistCurrentTheme(savedApplication.getId(), null, customTheme);
        // ^ This theme is created with application id set.

        Mono<Tuple2<Theme, Theme>> newAndOldThemeMono =
                createCustomTheme.flatMap(
                        theme -> {
                            return themeService
                                    .cloneThemeToApplication(theme.getId(), savedApplication)
                                    .zipWith(Mono.just(theme));
        ...
        StepVerifier.create(newAndOldThemeMono)
                .assertNext(
                        objects -> {
                            ...
                            assertThat(clonnedTheme.getDisplayName())
                                    .isEqualTo(srcTheme.getDisplayName());
                ...
                .assertNext(
                        objects -> {
                            ...
                            assertThat(application.getEditModeThemeId())
                                    .isEqualTo(classicSystemTheme.getId());
                            assertThat(application.getEditModeThemeId())
                                    .isEqualTo(application.getPublishedModeThemeId());
                        })
                .verifyComplete();
    }
        ...
        Mono<Theme> createAndApplyCustomThemeMono =
                themeService
                        ...
                        .flatMap(
                                theme ->
                                        themeService.changeCurrentTheme(
                                                theme.getId(), application.getId(), null));
        // publish the theme
        Mono<Theme> publishThemeMono = themeService.publishTheme(application.getId());

        Mono<Tuple2<Theme, Theme>> appThemesMono =
                createAndApplyCustomThemeMono
                        .then(publishThemeMono)
                        .then(
                                Mono.zip(
                                        themeService.getApplicationTheme(
                                                application.getId(), ApplicationMode.EDIT, null),
                                        themeService.getApplicationTheme(
                                                application.getId(),
                                                ApplicationMode.PUBLISHED,
                                                null)));
        ...
        StepVerifier.create(appThemesMono)
                .assertNext(
                        objects -> {
                            ...
                            assertThat(editModeTheme.getId())
                                    .isNotEqualTo(publishedModeTheme.getId()); // different id
                        })
                .verifyComplete();
    }
    ...
    public void updateTheme_WhenSystemThemeIsSet_NewThemeCreated() {
        ...
        Theme systemDefaultTheme =
                themeService.getThemeById(application.getEditModeThemeId(), READ_THEMES).block();
        ...
        StepVerifier.create(appThemesMono)
                .assertNext(
                        objects -> {
                            ...
                            Theme publishedModeTheme =
                                    objects.getT2(); // should be the system theme
                            assertThat(editModeTheme.getDisplayName())
                                    .isEqualTo(updatesToSystemTheme.getDisplayName());
                            assertThat(editModeTheme.getId())
                                    .isNotEqualTo(publishedModeTheme.getId()); // different id
    ...
    public void updateTheme_WhenCustomThemeIsSet_ThemeIsOverridden() {
        ...
        themeService
                ...
                .flatMap(
                        theme ->
                                themeService.changeCurrentTheme(theme.getId(), applicationId, null))
                .block();
        ...
        Mono<Theme> updateThemeMono =
                themeService.updateTheme(application.getId(), null, themeCustomization);

        Mono<Tuple3<Theme, Theme, Application>> appThemesMono =
                updateThemeMono.then(
                        Mono.zip(
                                themeService.getApplicationTheme(
                                        application.getId(), ApplicationMode.EDIT, null),
                                themeService.getApplicationTheme(
                                        application.getId(), ApplicationMode.PUBLISHED, null),
        ...
        StepVerifier.create(appThemesMono)
                .assertNext(
                        objects -> {
                            ...
                            assertThat(appBeforeUpdateTheme.getEditModeThemeId())
                                    .isEqualTo(editModeTheme.getId());
                            assertThat(appBeforeUpdateTheme.getPublishedModeThemeId())
    ...
    public void publishTheme_WhenNoThemeIsSet_SystemDefaultThemeIsSetToPublishedMode() {
        ...
        Mono<Theme> classicThemeMono =
                themeRepository.getSystemThemeByName(Theme.LEGACY_THEME_NAME);
    ...
    public void publishTheme_WhenApplicationIsPublic_PublishedThemeIsPublic() {
        ...
        // Make the app public.
        Mono<Application> makeAppPublicMono =
                applicationPageService.publish(savedApplication.getId(), TRUE);

        // Publish the theme
        Mono<Theme> publishThemeMono = themeService.publishTheme(savedApplication.getId());

        Mono<Theme> getPublishedApplicationThemeMono =
                themeService
                        .getApplicationTheme(
                                savedApplication.getId(), ApplicationMode.PUBLISHED, null)
        ...
        Mono<List<PermissionGroup>> anonymousUserPermissionsMono =
                Mono.zip(getPublishedApplicationThemeMono, anonymousUserMono)
                        .flatMap(
                                tuple -> {
                                    Theme theme = tuple.getT1();
                                    User anonymousUser = tuple.getT2();

                                    Policy readThemePolicy =
                                            theme.getPolicies().stream()
                                                    .filter(
                                                            themePolicy ->
                                                                    themePolicy
                                                                            .getPermission()
    ...
    public void persistCurrentTheme_WhenCustomThemeIsSet_NewApplicationThemeCreated() {
        ...
        Mono<Theme> persistCustomThemeMono =
                themeService.persistCurrentTheme(savedApplication.getId(), null, theme).cache();

        Mono<Tuple4<List<Theme>, Theme, Application, Theme>> tuple4Mono =
                persistCustomThemeMono
                        .then(
                                themeService
        ...
        StepVerifier.create(tuple4Mono)
                .assertNext(
                        tuple4 -> {
                            ...
                            long systemThemesCount =
                                    availableThemes.stream()
                                            .filter(
                                                    availableTheme ->
                                                            availableTheme.isSystemTheme())
                                            .count();
                            assertThat(availableThemes.size())
                                    .isEqualTo(
                                            systemThemesCount
                                                    + 1); // one custom theme + existing system
                            // themes
                            ...
                            assertThat(persistedThemeWithReadPermission.getWorkspaceId())
                                    .isEqualTo(
                                            this.workspace
                                                    .getId()); // theme should have workspace id set
                            assertThat(application.getEditModeThemeId())
                                    .isNotEqualTo(
                                            persistedThemeWithReadPermission
                                                    .getId()); // a new copy should be created
                        })
                .verifyComplete();
    }
    ...
    public void delete_WhenUnsavedCustomizedTheme_NotAllowed() {
        ...
        Theme themeCustomization = new Theme();
        themeCustomization.setDisplayName("Updated name");
        Mono<Theme> deleteThemeMono =
                themeService
                        .updateTheme(savedApplication.getId(), null, themeCustomization)
                        .flatMap(
                                customizedTheme ->
                                        themeService.archiveById(customizedTheme.getId()));
                ...
                Mono.just(application)
                        .flatMap(
                                savedApplication -> {
                                    Theme themeCustomization = new Theme();
                                    themeCustomization.setDisplayName("Updated name");
                                    return themeService.persistCurrentTheme(
                                            savedApplication.getId(), null, themeCustomization);
                                })
                        .flatMap(
                                customizedTheme ->
                                        themeService
                                                ...
                                                .then(
                                                        themeService.getThemeById(
                                                                customizedTheme.getId(),
                                                                READ_THEMES)));
    ...
    public void updateName_WhenSystemTheme_NotAllowed() {
        Mono<Theme> updateThemeNameMono =
                themeService
                        .getDefaultThemeId()
                        .flatMap(
                                themeId -> {
                        ...
                        .flatMap(
                                customizedTheme -> {
                                    ...
                                    return themeService
                                            ...
                                            .then(
                                                    themeService.getThemeById(
                                                            customizedTheme.getId(), READ_THEMES));
                                });
        ...
        Mono<Application> applicationMono =
                Mono.just(application)
                        .flatMap(
                                savedApplication ->
                                        themeService
                                                .importThemesToApplication(
                                                        savedApplication, applicationJson)
                                                .thenReturn(savedApplication.getId()))
                        .flatMap(
                                applicationId ->
                                        applicationRepository.findById(
                                                applicationId, MANAGE_APPLICATIONS));
                        ...
                        app -> {
                            assertThat(
                                            app.getEditModeThemeId()
                                                    .equals(app.getPublishedModeThemeId()))
                                    .isFalse();
                        })
                .verifyComplete();
    }
