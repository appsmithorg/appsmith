...
public class ApplicationForkingServiceTests {
  ...
  public void setup() {
    ...
    PageDTO testPage =
        newPageService.findPageById(app1.getPages().get(0).getId(), READ_PAGES, false).block();
  ...
  public void test1_cloneWorkspaceWithItsContents() {
    ...
    final Mono<ApplicationImportDTO> resultMono =
        workspaceService
            ...
            .flatMap(
                targetWorkspaceId ->
                    applicationForkingService.forkApplicationToWorkspace(
  ...
  public void test2_forkApplicationWithReadApplicationUserAccess() {
    ...
    Application targetApplication =
        applicationForkingService
            .forkApplicationToWorkspace(sourceAppId, testUserWorkspaceId)
            .block()
            .getApplication();
  ...
  public void test3_failForkApplicationWithInvalidPermission() {
    ...
    final Mono<ApplicationImportDTO> resultMono =
        applicationForkingService.forkApplicationToWorkspace(sourceAppId, testUserWorkspaceId);
  ...
  public void test4_validForkApplication_cancelledMidWay_createValidApplication() {
    ...
    applicationForkingService
        .forkApplicationToWorkspace(sourceAppId, targetWorkspace.getId())
  ...
  public void
    ...
    Application forkedApplication =
        applicationForkingService
            .forkApplicationToWorkspace(createdSrcApplication.getId(), createdDestWorkspace.getId())
            .block()
            .getApplication();
    ...
    final Mono<Tuple4<Theme, Theme, Application, Application>> tuple4Mono =
        Mono.zip(
            ...
            Mono.just(forkedApplication), Mono.just(createdSrcApplication));
  ...
  public void forkApplicationToWorkspace_WhenAppHasSystemTheme_SystemThemeSet() {
    ...
    Application createdSrcApplication =
        applicationPageService.createApplication(application, createdWorkspace.getId()).block();
  ...
  public void forkApplicationToWorkspace_WhenAppHasCustomSavedTheme_NewCustomThemeCreated() {
    ...
    application.setName("app_" + uniqueString);
    Application createdSrcApplication =
        applicationPageService.createApplication(application, createdSrcWorkspace.getId()).block();
  ...
  public void forkApplication_deletePageAfterBeingPublished_deletedPageIsNotCloned() {
    ...
    Application resultApplication =
        applicationForkingService
            .forkApplicationToWorkspace(pageDTO.getApplicationId(), targetWorkspaceId)
            .block()
            .getApplication();
            ...
            tuple -> {
              ...
              NewPage deletedPage =
                  originalPages.stream()
                      .filter(
                          newPage ->
                              pageDTO.getName().equals(newPage.getUnpublishedPage().getName()))
                      .findAny()
                      .orElse(null);
  ...
  public void forkApplication_WhenContainsInternalFields_InternalFieldsNotForked() {
    ...
    Application resultApplication =
        applicationForkingService
            .forkApplicationToWorkspace(srcApp.getId(), targetWorkspaceId)
            .block()
            .getApplication();
    final Mono<Application> resultMono = Mono.just(resultApplication);
  ...
  public void
    ...
    Mono<ApplicationImportDTO> resultMono =
        applicationForkingService.forkApplicationToWorkspace(srcApp.getId(), targetWorkspaceId);
