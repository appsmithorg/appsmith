...
public class WorkspaceRepositoryTest {
    ...
    public void updateUserRoleNames_WhenUserIdMatched_AllOrgsUpdated() {
        ...
        Mono<Tuple2<Workspace, Workspace>> updatedOrgTupleMono =
                aveOrgsMonoZip
                        .flatMap(
                                objects -> {
                        ...
                        .flatMap(
                                workspaceTuple2 -> {
                                    ...
                                    Mono<Workspace> updatedOrg1Mono =
                                            workspaceRepository.findBySlug(org1.getId());
                                    Mono<Workspace> updatedOrg2Mono =
                                            workspaceRepository.findBySlug(org2.getId());
