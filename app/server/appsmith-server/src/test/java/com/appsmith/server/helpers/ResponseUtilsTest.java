...
public void getApplication_withDefaultIdsPresent_returnsUpdatedApplication() {
	...
	// Check if the id and defaultPage ids for pages are not same before we update the application
	// using responseUtils
	...
	// Check if the id and defaultPage ids for pages are same after we update the application from
	// responseUtils
	for (ApplicationPage applicationPage : application.getPages()) {
