...
public class ResponseUtilsTest {
  ...
  public void getAction_withDefaultIdsPresent_returnsUpdatedAction() {
    ...
    assertEquals(
        newActionCopy.getDefaultResources().getApplicationId(), newAction.getApplicationId());
  ...
  public void getActionCollection_withDefaultIdsPresent_returnsUpdatedActionCollection() {
    ...
    assertEquals(
        actionCollectionCopy.getDefaultResources().getCollectionId(), actionCollection.getId());
    assertEquals(
