    ...
    public void setup() {
        ...
        PermissionGroup adminPermissionGroup =
                permissionGroupService
                        .getByDefaultWorkspace(
                                savedWorkspace, AclPermission.READ_PERMISSION_GROUP_MEMBERS)
                        .collectList()
                        .block()
                        .stream()
                        .filter(
        ...
        permissionGroupService
                .cleanPermissionGroupCacheForUsers(
                        List.of(userAdmin.getEmail(), userDeveloper.getEmail()))
                .block();
    }
    ...
    public void testAdminPermissionsForInviteAndMakePublic() {
        ...
        PermissionGroup viewerPermissionGroup =
                permissionGroupService
                        ...
                        .filter(
                                permissionGroupElem ->
                                        permissionGroupElem.getName().startsWith(FieldName.VIEWER))
                        .findFirst()
                        .get();
