...
public class ApplicationServiceCETest {
    ...
    @Autowired ApplicationPageServiceCE applicationPageService;
    ...
    @Autowired NewPageRepository newPageRepository;
    ...
    private Mono<? extends BaseDomain> getArchivedResource(
            String id, Class<? extends BaseDomain> domainClass) {
        Query query = new Query(where("id").is(id));

        final Query actionQuery =
                query(where(fieldName(QNewAction.newAction.applicationId)).exists(true))
                        .addCriteria(
                                where(
     ...
     *
     * @param applicationName This is the initial name of the application which will try to create
     *     the application, but not guaranteed this will be the application's final name due to
     *     retry logic
     * @param applicationFinalName This is the application final name and it can be different from
     *     initial name due to retry if there is name clash.
     */
    private void createAndVerifyValidApplication(
            String applicationName, String applicationFinalName) {
        ...
        StepVerifier.create(
                ...
                .assertNext(
                        tuple2 -> {
                            ...
                            assertThat(application.getSlug())
                                    .isEqualTo(TextUtils.makeSlug(applicationFinalName));
                            ...
                            assertThat(application.getEvaluationVersion())
                                    .isEqualTo(EVALUATION_VERSION);
                            assertThat(application.getApplicationVersion())
                                    .isEqualTo(ApplicationVersion.LATEST_VERSION);
                                    ...
                                    Policy.builder()
                                            ...
                                            .permissionGroups(
                                                    Set.of(
                                                            ...
                                                            developerPermissionGroup.getId()))
                                            .build();
                            Policy exportAppPolicy =
                                    Policy.builder()
                                            .permission(EXPORT_APPLICATIONS.getValue())
                                            .permissionGroups(Set.of(adminPermissionGroup.getId()))
                                            .build();
                            Policy deleteApplicationsPolicy =
                                    Policy.builder()
                                            .permission(
                                                    AclPermission.DELETE_APPLICATIONS.getValue())
                                            .permissionGroups(
                                                    Set.of(
                                                            adminPermissionGroup.getId(),
                                                            developerPermissionGroup.getId()))
                                            .build();
                            Policy createPagesPolicy =
                                    Policy.builder()
                                            .permission(
    ...
    public void createValidApplication() {
        this.createAndVerifyValidApplication(
                "ApplicationServiceTest TestApp", "ApplicationServiceTest TestApp");
    }
    ...
    public void createApplicationWithDuplicateName() {
        ...
        // Creating second App with same name "ApplicationServiceTest TestApp" but due to duplicate
        // name its resultant
        // name will be ApplicationServiceTest TestApp (1)
        this.createAndVerifyValidApplication(
                "ApplicationServiceTest TestApp", "ApplicationServiceTest TestApp (1)");
    }
    ...
    public void validGetApplicationById() {
        ...
        Mono<Application> getApplication =
                createApplication.flatMap(t -> applicationService.getById(t.getId()));
    ...
    public void validGetApplicationsByName() {
        ...
        Flux<Application> getApplication =
                createApplication.flatMapMany(t -> applicationService.get(params));
        StepVerifier.create(getApplication)
                .assertNext(
                        t -> {
                            assertThat(t).isNotNull();
    ...
    public void validUpdateApplication() {
        ...
        Mono<Application> createApplication =
                applicationPageService.createApplication(application, workspaceId);
        Mono<Application> updateApplication =
                createApplication
                        .map(
                                t -> {
    ...
    public void invalidUpdateApplication() {
        ...
        Mono<Application> updateInvalidApplication =
    ...
    public void reuseDeletedAppName() {
        ...
        Mono<Application> firstAppDeletion =
                applicationPageService
        ...
        StepVerifier.create(allApplications)
                .assertNext(
                        userHomepageDTO -> {
                            ...
                            // In case of anonymous user, we should have errored out. Assert that
                            ...
                            for (WorkspaceApplicationsDTO workspaceApplicationDTO :
                                    workspaceApplicationsDTOs) {
                                if (workspaceApplicationDTO
                                        .getWorkspace()
                                        .getName()
                                        .equals("Spring Test Workspace")) {
                                    assertThat(
                                                    workspaceApplicationDTO
                                                            .getWorkspace()
                                                            .getUserPermissions())
                                    ...
                                    assertThat(application.getUserPermissions())
                                            .contains("read:applications");
                                    assertThat(application.isAppIsExample()).isFalse();
    ...
    public void getOnlyDefaultApplicationsConnectedToGitForHome() {
        ...
        AppsmithBeanUtils.copyNestedNonNullProperties(
                gitConnectedApp.getGitApplicationMetadata(), childBranchGitData);
        ...
        Mono<Application> branchedApplicationMono =
                applicationPageService.createApplication(branchedApplication);

        Mono<List<Application>> gitConnectedAppsMono =
                applicationService
        ...
        StepVerifier.create(
                        branchedApplicationMono.then(
                                Mono.zip(allApplications, gitConnectedAppsMono)))
                .assertNext(
                        tuple -> {
                            ...
                            for (WorkspaceApplicationsDTO workspaceApplicationDTO :
                                ...
                                if (workspaceApplicationDTO
                                    ...
                                    List<Application> applications =
                                            workspaceApplicationDTO.getApplications().stream()
                                                    .filter(
                                                            application ->
                                                                    application
                                                                                    .getGitApplicationMetadata()
                                    ...
                                    assertThat(applications.get(0).getId())
    ...
    public void getAllApplicationsForHomeWhenNoApplicationPresent() {
        ...
        Mono<UserHomepageDTO> allApplications =
                workspaceMono.then(applicationFetcher.getAllApplications());
        ...
        StepVerifier.create(allApplications)
                .assertNext(
                        userHomepageDTO -> {
                            ...
                            assertThat(orgAppDto.getWorkspace().getUserPermissions())
                                    .contains("read:workspaces");
                        })
                .verifyComplete();
    }
    ...
    public void validMakeApplicationPrivate() {
        ...
        ApplicationAccessDTO applicationAccessDTO = new ApplicationAccessDTO();
        Mono<Application> privateAppMono =
                createApplication
                        .flatMap(
                                application1 -> {
                                    applicationAccessDTO.setPublicAccess(true);
    ...
    public void makeApplicationPublic_applicationWithGitMetadata_success() {
        ...
        Mono<Application> publicAppMono =
                applicationService
                        .changeViewAccess(
                                gitConnectedApp.getId(), "testBranch", applicationAccessDTO)
                        .cache();
        ...
        StepVerifier.create(Mono.zip(branchApplicationMono, publicPermissionGroupMono))
                .assertNext(
                        tuple -> {
                            ...
                            assertThat(branchApplication.getPolicies())
                                    .containsAll(Set.of(manageAppPolicy, readAppPolicy));
                        })
                .verifyComplete();
    }
        ...
        StepVerifier.create(branchApplicationMono)
                .assertNext(
                        branchApplication -> {
                            ...
                            assertThat(branchApplication.getPolicies())
                                    .containsAll(Set.of(readAppPolicy, manageAppPolicy));
                        })
                .verifyComplete();
    }
        ...
        final Mono<ActionCollection> actionCollectionMono =
                publicAppMono.then(
                        actionCollectionService.findById(
                                savedActionCollection.getId(), READ_ACTIONS));
        ...
        StepVerifier.create(
                ...
                .assertNext(
                        tuple -> {
                            ...
                            // Check that the action collection used in the app contains public
                            // execute permission
    ...
    public void cloneApplication_applicationWithGitMetadata_success() {
        ...
        Mono<List<PageDTO>> clonedPageListMono =
                clonedApplicationMono
                        .flatMapMany(application -> Flux.fromIterable(application.getPages()))
                        .flatMap(
                                applicationPage ->
                                        newPageService.findPageById(
                                                applicationPage.getId(), READ_PAGES, false))
                        .collectList();

        Mono<List<PageDTO>> srcPageListMono =
                Flux.fromIterable(gitConnectedApp.getPages())
                        .flatMap(
                                applicationPage ->
                                        newPageService.findPageById(
                                                applicationPage.getId(), READ_PAGES, false))
        ...
        StepVerifier.create(
                ...
                .assertNext(
                        tuple -> {
                            ...
                            assertThat(clonedApplication.getName())
                                    .isEqualTo("gitConnectedApp Copy");
                            assertThat(clonedApplication.getPolicies())
                                    .containsAll(Set.of(manageAppPolicy, readAppPolicy));
                            ...
                            Set<String> clonedPageIdsFromDb =
                                    clonedPageList.stream()
                                            .map(page -> page.getId())
                                            .collect(Collectors.toSet());

                            assertThat(clonedPageIdsFromApplication)
                                    .containsAll(clonedPageIdsFromDb);

                            Set<String> srcPageIdsFromDb =
                                    srcPageList.stream()
                                            .map(page -> page.getId())
                                            .collect(Collectors.toSet());
                            Set<String> defaultSrcPageIdsFromDb =
                                    srcPageList.stream()
                            ...
                            for (PageDTO page : clonedPageList) {
                                assertThat(page.getPolicies())
                                        .containsAll(Set.of(readPagePolicy, managePagePolicy));
                                assertThat(page.getApplicationId())
                                        .isEqualTo(clonedApplication.getId());
                            }
                        })
                .verifyComplete();
        ...
        Mono<List<NewPage>> clonedNewPageListMono =
                clonedApplicationMono
                        .flatMapMany(application -> Flux.fromIterable(application.getPages()))
                        .flatMap(
                                applicationPage ->
                                        newPageRepository.findById(applicationPage.getId()))
                        .collectList();

        Mono<List<NewPage>> srcNewPageListMono =
                Flux.fromIterable(gitConnectedApp.getPages())
                        .flatMap(
                                applicationPage ->
                                        newPageService.findByBranchNameAndDefaultPageId(
                                                branchName,
                                                applicationPage.getDefaultPageId(),
                                                READ_PAGES))
                        .collectList();
                        ...
                        tuple -> {
                            ...
                            clonedNewPageList.forEach(
                                    newPage -> {
                                        ...
                                        assertThat(newPage.getDefaultResources().getPageId())
                                                .isEqualTo(newPage.getId());
                                    });

                            List<String> srcPageIdList = new ArrayList<>();
                            List<String> srcDefaultPageIdList = new ArrayList<>();
                            srcNewPageList.forEach(
                                    newPage -> {
                                        srcPageIdList.add(newPage.getId());
                                        srcDefaultPageIdList.add(
                                                newPage.getDefaultResources().getPageId());
                                        assertThat(newPage.getDefaultResources().getApplicationId())
                                                .isEqualTo(newPage.getApplicationId());
                                        assertThat(newPage.getDefaultResources().getPageId())
                            ...
                            assertThat(clonedDefaultPageIdList)
                                    .doesNotContainAnyElementsOf(srcDefaultPageIdList);
                        })
                .verifyComplete();

        // verify that cloned Pages are not renamed

        Mono<List<String>> pageNameListMono =
                clonedPageListMono
                        .flatMapMany(Flux::fromIterable)
                        .map(PageDTO::getName)
                        .collectList();

        Mono<List<String>> testPageNameListMono =
                clonedNewPageListMono
                        .flatMapMany(Flux::fromIterable)
        ...
        StepVerifier.create(Mono.zip(pageNameListMono, testPageNameListMono))
                .assertNext(
                        tuple -> {
                            ...
                            assertThat(pageNameList)
                                    .containsExactlyInAnyOrderElementsOf(testPageNameList);
                        })
                .verifyComplete();
    }
    ...
    public void cloneApplication_applicationWithGitMetadataAndActions_success() {
        ...
        Mono<List<NewAction>> clonedActionListMono =
                clonedApplicationMono
                        .flatMapMany(
                                application ->
                                        newActionService.findAllByApplicationIdAndViewMode(
                                                application.getId(), false, READ_ACTIONS, null))
                        .collectList();

        Mono<List<NewAction>> srcActionListMono =
                newActionService
                        .findAllByApplicationIdAndViewMode(
                                gitConnectedApp.getId(), false, READ_ACTIONS, null)
                        .collectList();

        StepVerifier.create(
                        Mono.zip(
                                clonedApplicationMono,
                                clonedActionListMono,
                                srcActionListMono,
                                defaultPermissionGroupsMono))
                .assertNext(
                        tuple -> {
                            ...
                            Set<String> clonedPageId =
                                    clonedApplication.getPages().stream()
                                            .map(page -> page.getId())
                                            .collect(Collectors.toSet());
                            Set<String> clonedActionIdsFromDb =
                                    clonedActionList.stream()
                                            .map(action1 -> action1.getId())
                                            .collect(Collectors.toSet());
                            Set<String> clonedPageIdsInActionFromDb =
                                    clonedActionList.stream()
                                            .map(
                                                    action1 ->
                                                            action1.getUnpublishedAction()
                                                                    .getPageId())
                                            .collect(Collectors.toSet());
                            Set<String> defaultPageIdsInClonedActionFromDb =
                                    clonedActionList.stream()
                                            .map(
                                                    action1 ->
                                                            action1.getUnpublishedAction()
                                                                    ...
                                                                    .getPageId())
                                            .collect(Collectors.toSet());
                            Set<String> defaultClonedActionIdsFromDb =
                                    clonedActionList.stream()
                                            .map(
                                                    newAction ->
                                                            newAction
                            ...
                            Set<String> srcActionIdsFromDb =
                                    srcActionList.stream()
                                            .map(action1 -> action1.getId())
                                            .collect(Collectors.toSet());
                            Set<String> srcPageIdsInActionFromDb =
                                    srcActionList.stream()
                                            .map(
                                                    action1 ->
                                                            action1.getUnpublishedAction()
                                                                    .getPageId())
                                            .collect(Collectors.toSet());
                            Set<String> defaultPageIdsInSrcActionFromDb =
                                    srcActionList.stream()
                                            .map(
                                                    action1 ->
                                                            action1.getUnpublishedAction()
                                                                    ...
                                                                    .getPageId())
                                            .collect(Collectors.toSet());
                            Set<String> defaultSrcActionIdsFromDb =
                                    srcActionList.stream()
                                            .map(
                                                    newAction ->
                                                            newAction
                            ...
                            assertThat(
                                            Collections.disjoint(
                                                    clonedActionIdsFromDb, srcActionIdsFromDb))
                                    .isTrue();
                            assertThat(clonedPageId).containsAll(clonedPageIdsInActionFromDb);
                            assertThat(
                                            Collections.disjoint(
                                                    defaultClonedActionIdsFromDb,
                                                    defaultSrcActionIdsFromDb))
                                    .isTrue();
                            assertThat(
                                            Collections.disjoint(
                                                    clonedPageIdsInActionFromDb,
                                                    srcPageIdsInActionFromDb))
                                    .isTrue();
                            assertThat(
                                            Collections.disjoint(
                                                    defaultPageIdsInClonedActionFromDb,
                                                    defaultPageIdsInSrcActionFromDb))
                                    .isTrue();
                                ...
                                assertThat(newAction.getPolicies())
                                        .containsAll(
                                                Set.of(
                                                        ...
                                                        executeActionPolicy,
                                                        manageActionPolicy));
                                assertThat(newAction.getApplicationId())
                                        .isEqualTo(clonedApplication.getId());
    ...
    public void cloneApplication_withActionAndActionCollection_success() {
        ...
        Mono<Application> originalApplicationMono =
                applicationPageService.createApplication(testApplication, workspaceId).cache();
                ...
                originalApplicationMono
                        ...
                        .flatMap(
                                tuple -> {
                                    ...
                                    try {
                                        ...
                                        log.debug(
                                                "Error while creating JSONObj from"
                                                        + " defaultPageLayout: ",
                                                e);
                                    }
                                    ...
                                    secondWidget.put(
                                            "testField1", "{{ testCollection1.getData.data }}");
                                    ...
                                    actionCollectionDTO.setWorkspaceId(
                                            application.getWorkspaceId());
                                    actionCollectionDTO.setPluginId(testPlugin.getId());
                                    actionCollectionDTO.setVariables(
                                            List.of(new JSValue("test", "String", "test", true)));
                                    actionCollectionDTO.setBody(
                                            "export default {\n"
                                                + "\tgetData: async () => {\n"
                                    ...
                                    return Mono.zip(
                                            layoutCollectionService.createCollection(
                                                    actionCollectionDTO),
                        ...
                        .flatMap(
                                tuple -> {
                                    ...
                                    tuple.getT4()
                                            .getPages()
                                            .forEach(page -> pageIds.add(page.getId()));
                ...
                .assertNext(
                        tuple -> {
                            ...
                            assertThat(application.getName())
                                    .isEqualTo("ApplicationServiceTest Clone Source TestApp Copy");
                            assertThat(application.getPolicies())
                                    .containsAll(Set.of(manageAppPolicy, readAppPolicy));
                            assertThat(application.getWorkspaceId()).isEqualTo(workspaceId);
                            assertThat(application.getModifiedBy()).isEqualTo("api_user");
                            ...
                            actionList.forEach(
                                    newAction -> {
                                        ...
                                        if (!StringUtils.isEmpty(
                                                action.getDefaultResources().getCollectionId())) {
                                            assertThat(
        ...
        StepVerifier.create(
                ...
                .assertNext(
                        tuple -> {
                            ...
                            assertThat(originalResourceIds.get("collectionIds"))
                                    .containsAll(collectionIds);
                        })
                .verifyComplete();

        Mono<List<PageDTO>> pageListMono =
                resultMono
                        .flatMapMany(application -> Flux.fromIterable(application.getPages()))
                        .flatMap(
                                applicationPage ->
        ...
        // verify that Pages are cloned
        Mono<List<NewPage>> testPageListMono =
                originalApplicationMono
                        .flatMapMany(application -> Flux.fromIterable(application.getPages()))
                        .flatMap(
                                applicationPage ->
        ...
        Mono<List<String>> testPageIdListMono =
                testPageListMono.flatMapMany(Flux::fromIterable).map(NewPage::getId).collectList();
        ...
        Mono<List<String>> pageNameListMono =
                pageListMono.flatMapMany(Flux::fromIterable).map(PageDTO::getName).collectList();
    ...
    public void cloneApplication_withDeletedActionInActionCollection_deletedActionIsNotCloned() {
        ...
        testApplication.setName(
                "ApplicationServiceTest-clone-application-deleted-action-within-collection");
                ...
                originalApplicationMono
                        ...
                        .flatMap(
                                tuple -> {
                                    ...
                                    thirdWidget.put(
                                            "testField1",
                                            "{{ testCollection1.anotherMethod.data }}");
                                ...
                                tuple -> {
                                    ...
                                    return newActionService
                                            .deleteUnpublishedAction(
                                                    deletedActionIdWithinActionCollection)
                                            .thenMany(
                                                    newActionService
                                                            .findAllByApplicationIdAndViewMode(
                                                                    tuple.getT4().getId(),
                        ...
                        tuple -> {
                            ...
                            actionCollectionList.forEach(
                                    actionCollection -> {
                                        ...
                                        // We should have single entry as other action is deleted
    ...
    public void basicPublishApplicationTest() {
        ...
        testApplication
                ...
                .setAppPositioning(
                        new Application.AppPositioning(Application.AppPositioning.Type.FIXED));
        ...
        Mono<List<NewPage>> applicationPagesMono =
                applicationMono
                        ...
                        .flatMap(
                                applicationPage ->
                                        newPageService.findById(
                                                applicationPage.getId(), READ_PAGES))
                        .collectList();
                ...
                .assertNext(
                        tuple -> {
                            ...
                            assertThat(newPage.getUnpublishedPage().getLayouts().get(0).getId())
                                    .isEqualTo(
                                            newPage.getPublishedPage().getLayouts().get(0).getId());
                            ...
                            assertThat(application.getPublishedAppLayout())
                                    .isEqualTo(application.getUnpublishedAppLayout());
                            assertThat(
                                            application
    ...
    /**
     * Method to test if the action, pages and actionCollection are archived after the application
     * is published
     */
    @Test
    @WithUserDetails(value = "api_user")
    public void publishApplication_withArchivedUnpublishedResources_resourcesArchived() {
        ...
        */
        ...
        testApplication
                .getUnpublishedApplicationDetail()
                .setNavigationSetting(appNavigationSetting);
        Mono<Tuple3<NewAction, ActionCollection, NewPage>> resultMono =
                applicationPageService
                        .createApplication(testApplication, workspaceId)
                        .flatMap(
                                application -> {
                        ...
                        .flatMap(
                                tuple -> {
                                    ...
                                    actionCollectionDTO.setWorkspaceId(
                                            testApplication.getWorkspaceId());
                                    actionCollectionDTO.setVariables(
                                            List.of(new JSValue("test", "String", "test", true)));
                                    ActionDTO action1 = new ActionDTO();
        ...
        Mono<NewAction> archivedActionFromActionCollectionMono =
                resultMono.flatMap(
                        tuple -> {
                            final Optional<String> actionId =
                                    tuple
                                            ...
                                            .stream()
                                            .findFirst();
                            return (Mono<NewAction>)
                                    this.getArchivedResource(actionId.get(), NewAction.class);
                        });
                        ...
                        .flatMap(
                                updatedApp ->
                                        applicationPageService.publish(
                                                updatedApp.getId(), gitData.getBranchName(), true))
                        .flatMap(
                                application ->
                                        applicationService.findByBranchNameAndDefaultApplicationId(
                                                gitData.getBranchName(),
    ...
    public void publishApplication_withPageIconSet_success() {
        ...
        Mono<Application> applicationMono =
                applicationPageService.publish(testApplication.getId(), true);
        ...
        StepVerifier.create(Mono.zip(applicationMono, applicationPagesMono))
                .assertNext(
                        tuple -> {
                            ...
                            Optional<NewPage> optionalNewPage =
                                    pages.stream()
                                            .filter(
                                                    thisPage ->
                                                            finalPage
                                                                    .getId()
                                                                    .equals(thisPage.getId()))
                                            .findFirst();
    ...
    public void deleteUnpublishedPageFromApplication() {
        ...
        StepVerifier.create(
                        applicationService.findById(
                                newPage.getApplicationId(), MANAGE_APPLICATIONS))
                .assertNext(
                        editedApplication -> {
                            List<ApplicationPage> publishedPages =
                                    editedApplication.getPublishedPages();
                            assertThat(publishedPages).size().isEqualTo(2);
                            assertThat(publishedPages).containsAnyOf(applicationPage);

                            List<ApplicationPage> editedApplicationPages =
                                    editedApplication.getPages();
        ...
        Mono<Application> applicationMono =
                applicationPageService
                        ...
                        .flatMap(
                                pageDTO ->
                                        applicationPageService.publish(
                                                pageDTO.getApplicationId(), branchName, true))
                        .cache();
                ...
                applicationMono
                        .flatMap(
                                application ->
                                        newPageService
                                                .findByNameAndApplicationIdAndViewMode(
                                                        "Test delete unPublish page test",
                                                        application.getId(),
                                                        READ_PAGES,
                                                        false)
                                                .switchIfEmpty(
    ...
    public void changeDefaultPageForAPublishedApplication() {
        ...
        Mono<Application> updatedDefaultPageApplicationMono =
                applicationMono.flatMap(
                        application ->
                                applicationPageService.makePageDefault(
                                        application.getId(), newPage.getId()));
                        ...
                        editedApplication -> {
                            ...
                            for (ApplicationPage page : publishedPages) {
                                if (page.getId().equals(publishedEditedPage.getId())
                                        && page.getIsDefault()
                                                .equals(publishedEditedPage.getIsDefault())) {
                                    isFound = true;
                                    break;
                                }
                            }
                            ...
                            for (ApplicationPage page : editedApplicationPages) {
                                if (page.getId().equals(unpublishedEditedPage.getId())
                                        && page.getIsDefault()
                                                .equals(unpublishedEditedPage.getIsDefault())) {
                                    isFound = true;
                                    break;
                                }
                            }
    ...
    public void getApplicationInViewMode() {
                        ...
                        .flatMap(
                                application -> {
                                    ...
                                    return customJSLibService
                                            .addJSLibToApplication(
                                                    application.getId(), jsLib, null, false)
        ...
        Mono<Application> viewModeApplicationMono =
                applicationMono.flatMap(
                        application ->
                                applicationService.getApplicationInViewMode(application.getId()));
        ...
        StepVerifier.create(viewModeApplicationMono)
                .assertNext(
                        viewApplication -> {
                            List<ApplicationPage> editedApplicationPages =
                                    viewApplication.getPages();
                            assertThat(editedApplicationPages.size()).isEqualTo(2);
                            boolean isFound = false;
                            for (ApplicationPage page : editedApplicationPages) {
                                if (page.getId().equals(applicationPage.getId())
                                        && page.getIsDefault()
                                                .equals(applicationPage.getIsDefault())) {
                                    isFound = true;
                                    break;
                                }
                            }
    ...
    public void validCloneApplicationWhenCancelledMidWay() {
        ...
        Mono<Application> clonedAppFromDbMono =
                Mono.just(originalApplication)
                        .flatMap(
                                originalApp -> {
                                    try {
                                        // Before fetching the cloned application, sleep for 5
                                        // seconds to ensure that the cloning finishes
                                        Thread.sleep(5000);
        ...
        Mono<List<NewAction>> actionsMono =
                clonedAppFromDbMono.flatMap(
                        clonedAppFromDb ->
                                newActionService
                                        .findAllByApplicationIdAndViewMode(
                                                clonedAppFromDb.getId(), false, READ_ACTIONS, null)
                                        .collectList());

        // Find all pages in new app
        Mono<List<PageDTO>> pagesMono =
                clonedAppFromDbMono
                        .flatMapMany(application -> Flux.fromIterable(application.getPages()))
                        .flatMap(
                                applicationPage ->
        ...
        StepVerifier.create(
                        Mono.zip(
                                clonedAppFromDbMono, actionsMono, pagesMono, actionCollectionsMono))
                .assertNext(
                        tuple -> {
                            ...
                            Set<String> actionCollectionNames =
                            ...
                            assertThat(actionCollectionNames)
                                    .containsExactlyInAnyOrder("testCollection1");
                        })
                .verifyComplete();
    }
    ...
    public void newApplicationShouldHavePublishedState() {
        ...
        Mono<PageDTO> publishedPageMono =
                applicationMono.flatMap(
                        application -> {
                            List<ApplicationPage> publishedPages = application.getPublishedPages();
                            return applicationPageService.getPage(
                                    publishedPages.get(0).getId(), true);
                        });
        ...
        StepVerifier.create(Mono.zip(applicationMono, publishedPageMono))
                .assertNext(
                        tuple -> {
                            ...
                            // Assert that the published page and the unpublished page are one and
                            // the same
                        ...
                        applicationPagesDTO -> {
                            ...
                            List<String> pageNames =
                                    applicationPagesDTO.getPages().stream()
                                            ...
                                            .collect(Collectors.toList());
                            List<String> slugNames =
                                    applicationPagesDTO.getPages().stream()
                                            .map(pageNameIdDTO -> pageNameIdDTO.getSlug())
                                            .collect(Collectors.toList());
                            List<String> pageIconNames =
                                    applicationPagesDTO.getPages().stream()
                                            .map(pageNameIdDTO -> pageNameIdDTO.getIcon())
                                            .collect(Collectors.toList());
                            assertThat(pageNames)
                                    .containsExactly("Page1", "Page2", "Page3", "Page4");
                            assertThat(slugNames)
                                    .containsExactly("page1", "page2", "page3", "page4");
    ...
    public void validChangeViewAccessCancelledMidWay() {
        ...
        Mono<Application> applicationFromDbPostViewChange =
                Mono.just(originalApplication)
                        .flatMap(
                                originalApp -> {
                                    try {
                                        // Before fetching the public application, sleep for 5
                                        // seconds to ensure that the updating
                                    ...
                                    return applicationRepository
                                            .findById(
                                                    originalApplication.getId(), READ_APPLICATIONS)
                                            .flatMap(applicationService::setTransientFields);
                                })
                        .cache();

        Mono<List<NewAction>> actionsMono =
                applicationFromDbPostViewChange.flatMap(
                        clonedAppFromDb ->
                                newActionService
                                        .findAllByApplicationIdAndViewMode(
                                                clonedAppFromDb.getId(), false, READ_ACTIONS, null)
        ...
        Mono<Datasource> datasourceMono =
                applicationFromDbPostViewChange.flatMap(
                        application ->
                                datasourceService.findById(
                                        savedDatasource.getId(), READ_DATASOURCES));
        ...
        StepVerifier.create(
                ...
                .assertNext(
                        tuple -> {
                            ...
                            assertThat(
                                            updatedApplication.getPolicies().stream()
                                                    .filter(
                                                            policy ->
                            ...
                            assertThat(
                                            datasource1.getPolicies().stream()
                                                    .filter(
                                                            policy ->
                                                                    policy.getPermission()
                                                                            .equals(
    ...
    public void generateSshKeyPair_WhenDefaultApplicationIdSet_DefaultApplicationUpdated() {
        ...
        Application savedApplication =
                applicationPageService.createApplication(unsavedMainApp, workspaceId).block();

        Mono<Tuple2<Application, Application>> tuple2Mono =
                applicationService
                        ...
                        .flatMap(
                                savedMainApp -> {
                                    ...
                                    unsavedChildApp.setGitApplicationMetadata(
                                            new GitApplicationMetadata());
                                    unsavedChildApp
                                            .getGitApplicationMetadata()
                                            .setDefaultApplicationId(savedMainApp.getId());
                                    ...
                                    return applicationPageService.createApplication(
                                            unsavedChildApp, workspaceId);
                                })
                        .flatMap(
                                savedChildApp ->
                                        applicationService
                                                .createOrUpdateSshKeyPair(
                                                        savedChildApp.getId(), null)
                        ...
                        .flatMap(
                                savedChildApp -> {
                                    ...
                                    Mono<Application> childAppMono =
                                            applicationRepository.findById(
                                                    savedChildApp.getId(), MANAGE_APPLICATIONS);
                                    Mono<Application> mainAppMono =
                                            applicationRepository.findById(
                                                    mainApplicationId, MANAGE_APPLICATIONS);
        ...
        StepVerifier.create(tuple2Mono)
                .assertNext(
                        applicationTuple2 -> {
                            ...
                            assertThat(metadata.getDefaultApplicationId())
                                    .isEqualTo(mainApp.getId());
    ...
    public void cloneApplication_WithCustomSavedTheme_ThemesAlsoCopied() {
        ...
        Mono<Tuple2<Theme, Tuple2<Application, Application>>> tuple2Application =
                createTheme
                        .then(
                                applicationPageService.createApplication(
                        ...
                        .flatMap(
                                objects ->
                                        themeService
                                                .getThemeById(
                                                        objects.getT1().getEditModeThemeId(),
                                                        MANAGE_THEMES)
        ...
        StepVerifier.create(tuple2Application)
                .assertNext(
                        objects -> {
                            ...
                            assertThat(clonedApp.getEditModeThemeId())
                                    .isNotEqualTo(srcApp.getEditModeThemeId());
    ...
    @WithUserDetails(value = "api_user")
    public void
            getApplicationConnectedToGit_defaultBranchUpdated_returnBranchSpecificApplication() {
        ...
        Mono<Application> getApplication =
                applicationService.findByIdAndBranchName(gitConnectedApp.getId(), "release");
        StepVerifier.create(getApplication)
                .assertNext(
                        application1 -> {
    ...
    /**
     * Test case which proves the non-dependency of isPublic Field in Update Application API
     * Response on the deprecated Application collection isPublic field for a public application The
     * following steps are followed: 1. Create a new app 2. Invoke the changeViewAccess method to
     * set the App "Public" 3. Invoke the update method and assert the "isPublic" field in the
     * response
     */
    @Test
    @WithUserDetails(value = "api_user")
    public void validPublicAppUpdateApplication() {
        ...
        /**
         * Making the App public using changeViewAccess method which changes the permission groups
         * of the app to allow public access
         */
        ApplicationAccessDTO applicationAccessDTO = new ApplicationAccessDTO();
        applicationAccessDTO.setPublicAccess(true);
        Application publicAccessApplication =
                applicationService
                        .changeViewAccess(createdApplication.getId(), applicationAccessDTO)
                        .block();
        ...
        /**
         * Using the Update App method and asserting the response to verify the isPublic field in
         * the response is True which proves it's non-dependency on the deprecated Application
         * collection isPublic field and shows it dependency on the actual app permissions and state
         * of the app which has been set public in this case
         */
        Mono<Application> updatedApplication =
    ...
    public void validPrivateAppUpdateApplication() {
        ...
        /**
         * Making the App private using changeViewAccess method which changes the permission groups
         * of the app to restrict public access
         */
        ApplicationAccessDTO applicationAccessDTO = new ApplicationAccessDTO();
        applicationAccessDTO.setPublicAccess(false);

        Application privateAccessApplication =
                applicationService
                        .changeViewAccess(createdApplication.getId(), applicationAccessDTO)
                        .block();
        ...
        /**
         * Using the Update App method and asserting the response to verify the isPublic field in
         * the response is False which proves it's non-dependency on the deprecated Application
         * collection isPublic field and shows it dependency on the actual app permissions and state
         * of the app which has been set private in this case
         */
        Mono<Application> updatedApplication =
    ...
    public void testUploadAndDeleteNavigationLogo_validImage() {
        ...
        String createdApplicationId =
                createTestApplication("ApplicationServiceTest Upload/Delete Nav Logo");

        final Mono<Application> saveMono =
                applicationService
                        .saveAppNavigationLogo(null, createdApplicationId, filepart)
                        .cache();

        Mono<Tuple2<Application, Asset>> loadLogoImageMono =
                applicationService
                        .findById(createdApplicationId)
                        .flatMap(
                                fetchedApplication -> {
                                    Mono<Application> fetchedApplicationMono =
                                            Mono.just(fetchedApplication);
                                    if (StringUtils.isEmpty(
                                            fetchedApplication
                                                    .getUnpublishedApplicationDetail()
                                                    .getNavigationSetting()
                                                    .getLogoAssetId())) {
                                        return fetchedApplicationMono.zipWith(
                                                Mono.just(new Asset()));
                                    } else {
                                        return fetchedApplicationMono.zipWith(
        ...
        final Mono<Tuple2<Application, Asset>> deleteAndGetMono =
                saveMono.then(
                                applicationService.deleteAppNavigationLogo(
                                        null, createdApplicationId))
    ...
    public void testUploadNavigationLogo_invalidImageFormat() {
        ...
        String createdApplicationId =
                createTestApplication("ApplicationServiceTest Upload Invalid Nav Logo");
    ...
    public void testUploadNavigationLogo_invalidImageSize() {
        ...
        Flux<DataBuffer> dataBufferFlux =
                DataBufferUtils.read(
                                new ClassPathResource(
                                        "test_assets/WorkspaceServiceTest/my_workspace_logo_large.png"),
                                new DefaultDataBufferFactory(),
                                4096)
                        .repeat(100) // So the file size looks like it's much larger than what it
                        // actually is.
                        .cache();
        ...
        String createdApplicationId =
                createTestApplication("ApplicationServiceTest Upload Invalid Nav Logo Size");
