...
public class ApplicationServiceCETest {
        ...
        .expectErrorMatches(
            throwable ->
                throwable instanceof AppsmithException
                    && throwable
                        .getMessage()
                        .equals(AppsmithError.INVALID_PARAMETER.getMessage(FieldName.NAME)))
        .verify();
  }
   ...
   *
   * @param applicationName This is the initial name of the application which will try to create the
   *     application, but not guaranteed this will be the application's final name due to retry
   *     logic
  ...
  private void createAndVerifyValidApplication(
    ...
    StepVerifier.create(
            Mono.zip(
                applicationMono, themeService.getDefaultThemeId(), defaultPermissionGroupsMono))
        .assertNext(
            tuple2 -> {
              ...
              PermissionGroup adminPermissionGroup =
                  permissionGroups.stream()
                      .filter(
                          permissionGroup -> permissionGroup.getName().startsWith(ADMINISTRATOR))
                      .findFirst()
                      .get();
  ...
  public void defaultPageCreateOnCreateApplicationTest() {
    ...
    Policy managePagePolicy =
        Policy.builder().permission(MANAGE_PAGES.getValue()).users(Set.of("api_user")).build();
    Policy readPagePolicy =
        Policy.builder().permission(READ_PAGES.getValue()).users(Set.of("api_user")).build();
                    ...
                    && throwable
                        ...
                        .equals(
                            AppsmithError.NO_RESOURCE_FOUND.getMessage(
                                FieldName.APPLICATION, "random-id")))
        .verify();
  }
                    ...
                    && throwable
                        ...
                        .equals(
                            AppsmithError.NO_RESOURCE_FOUND.getMessage(
                                ...
                                gitConnectedApp.getId() + "," + "randomBranch")))
        .verify();
  }
        ...
        .assertNext(
            t -> {
              ...
              assertThat(t.getGitApplicationMetadata().getBranchName())
                  .isEqualTo(gitConnectedApp.getGitApplicationMetadata().getBranchName());
            ...
            userHomepageDTO -> {
              ...
              for (WorkspaceApplicationsDTO workspaceApplicationDTO : workspaceApplicationsDTOs) {
                if (workspaceApplicationDTO
                  ...
                  assertThat(workspaceApplicationDTO.getUsers().get(0).getRoles().get(0).getName())
  ...
  public void getOnlyDefaultApplicationsConnectedToGitForHome() {
    ...
    StepVerifier.create(
            branchedApplicationMono.then(Mono.zip(allApplications, gitConnectedAppsMono)))
        .assertNext(
            tuple -> {
        ...
        applicationService
            ...
            .flatMap(
                app -> {
                  String pageId = app.getPages().get(0).getId();
                  return Mono.zip(
                      Mono.just(app), newPageService.findPageById(pageId, READ_PAGES, false));
                });
  ...
  public void validMakeApplicationPublicWithActions() {
    ...
    final Mono<ActionCollection> actionCollectionMono =
        publicAppMono.then(
            actionCollectionService.findById(savedActionCollection.getId(), READ_ACTIONS));

    StepVerifier.create(
            Mono.zip(datasourceMono, actionMono, actionCollectionMono, publicPermissionGroupMono))
        .assertNext(
            tuple -> {
  ...
  public void cloneApplication_applicationWithGitMetadata_success() {
    ...
    Mono<Application> clonedApplicationMono =
        applicationPageService.cloneApplication(gitConnectedApp.getId(), branchName).cache();
    ...
    Mono<List<PageDTO>> clonedPageListMono =
        clonedApplicationMono
            ...
            .flatMap(
                applicationPage ->
                    newPageService.findPageById(applicationPage.getId(), READ_PAGES, false))
            .collectList();
    ...
    Mono<List<String>> pageNameListMono =
        clonedPageListMono.flatMapMany(Flux::fromIterable).map(PageDTO::getName).collectList();
            ...
            tuple -> {
              ...
              Set<String> defaultPageIdsInClonedActionFromDb =
                  clonedActionList.stream()
                      .map(
                          action1 ->
                              action1.getUnpublishedAction().getDefaultResources().getPageId())
                      .collect(Collectors.toSet());
              ...
              assertThat(
                      Collections.disjoint(defaultClonedActionIdsFromDb, defaultSrcActionIdsFromDb))
                  .isTrue();
              assertThat(
                      Collections.disjoint(clonedPageIdsInActionFromDb, srcPageIdsInActionFromDb))
                  .isTrue();
              assertThat(
              ...
              for (NewAction newAction : clonedActionList) {
                ...
                assertThat(newAction.getUnpublishedAction().getPageId())
                    .isEqualTo(newAction.getUnpublishedAction().getDefaultResources().getPageId());
              }
            })
        .verifyComplete();
  }
            ...
            tuple -> {
              ...
              actionCollectionList.forEach(
                  actionCollection -> {
                    ...
                    assertThat(unpublishedCollection.getDefaultToBranchedActionIdsMap()).hasSize(2);
            ...
            .flatMap(
                tuple -> {
                  ...
                  String deletedActionIdWithinActionCollection =
                      String.valueOf(
                          collectionDTO.getDefaultToBranchedActionIdsMap().values().stream()
                              .findAny()
                              .orElse(null));
  ...
  public void basicPublishApplicationTest() {
    ...
    Mono<List<NewPage>> applicationPagesMono =
        applicationMono
            ...
            .flatMapMany(Flux::fromIterable)
            .flatMap(
                applicationPage -> newPageService.findById(applicationPage.getId(), READ_PAGES))
            .collectList();
        ...
        .assertNext(
            tuple -> {
              ...
              assertThat(newPage.getUnpublishedPage().getLayouts().get(0).getId())
                  .isEqualTo(newPage.getPublishedPage().getLayouts().get(0).getId());
              assertThat(newPage.getUnpublishedPage().getLayouts().get(0).getDsl())
                  .isEqualTo(newPage.getPublishedPage().getLayouts().get(0).getDsl());
              ...
              assertThat(application.getPublishedApplicationDetail().getAppPositioning())
                  .isEqualTo(application.getUnpublishedApplicationDetail().getAppPositioning());
              assertThat(application.getPublishedApplicationDetail().getNavigationSetting())
                  .isEqualTo(application.getUnpublishedApplicationDetail().getNavigationSetting());
            })
        .verifyComplete();
  }

  /**
   * Method to test if the action, pages and actionCollection are archived after the application is
   * published
   */
  @Test
  @WithUserDetails(value = "api_user")
                          ...
                          tuple1 -> {
                            ...
                            return applicationPageService
                                ...
                                .then(
                                    Mono.zip(
                                        (Mono<NewAction>)
                                            this.getArchivedResource(
                                                savedAction.getId(), NewAction.class),
                                        (Mono<ActionCollection>)
                                            this.getArchivedResource(
  ...
  public void deleteUnpublishedPageFromApplication() {
                ...
                application ->
                    newPageService
                        .findByNameAndApplicationIdAndViewMode(
                            "New Page", application.getId(), READ_PAGES, false)
                        .switchIfEmpty(
                            Mono.error(
                                new AppsmithException(AppsmithError.NO_RESOURCE_FOUND, "page")))
                        .flatMap(
                            page -> applicationPageService.deleteUnpublishedPage(page.getId())))
            .block();
    ...
    StepVerifier.create(
            applicationService.findById(newPage.getApplicationId(), MANAGE_APPLICATIONS))
        .assertNext(
            editedApplication -> {
  ...
  public void deleteUnpublishedPage_FromApplicationConnectedToGit_success() {
    ...
    Mono<Application> applicationMono =
        applicationPageService
            ...
            .flatMap(
                pageDTO ->
                    applicationPageService.publish(pageDTO.getApplicationId(), branchName, true))
            .cache();
            ...
            .flatMap(
                application ->
                    newPageService
                        ...
                        .flatMap(
                            pageDTO ->
                                applicationPageService.deleteUnpublishedPage(pageDTO.getId())))
            .block();
                        ...
                        .switchIfEmpty(
                            Mono.error(
                                new AppsmithException(
                                    AppsmithError.NO_RESOURCE_FOUND, "unpublishedEditedPage"))))
            .block();

    Mono<Application> updatedDefaultPageApplicationMono =
        applicationMono.flatMap(
            application ->
                applicationPageService.makePageDefault(application.getId(), newPage.getId()));
        ...
        applicationPageService
            ...
            .flatMap(
                application -> {
                  CustomJSLib jsLib =
                      new CustomJSLib(
                          "name1", Set.of("accessor"), "url", "docsUrl", "version", "defs");
  ...
  public void validCloneApplicationWhenCancelledMidWay() {
    ...
    StepVerifier.create(
            Mono.zip(clonedAppFromDbMono, actionsMono, pagesMono, actionCollectionsMono))
        .assertNext(
            tuple -> {
              ...
              Set<String> actionCollectionNames =
                  actionCollections.stream()
                      .map(
                          actionCollection -> actionCollection.getUnpublishedCollection().getName())
                      .collect(Collectors.toSet());
            ...
            tuple -> {
              ...
              assertThat(
                      updatedApplication.getPolicies().stream()
                          .filter(
                              policy -> policy.getPermission().equals(READ_APPLICATIONS.getValue()))
                          .findFirst()
                          .get()
                          .getPermissionGroups())
              ...
              for (NewAction action : actions) {
                assertThat(
                        action.getPolicies().stream()
                            .filter(
                                policy -> policy.getPermission().equals(EXECUTE_ACTIONS.getValue()))
                            .findFirst()
                            .get()
                            .getPermissionGroups())
                    .contains(permissionGroup.getId());
              ...
              assertThat(
                      datasource1.getPolicies().stream()
                          .filter(
                              policy ->
                                  policy.getPermission().equals(EXECUTE_DATASOURCES.getValue()))
                          .findFirst()
                          .get()
                          .getPermissionGroups())
                  .contains(permissionGroup.getId());
  ...
  public void saveLastEditInformation_WhenUserHasPermission_Updated() {
    ...
    Mono<Application> updatedApplication =
        applicationPageService
            ...
            .flatMap(
                application -> applicationService.saveLastEditInformation(application.getId()));
  ...
  public void generateSshKeyPair_WhenDefaultApplicationIdNotSet_CurrentAppUpdated() {
    ...
    Mono<Application> applicationMono =
        applicationPageService
            ...
            .flatMap(
                testApplicationId ->
                    applicationRepository.findById(testApplicationId, MANAGE_APPLICATIONS));
        ...
        .assertNext(
            application1 -> {
              ...
              assertThat(application1.getGitApplicationMetadata().getBranchName())
                  .isNotEqualTo(gitConnectedApp.getGitApplicationMetadata().getBranchName());
              assertThat(application1.getGitApplicationMetadata().getBranchName())
   ...
   * on the deprecated Application collection isPublic field for a public application The following
   * steps are followed: 1. Create a new app 2. Invoke the changeViewAccess method to set the App
   * "Public" 3. Invoke the update method and assert the "isPublic" field in the response
   */
  @Test
  @WithUserDetails(value = "api_user")
  public void validPublicAppUpdateApplication() {
    ...
    /**
     * Making the App public using changeViewAccess method which changes the permission groups of
     * the app to allow public access
     */
    ApplicationAccessDTO applicationAccessDTO = new ApplicationAccessDTO();
    applicationAccessDTO.setPublicAccess(true);
    ...
    /**
     * Using the Update App method and asserting the response to verify the isPublic field in the
     * response is True which proves it's non-dependency on the deprecated Application collection
     * isPublic field and shows it dependency on the actual app permissions and state of the app
  ...
  public void validPrivateAppUpdateApplication() {
    ...
    /**
     * Making the App private using changeViewAccess method which changes the permission groups of
     * the app to restrict public access
     */
    ApplicationAccessDTO applicationAccessDTO = new ApplicationAccessDTO();
    applicationAccessDTO.setPublicAccess(false);
    ...
    /**
     * Using the Update App method and asserting the response to verify the isPublic field in the
     * response is False which proves it's non-dependency on the deprecated Application collection
     * isPublic field and shows it dependency on the actual app permissions and state of the app
  ...
  public void testUploadAndDeleteNavigationLogo_validImage() {
    ...
    final Mono<Application> saveMono =
        applicationService.saveAppNavigationLogo(null, createdApplicationId, filepart).cache();
    ...
    final Mono<Tuple2<Application, Asset>> deleteAndGetMono =
        saveMono
            .then(applicationService.deleteAppNavigationLogo(null, createdApplicationId))
