...
public class ActionCollectionServiceImplTest {
  ...
  <T> DefaultResources setDefaultResources(T collection) {
    ...
    if (collection instanceof ActionCollection) {
      ...
      if (collection instanceof ActionCollectionDTO) {
  ...
  public void testCreateCollection_withRepeatedActionName_throwsError() throws IOException {
    ...
    Mockito.when(
            actionCollectionRepository.findAllActionCollectionsByNamePageIdsViewModeAndBranch(
                Mockito.any(),
                Mockito.any(),
                Mockito.anyBoolean(),
                Mockito.any(),
    ...
    StepVerifier.create(actionCollectionDTOMono)
        .assertNext(
            actionCollectionDTO1 -> {
              ...
              assertEquals(
                  "testActionCollectionId", actionDTO.getDefaultResources().getCollectionId());
  ...
  public void testUpdateUnpublishedActionCollection_withInvalidId_throwsError() throws IOException {
    ...
    Mockito.when(
            actionCollectionRepository.findById(Mockito.anyString(), Mockito.<AclPermission>any()))
    ...
    StepVerifier.create(actionCollectionDTOMono)
        .assertNext(
            actionCollectionDTO1 -> {
              ...
              assertEquals(
                  "testActionId2", actionCollectionDTO1.getArchivedActions().get(0).getId());
              assertTrue(
  ...
  public void
    ...
    actionCollection
        ...
        .setDefaultToBranchedActionIdsMap(
            Map.of(
                "defaultTestActionId1", "testActionId1", "defaultTestActionId2", "testActionId2"));
    actionCollection.setPublishedCollection(null);
  ...
  public void testGenerateActionCollectionByViewModeTestTransientFields() {
    ...
    StepVerifier.create(
            Mono.zip(publishedActionCollectionDTOMono, unpublishedActionCollectionDTOMono))
        .assertNext(
            tuple -> {
              ...
              assertEquals(
                  mockAppId, publishedActionCollectionDTO.getDefaultResources().getApplicationId());
