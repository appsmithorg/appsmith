...
public class ActionCollectionServiceImplTest {
    ...
    @MockBean LayoutActionService layoutActionService;
    ...
    @MockBean RefactoringSolution refactoringSolution;
    ...
    @MockBean private PolicyGenerator policyGenerator;
    ...
    public void setUp() {
        ...
        actionCollectionService =
                new ActionCollectionServiceImpl(
                        scheduler,
                        validator,
                        mongoConverter,
        ...
        layoutCollectionService =
                new LayoutCollectionServiceImpl(
                        newPageService,
                        layoutActionService,
                        refactoringSolution,
                        actionCollectionService,
    ...
    @Test
    public void testCreateCollection_createActionFailure_returnsWithIncompleteCollection()
            throws IOException {
        ActionCollectionDTO actionCollectionDTO = new ActionCollectionDTO();
        actionCollectionDTO.setName("testCollection");
        actionCollectionDTO.setPageId("testPageId");
        ...
        Mockito.when(layoutActionService.createAction(Mockito.any()))
        ...
        Mockito.when(actionCollectionRepository.save(Mockito.any()))
                .thenAnswer(
                        invocation -> {
                ...
                .thenAnswer(
                        invocation -> {
                            final ActionCollection argument =
                                    (ActionCollection) invocation.getArguments()[0];
                            argument.setId("testActionCollectionId");
                            argument.setUserPermissions(
                                    Set.of("test-user-permission1", "test-user-permission2"));
                            return Mono.just(argument);
                        });
    ...
    @Test
    public void testCreateCollection_validCollection_returnsPopulatedCollection()
            throws IOException {
        ActionCollectionDTO actionCollectionDTO = new ActionCollectionDTO();
        actionCollectionDTO.setName("testCollection");
        actionCollectionDTO.setPageId("testPageId");
        ...
        StepVerifier.create(actionCollectionDTOMono)
                .assertNext(
                        actionCollectionDTO1 -> {
                            ...
                            assertEquals(
                                    "testCollection.testAction", actionDTO.getFullyQualifiedName());
                            assertEquals(
    ...
    public void testUpdateUnpublishedActionCollection_withInvalidId_throwsError()
        ...
        Mockito.when(
                        actionCollectionRepository.findById(
                                Mockito.anyString(), Mockito.<AclPermission>any()))
        ...
        final Mono<ActionCollectionDTO> actionCollectionDTOMono =
                layoutCollectionService.updateUnpublishedActionCollection(
                        "testId", actionCollectionDTO, null);
    ...
    @Test
    public void
            testUpdateUnpublishedActionCollection_withModifiedCollection_returnsValidCollection()
                    throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        ObjectMapperUtils objectMapperUtils = new ObjectMapperUtils(objectMapper);

        final JsonNode jsonNode =
                objectMapperUtils.readFromFile(mockObjects, Views.Public.class, JsonNode.class);

        String actionCollectionString =
                objectMapperUtils.writeAsString(
                        jsonNode.get("actionCollectionWithAction"), Views.Public.class);
        final ActionCollection actionCollection =
                objectMapperUtils.readFromString(
                        actionCollectionString, Views.Public.class, ActionCollection.class);

        String actionCollectionDTOWithModifiedActionsString =
                objectMapperUtils.writeAsString(
                        jsonNode.get("actionCollectionDTOWithModifiedActions"), Views.Public.class);
        final ActionCollectionDTO modifiedActionCollectionDTO =
                objectMapperUtils.readFromString(
                        actionCollectionDTOWithModifiedActionsString,
                        Views.Public.class,
                        ActionCollectionDTO.class);

        String actionCollectionAfterModifiedActionsString =
                objectMapperUtils.writeAsString(
                        jsonNode.get("actionCollectionAfterModifiedActions"), Views.Public.class);
        final ActionCollection modifiedActionCollection =
                objectMapperUtils.readFromString(
                        actionCollectionAfterModifiedActionsString,
                        Views.Public.class,
                        ActionCollection.class);

        final ActionCollectionDTO unpublishedCollection =
                modifiedActionCollection.getUnpublishedCollection();
        unpublishedCollection.setDefaultToBranchedActionIdsMap(
                Map.of(
                        "defaultTestActionId1",
                        "testActionId1",
                        "defaultTestActionId3",
                        "testActionId3"));
        unpublishedCollection.setDefaultToBranchedArchivedActionIdsMap(
        ...
        modifiedActionCollectionDTO.setDefaultResources(
                setDefaultResources(modifiedActionCollectionDTO));
        ...
        StepVerifier.create(actionCollectionDTOMono)
                .assertNext(
                        actionCollectionDTO1 -> {
                            ...
                            assertTrue(
                                    actionCollectionDTO1.getActions().stream()
                                            .map(ActionDTO::getId)
    ...
    public void testDeleteUnpublishedActionCollection_withInvalidId_throwsError() {
        Mockito.when(
                        actionCollectionRepository.findById(
                                Mockito.any(), Mockito.<Optional<AclPermission>>any()))
                .thenReturn(Mono.empty());
    ...
    @Test
    public void
            testDeleteUnpublishedActionCollection_withPublishedCollectionAndNoActions_returnsActionCollectionDTO()
                    throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        final JsonNode jsonNode = objectMapper.readValue(mockObjects, JsonNode.class);
        final ActionCollection actionCollection =
                objectMapper
                        ...
                        .readValue(
                                jsonNode.get("actionCollectionWithAction"), ActionCollection.class);
        final ActionCollectionDTO unpublishedCollection =
    ...
    @Test
    public void
            testDeleteUnpublishedActionCollection_withPublishedCollectionAndActions_returnsActionCollectionDTO()
                    throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        final JsonNode jsonNode =
                objectMapper
                        .readerWithView(Views.Public.class)
                        .readValue(mockObjects, JsonNode.class);
        final ActionCollection actionCollection =
                objectMapper
                        .readerWithView(Views.Public.class)
                        .readValue(
                                objectMapper
                                        ...
                                        .writeValueAsString(
                                                jsonNode.get("actionCollectionWithAction")),
                                ActionCollection.class);
        ...
        Mockito.when(newActionService.deleteUnpublishedAction(Mockito.any()))
                .thenReturn(
                        Mono.just(actionCollection.getUnpublishedCollection().getActions().get(0)));
    ...
    public void
        ...
        actionCollection
                ...
                .setDefaultResources(
                        setDefaultResources(actionCollection.getUnpublishedCollection()));
    ...
    public void
        ...
        Mockito.when(newActionService.archiveById(Mockito.any()))
    ...
    public void testRefactorCollectionName_withDuplicateName_throwsError() {
        final RefactorActionCollectionNameDTO refactorActionCollectionNameDTO =
                new RefactorActionCollectionNameDTO();
        ...
        final Mono<LayoutDTO> layoutDTOMono =
                layoutCollectionService.refactorCollectionName(
                        refactorActionCollectionNameDTO, null);
    ...
    public void testRefactorCollectionName_withEmptyActions_returnsValidLayout() {
        ...
        Mockito.when(
                        actionCollectionRepository.findById(
                                Mockito.any(), Mockito.<AclPermission>any()))
        ...
        Mockito.when(
                        refactoringSolution.refactorActionCollectionName(
                                Mockito.any(),
                                Mockito.any(),
                                Mockito.any(),
                                Mockito.any(),
    ...
    public void testRefactorCollectionName_withActions_returnsValidLayout() {
        ...
        oldUnpublishedCollection.setPageId("testPageId");
        oldUnpublishedCollection.setName("oldName");
        oldUnpublishedCollection.setDefaultToBranchedActionIdsMap(
                Map.of("defaultTestActionId", "testActionId"));
        oldActionCollection.setUnpublishedCollection(oldUnpublishedCollection);
        oldActionCollection.setDefaultResources(setDefaultResources(oldActionCollection));
        oldUnpublishedCollection.setDefaultResources(setDefaultResources(oldUnpublishedCollection));
    ...
    public void testGenerateActionCollectionByViewModeTestTransientFields() {
        ...
        Set<String> mockPermissions =
                Set.of("mock-permission-1", "mock-permission-2", "mock-permission-3");
        ...
        StepVerifier.create(
                        Mono.zip(
                                publishedActionCollectionDTOMono,
                                unpublishedActionCollectionDTOMono))
                .assertNext(
                        tuple -> {
                            ...
                            assertEquals(
                                    mockAppId, publishedActionCollectionDTO.getApplicationId());
                            assertEquals(
                                    mockWorkspaceId, publishedActionCollectionDTO.getWorkspaceId());
                            assertEquals(
                                    mockPermissions,
                                    publishedActionCollectionDTO.getUserPermissions());
                            assertEquals(
                                    mockAppId,
                            ...
                            assertEquals(
                                    mockAppId, unpublishedActionCollectionDTO.getApplicationId());
                            assertEquals(
                                    mockWorkspaceId,
                                    unpublishedActionCollectionDTO.getWorkspaceId());
                            assertEquals(
                                    mockPermissions,
                                    unpublishedActionCollectionDTO.getUserPermissions());
                            assertEquals(
                                    mockAppId,
