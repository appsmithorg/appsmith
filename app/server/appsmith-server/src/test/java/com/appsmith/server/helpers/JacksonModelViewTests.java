...
public class JacksonModelViewTests {
    ...
    public void test_whenJsonViewIsUsed_thenCorrect() throws JsonProcessingException {
        ...
        String value =
                objectMapper
                        ...
                        .writeValueAsString(testModalJsonView);
    ...
    public void test_withJsonView_measureSerializingPerformance() throws JsonProcessingException {
        ...
        log.info(
                "test_withJsonView_measureSerializingPerformance: {} ms for 1000000 iterations",
                end - start);
    }
    ...
    public void test_withJsonView_measureDeserializingPerformance() throws JsonProcessingException {
        ...
        long end = System.currentTimeMillis();
        log.info(
                "test_withJsonView_measureDeserializingPerformance: {} ms for 1000000 iterations",
                end - start);
    }
    ...
    public void test_withJsonIgnore_measurePerformance() throws JsonProcessingException {
        ...
        long end = System.currentTimeMillis();
        log.info(
                "test_withJsonIgnore_measureSerializingPerformance: {} ms for 1000000 iterations",
                end - start);
    }

    @Test
    public void test_withJsonIgnore_measureDeserializingPerformance()
        ...
        long end = System.currentTimeMillis();
        log.info(
                "test_withJsonIgnore_measureDeserializingPerformance: {} ms for 1000000 iterations",
                end - start);
    }
    ...
    public static class TestModelJsonIgnore {
        ...
        @JsonIgnore private String password = "password";
        private String email = "email";
        private String phone = "phone";
        @JsonIgnore private String address = "address";
