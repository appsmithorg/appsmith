...
public class GitServiceCEImplTest {
  ...
  // This test is to check if the limit is reached when the count of connected apps is more than
  // the limit
  // This happens when public visible git repo is synced with application and then the visibility
  // is changed
  @Test
