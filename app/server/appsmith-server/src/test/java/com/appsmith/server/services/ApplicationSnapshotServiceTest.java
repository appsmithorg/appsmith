...
public void createApplicationSnapshot_WhenNoPreviousSnapshotExists_NewCreated() {
	...
	Mono<ApplicationSnapshot> snapshotMono =
		workspaceService
			...
			.flatMap(
				applicationId ->
					applicationSnapshotService.getWithoutDataByApplicationId(applicationId, null));
	...
	Mono<Tuple2<ApplicationSnapshot, Application>> tuple2Mono =
		workspaceService
			...
			.flatMap(
				...
				// this app will have default app id=testDefaultAppId and branch name=test branch
				// name
			...
			.flatMapMany(
				application ->
					applicationSnapshotService
						...
						.thenMany(
							applicationSnapshotRepository.findByApplicationId(
								application.getId())));
			...
			return applicationPageService
				...
				.then(
					newPageService.findApplicationPages(
						createdApp.getId(), null, null, ApplicationMode.EDIT));
			});
