                ...
                .assertNext(
                        applicationGitReference -> {
                            ...
                            JsonObject jsonObject =
                                    gson.fromJson(
                                            gson.toJson(applicationGitReference.getApplication()),
                                            JsonObject.class);
                            ...
                            JsonObject pages =
                                    gson.fromJson(
                                            gson.toJson(applicationGitReference.getPages()),
                                            JsonObject.class);
                            assertThat(pages.size()).isEqualTo(1);
                            assertThat(
                                            pages.get("Page1.json")
                                                    .getAsJsonObject()
                                                    .get("pageKey")
                                                    .getAsString())
                                    .isEqualTo("pageValue");
                            ...
                            JsonObject actions =
                                    gson.fromJson(
                                            gson.toJson(applicationGitReference.getActions()),
                                            JsonObject.class);
                            assertThat(actions.size()).isEqualTo(1);
                            assertThat(
                                            actions.get("Query1_Page1.json")
                                                    .getAsJsonObject()
                                                    .get("queryKey")
                                                    .getAsString())
                            ...
                            JsonObject actionCollections =
                                    gson.fromJson(
                                            gson.toJson(
                                                    applicationGitReference.getActionCollections()),
                                            JsonObject.class);
                            ...
                            JsonObject datasources =
                                    gson.fromJson(
                                            gson.toJson(applicationGitReference.getDatasources()),
                                            JsonObject.class);
