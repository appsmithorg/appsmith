...
public class NotificationServiceImplTest {
    ...
    @MockBean private MongoConverter mongoConverter;
    ...
    public void setUp() {
        ...
        Mockito.when(repository.countByForUsername(currentUser.getUsername()))
    ...
    public void get_WhenNoBeforeParamProvided_ReturnsData() {
        ...
        // mock the repository to return the sample list of notification when called with current
        // time
        Mockito.when(
