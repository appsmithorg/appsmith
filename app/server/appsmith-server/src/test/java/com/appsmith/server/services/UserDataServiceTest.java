        ...
        .expectErrorMatches(
            throwable ->
                throwable instanceof AppsmithException
                    && throwable
                        .getMessage()
                        .contains(AppsmithError.INVALID_PARAMETER.getMessage("Author Email")))
        .verify();
  }
    ...
    StepVerifier.create(userDataMono)
        .assertNext(
            gitProfileMap -> {
              ...
              AssertionsForClassTypes.assertThat(gitProfileMap.get("defaultAppId").getAuthorEmail())
                  .isNullOrEmpty();
              AssertionsForClassTypes.assertThat(gitProfileMap.get("defaultAppId").getAuthorName())
                  .isNullOrEmpty();
        ...
        .expectErrorMatches(
            throwable ->
                throwable instanceof AppsmithException
                    && throwable
                        .getMessage()
                        .contains(AppsmithError.INVALID_PARAMETER.getMessage("Author Name")))
        .verify();
  }
