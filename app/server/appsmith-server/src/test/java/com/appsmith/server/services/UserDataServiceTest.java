...
public class UserDataServiceTest {
    ...
    @MockBean private UserChangedHandler userChangedHandler;
    ...
    public void ensureViewedReleaseVersionNotesIsSet() {
        final Mono<UserData> resultMono =
                userMono.flatMap(
                                user ->
                                        userDataService.ensureViewedCurrentVersionReleaseNotes(
                                                user))
    ...
    public void setViewedReleaseNotesVersion() {
        final Mono<UserData> resultMono =
                userMono.flatMap(
                                user ->
                                        userDataService.setViewedCurrentVersionReleaseNotes(
                                                user, "version-1"))
                        .flatMap(user -> userDataService.getForUser(user));
        ...
        StepVerifier.create(resultMono)
                .assertNext(
                        userData -> {
                            assertThat(userData.getReleaseNotesViewedVersion())
                                    .isEqualTo("version-1");
                        })
                .verifyComplete();
    }
    ...
    public void testUploadAndDeleteProfilePhoto_validImage() {
        ...
        Mono<Tuple2<UserData, Asset>> loadProfileImageMono =
                userDataService
    ...
    */
    ...
    public void testUploadProfilePhoto_invalidImageContent() {
        ...
        Flux<DataBuffer> dataBufferFlux =
                DataBufferUtils.read(
                                new ClassPathResource(
                                        "test_assets/WorkspaceServiceTest/json_file_to_png.png"),
                                new DefaultDataBufferFactory(),
                                4096)
                        .cache();
        Mockito.when(filepart.content()).thenReturn(dataBufferFlux);
                ...
                userDataService
                        ...
                        .flatMap(
                                userData -> {
                                    ...
                                    Application application = new Application();
                                    application.setWorkspaceId(sampleWorkspaceId);
                                    return userDataService.updateLastUsedAppAndWorkspaceList(
                                            application);
                                });
        ...
        StepVerifier.create(resultMono)
                .assertNext(
                        userData -> {
                            ...
                            assertEquals(
                                    "sample-org-id", userData.getRecentlyUsedWorkspaceIds().get(0));
                        })
                .verifyComplete();
    }
        ...
        StepVerifier.create(resultMono)
                .assertNext(
                        userData -> {
                            ...
                            assertThat(userData.getRecentlyUsedWorkspaceIds().get(0))
                                    .isEqualTo(sampleWorkspaceId);
                            assertThat(userData.getRecentlyUsedWorkspaceIds().get(9))
                                    .isEqualTo("org-9");

                            // app id list should be truncated to 20
                            assertThat(userData.getRecentlyUsedAppIds().size()).isEqualTo(20);
                            assertThat(userData.getRecentlyUsedAppIds().get(0))
                                    .isEqualTo(sampleAppId);
                            assertThat(userData.getRecentlyUsedAppIds().get(19))
                                    .isEqualTo("app-19");
                        })
                .verifyComplete();
    }
                ...
                userDataService
                        ...
                        .flatMap(
                                userData -> {
                                    ...
                                    return userDataService.addTemplateIdToLastUsedList(
                                            newTemplateId);
                                });
        ...
        StepVerifier.create(resultMono)
                .assertNext(
                        userData -> {
                            ...
                            assertThat(userData.getRecentlyUsedTemplateIds().get(0))
                                    .isEqualTo(newTemplateId);
                            assertThat(userData.getRecentlyUsedTemplateIds().get(4))
                                    .isEqualTo("template-4");
                        })
                .verifyComplete();
    }
    ...
    public void deleteProfilePhotot_WhenExists_RemovedFromAssetAndUserData() {
        ...
        Mono<Tuple2<UserData, Asset>> tuple2Mono =
                assetRepository
                        ...
                        .flatMap(
                                savedAsset ->
                                        userDataService
                                                ...
                                                .flatMap(
                                                        userData -> {
                                                            userData.setProfilePhotoAssetId(
                                                                    savedAsset.getId());
    ...
    @WithUserDetails(value = "api_user")
    public void
            getAndUpdateDefaultGitProfile_fallbackValueFromUserProfileIfEmpty_updateWithProfile() {
