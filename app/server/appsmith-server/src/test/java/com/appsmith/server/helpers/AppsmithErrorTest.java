...
private void generateDuplicateKeyException() {
	String originalErrorMessage =
		"Write operation error on server localhost:27017. Write error: WriteError{code=11000,"
			+ " message='E11000 duplicate key error collection: appsmith.actionCollection index:"
			+ " unpublishedCollection.name_1 dup key: { unpublishedCollection.name:"
			+ " \\\"MyJSObject\\\" }', details={}}.";
