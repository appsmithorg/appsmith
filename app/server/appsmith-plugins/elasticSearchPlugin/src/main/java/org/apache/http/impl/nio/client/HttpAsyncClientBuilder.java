...
public class HttpAsyncClientBuilder {
   ...
   *
   * <p>Please note this value can be overridden by the {@link
  ...
  /**
   * Assigns default {@link org.apache.http.auth.AuthScheme} registry which will be used for request
   ...
   *
   * <p>Please note this value can be overridden by the {@link
   * #setConnectionManager(org.apache.http.nio.conn.NHttpClientConnectionManager)} and the {@link
   * #setSSLStrategy(org.apache.http.nio.conn.SchemeIOSessionStrategy)} methods.
   */
  ...
  /**
   * Assigns default {@link RequestConfig} instance which will be used for request execution if not
   * explicitly set in the client execution context.
   */
