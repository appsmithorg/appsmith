    ...
    public static class AppsmithAiPluginExecutor extends BaseRestApiPluginExecutor {
        ...
        public Mono<TriggerResultDTO> trigger(
            ...
            return switch (requestType) {
                case UPLOAD_FILES -> uploadFiles(request);
                case LIST_FILES -> listFiles(datasourceConfiguration, request);
                default -> super.trigger(connection, datasourceConfiguration, request);
            };
        }
