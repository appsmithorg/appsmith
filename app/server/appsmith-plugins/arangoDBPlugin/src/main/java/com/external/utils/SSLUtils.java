...
public class SSLUtils {
    ...
    public static boolean isCaCertificateAvailable(
        ...
        switch (authType) {
            ...
            default:
                throw new AppsmithPluginException(
                        ...
                        String.format(
                                ArangoDBErrorMessages.UNEXPECTED_SSL_OPTION_ERROR_MSG, authType));
        }
    }

    public static void setSSLContext(
            Builder builder, DatasourceConfiguration datasourceConfiguration) {
        ...
        switch (caCertificateType) {
            ...
            default:
                throw new AppsmithPluginException(
                        AppsmithPluginError.PLUGIN_DATASOURCE_ARGUMENT_ERROR,
                        String.format(
                                ArangoDBErrorMessages.UNEXPECTED_CA_CERT_OPTION_ERROR_MSG,
                                caCertificateType));
        }
    }
}
