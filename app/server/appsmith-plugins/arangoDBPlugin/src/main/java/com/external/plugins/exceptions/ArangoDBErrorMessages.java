...
public class ArangoDBErrorMessages {
    ...
    public static final String GET_STRUCTURE_ERROR_MSG =
            "Appsmith server has failed to fetch list of collections from database. Please check if"
    ...
    */
    ...
    public static final String DS_HOSTNAME_MISSING_OR_INVALID_ERROR_MSG =
            "Could not find host address. Please edit "
