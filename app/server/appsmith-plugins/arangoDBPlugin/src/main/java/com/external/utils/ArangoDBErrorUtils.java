...
/**
 * This class is meant to provide helpful methods to re-format the error messages received from
 * remote ArangoDB datasource. Example: Original error message: ArangoDBException:
 * UnknownHostException: Something went wrong. Re-formatted error message: Could not find host
 * address. Please edit the 'Host Address' and/or the 'Port' field to provide the desired endpoint.
 */
...
public class ArangoDBErrorUtils extends AppsmithPluginErrorUtils {
    ...
    public String getReadableError(Throwable error) {
        ...
        if (externalError instanceof ArangoDBException) {
            ...
            /**
             * Example: Original error message: com.arangodb.ArangoDBException:
             * java.net.UnknownHostException: 1656317e37af .arangodb.cloudx: nodename nor servname
             * provided, or not known Re-formatted error message: Could not find host address.
             * Please edit the 'Host Address' and/or the 'Port' field to provide the desired
             * endpoint.
             */
        ...
        /** Example: Input: ArangoErrorCode: Some issue found. Output: Some issue found */
