...
private static List<DatasourceStructure.Template> generateTemplate(
...
private static DatasourceStructure.Template generateSelectTemplate(
	Map<String, Object> templateConfiguration) {
	String collectionName = (String) templateConfiguration.get("collectionName");
	Map<String, String> sampleValues =
		(Map<String, String>) templateConfiguration.get("sampleValues");
...
private static DatasourceStructure.Template generateCreateTemplate(
	Map<String, Object> templateConfiguration) {
	String collectionName = (String) templateConfiguration.get("collectionName");
...
private static DatasourceStructure.Template generateUpdateTemplate(
	Map<String, Object> templateConfiguration) {
	String collectionName = (String) templateConfiguration.get("collectionName");
	Map<String, String> sampleValues =
		(Map<String, String>) templateConfiguration.get("sampleValues");
...
private static DatasourceStructure.Template generateRemoveTemplate(
	Map<String, Object> templateConfiguration) {
	String collectionName = (String) templateConfiguration.get("collectionName");
	Map<String, String> sampleValues =
		(Map<String, String>) templateConfiguration.get("sampleValues");
