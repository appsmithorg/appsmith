...
public class RedisErrorMessages {
    ...
    public static final String NO_PONG_RESPONSE_ERROR_MSG =
            "Expected PONG in response of PING but got %s";

    public static final String QUERY_EXECUTION_FAILED_ERROR_MSG =
            "Error occurred while executing Redis query. To know more about the error please check"
                    + " the error details.";
    ...
    */
    ...
    public static final String DS_MISSING_HOST_ADDRESS_ERROR_MSG =
            "Could not find host address. Please edit the 'Host address' field to provide the"
                    + " desired endpoint.";
