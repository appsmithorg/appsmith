    ...
    public void testBsonTypes() {
        ...
        assertEquals(
                ...
                DataTypeServiceUtils.getAppsmithType(
                                ClientDataType.OBJECT, "{}{}", pluginSpecificTypes)
                        .type());
        assertEquals(
                DataType.BSON,
                DataTypeServiceUtils.getAppsmithType(
                                ClientDataType.OBJECT, "{}[]null", pluginSpecificTypes)
                        .type());
        // Numbers may be NaNs or infinities.
        assertEquals(
                DataType.BSON,
                DataTypeServiceUtils.getAppsmithType(
                                ClientDataType.OBJECT, "{\"number\": NaN}", pluginSpecificTypes)
                        .type());
        assertEquals(
                DataType.BSON,
                DataTypeServiceUtils.getAppsmithType(
        ...
        assertEquals(
                DataType.BSON,
                DataTypeServiceUtils.getAppsmithType(
                                ClientDataType.OBJECT, "{a: 1}", pluginSpecificTypes)
                        .type());
        assertEquals(
                DataType.BSON,
                DataTypeServiceUtils.getAppsmithType(
        ...
        assertEquals(
                DataType.BSON,
                DataTypeServiceUtils.getAppsmithType(
                                ClientDataType.OBJECT, "{\"a\": ''}", pluginSpecificTypes)
                        .type());
        ...
        assertEquals(
                DataType.BSON,
                DataTypeServiceUtils.getAppsmithType(
                                ClientDataType.OBJECT, "{\"a\": 0,}", pluginSpecificTypes)
                        .type());
    }
}
