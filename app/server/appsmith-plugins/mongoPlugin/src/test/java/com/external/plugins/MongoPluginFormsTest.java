...
public class MongoPluginFormsTest {
        ...
        public void testBsonSmartSubstitution_withBSONValue() {
                ...
                Mono<ActionExecutionResult> executeMono = dsConnectionMono
                                .flatMap(conn -> pluginExecutor.executeParameterized(conn,
                                                executeActionDTO,
                ...
                StepVerifier.create(executeMono)
                                .assertNext(obj -> {
                                        ...
                                        List<Map.Entry<String, String>> parameters = (List<Map.Entry<String, String>>) request
                                                        .getProperties().get("smart-substitution-parameters");
                                        ...
                                        assertEquals(expectedQuery,
                                                        ((RequestParamDTO) (((List) result.getRequest()
                                                                        .getRequestParams())).get(0)).getValue());
                                })
                                .verifyComplete();
        }
        ...
        public void testInsertFormCommandArrayDocuments() {
                ...
                dsConnectionMono.flatMap(conn -> pluginExecutor.executeParameterized(conn, new ExecuteActionDTO(),
                                dsConfig, actionConfiguration)).block();
        }
        ...
        public void testUpdateManyFormCommandWithArrayInput() {
            ...
            // Query for all the documents in the collection
            setDataValueSafelyInFormData(configMap, UPDATE_QUERY, "{}");
            setDataValueSafelyInFormData(configMap, UPDATE_OPERATION, "[{ \"$set\": { \"department\": \"app\" } }" +
    ...
    @Test
        ...
        public void testFormSmartInputDistinct() {
                ...
                StepVerifier.create(executeMono)
                                .assertNext(obj -> {
                                        ...
                                        assertTrue(result.getIsExecutionSuccess());
                                        assertNotNull(result.getBody());
                                        ArrayNode valuesNode = (ArrayNode) ((ObjectNode) result.getBody())
                                                        .get("values");
        ...
        public void testSmartSubstitutionWithObjectIdInDoubleQuotes() {
                final MongoCollection<Document> usersCollection = mongoClient.getDatabase("test")
                                .getCollection("users");
        ...
        public void testFormToNativeQueryConversionForFindCommand() {
                ...
                setDataValueSafelyInFormData(configMap, COMMAND, "RAW");
                setDataValueSafelyInFormData(configMap, BODY,
                                getDataValueSafelyFromFormData(configMap, "misc.formToNativeQuery", STRING_TYPE));

                DatasourceConfiguration dsConfig = createDatasourceConfiguration();
                Mono<MongoClient> dsConnectionMono = pluginExecutor.datasourceCreate(dsConfig);
                Mono<Object> executeMono = dsConnectionMono
                                .flatMap(conn -> pluginExecutor.executeParameterized(conn, executeActionDTO,
        ...
        public void testFormToNativeQueryConversionForInsertCommand() {
                ...
                dsConnectionMono.flatMap(
                                conn -> pluginExecutor.executeParameterized(conn, new ExecuteActionDTO(), dsConfig,
                                                actionConfiguration))
                                .block();
        }
        ...
        public void testFormToNativeQueryConversionForDistinctCommand() {
                ...
                setDataValueSafelyInFormData(configMap, COMMAND, "RAW");
                setDataValueSafelyInFormData(configMap, BODY,
                                getDataValueSafelyFromFormData(configMap, "misc.formToNativeQuery",
                                                STRING_TYPE));
