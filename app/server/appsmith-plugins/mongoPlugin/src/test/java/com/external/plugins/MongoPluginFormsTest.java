...
public class MongoPluginFormsTest {
    ...
    public void testBsonSmartSubstitution_withBSONValue() {
        ...
        Mono<MongoClient> dsConnectionMono =
                        ...
                        obj -> {
                            ...
                            List<Map.Entry<String, String>> parameters =
                                    (List<Map.Entry<String, String>>)
                                            request.getProperties()
                                                    .get("smart-substitution-parameters");
                            ...
                            String expectedQuery =
                                    "{\n"
                                            ...
                                            + "      limit: 10\n"
                                            + "    }";
                            // check that bindings are not replaced with actual values and not '$i'
                            // or '?'
                            assertEquals(
                                    expectedQuery,
                                    ((RequestParamDTO)
    ...
    public void testInsertFormCommandArrayDocuments() {
        ...
        setDataValueSafelyInFormData(
                configMap,
                INSERT_DOCUMENT,
                "[{name : \"ZZZ Insert Form Array Test 1\", gender : \"F\", age : 40, tag :"
                    + " \"test\"},{name : \"ZZZ Insert Form Array Test 2\", gender : \"F\", age :"
                    + " 40, tag : \"test\"}]");
    ...
    public void testInsertFormCommandSingleDocument() {
        ...
        setDataValueSafelyInFormData(
                configMap,
                INSERT_DOCUMENT,
                "{\"name\" : \"ZZZ Insert Form Single Test\", \"gender\" : \"F\", \"age\" : 40,"
                        + " \"tag\" : \"test\"}");
    ...
    public void testUpdateManyFormCommand() {
        ...
        setDataValueSafelyInFormData(
                configMap, UPDATE_OPERATION, "{ $set: { updatedByCommand: true }}}");
    ...
    public void testDeleteFormCommandSingleDocument() {
        ...
        setDataValueSafelyInFormData(
                configMap,
                INSERT_DOCUMENT,
                "[{\"name\" : \"To Delete1\", \"tag\" : \"delete\"}, {\"name\" : \"To Delete2\","
                        + " \"tag\" : \"delete\"}]");
        ...
        StepVerifier.create(executeMono)
                .assertNext(
                        obj -> {
                            ...
                            String expectedQuery =
                                    "{\"find\": \"users\", \"filter\": {\"age\": {\"$gte\": 30}},"
                                        + " \"sort\": {\"id\": 1}, \"limit\": 10, \"batchSize\":"
                                        + " 10}";
                            assertEquals(
                                    expectedQuery,
                                    ((RequestParamDTO)
    ...
    public void testSmartSubstitutionEvaluatedValueContainingQuestionMark() {
        ...
        setDataValueSafelyInFormData(
                configMap,
                INSERT_DOCUMENT,
                "{\"name\" : {{Input1.text}}, \"gender\" : {{Input2.text}}, \"age\" : 40, \"tag\" :"
                        + " \"test\"}");
        ...
        Mono<Object> executeMono =
                dsConnectionMono.flatMap(
                        conn ->
                                pluginExecutor.executeParameterized(
                                        conn, executeActionDTO, dsConfig, actionConfiguration));
        StepVerifier.create(executeMono)
                .assertNext(
                        obj -> {
                            ActionExecutionResult result = (ActionExecutionResult) obj;
    ...
    public void testSmartSubstitutionWithMongoTypes3() {
        ...
        final List<Param> params = new ArrayList<>();
        final Param dob =
                new Param("Input1", "{\"dob\": \"ISODate(\\\"1970-01-01T00:00:00.000Z\\\")\"}");
        params.add(dob);
        executeActionDTO.setParams(params);
