...
public class MongoPluginErrorMessages {
    ...
    public static final String QUERY_EXECUTION_FAILED_ERROR_MSG =
            "Your Mongo query failed to execute.";
    ...
    public static final String NO_CONNECTION_STRING_URI_ERROR_MSG =
            "Could not find any Mongo connection string URI.";
    ...
    public static final String NO_VALID_MONGO_COMMAND_FOUND_ERROR_MSG =
            "No valid mongo command found.";

    public static final String FIELD_WITH_NO_CONFIGURATION_ERROR_MSG =
            "Try again after configuring the fields : %s";
    ...
    public static final String PIPELINE_STAGE_NOT_VALID_ERROR_MSG =
            "Pipeline stage is not a valid JSON object.";
    ...
    */
    ...
    public static final String DS_INVALID_CONNECTION_STRING_URI_ERROR_MSG =
            "Mongo Connection string URI does not seem to be in the correct format. Please "
                    + "check the URI once.";

    public static final String DS_MISSING_DEFAULT_DATABASE_NAME_ERROR_MSG =
    ...
    public static final String DS_USING_URI_BUT_EXPECTED_FORM_FIELDS_ERROR_MSG =
            "It seems that you are trying to use a mongo connection string URI. Please extract"
                + " relevant fields and fill the form with extracted values. For details, please"
                + " check out the Appsmith's documentation for Mongo database. Alternatively, you"
                + " may use 'Import from connection string URI' option from the dropdown labelled"
                + " 'Use mongo connection string URI' to use the URI connection string directly.";

    public static final String DS_INVALID_AUTH_TYPE_ERROR_MSG =
            "Invalid authType. Must be one of %s";
