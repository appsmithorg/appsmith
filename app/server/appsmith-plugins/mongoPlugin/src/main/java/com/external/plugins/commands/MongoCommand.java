...
/**
 * This is the base class which every Mongo Command extends. Common functions across all mongo
 * commands are implemented here including reading and validating the collection. This also defines
 * functions which should be implemented by all the commands.
 */
@Getter
@Setter
@NoArgsConstructor
...
public MongoCommand(ActionConfiguration actionConfiguration) {
	...
	this.collection =
		PluginUtils.getDataValueSafelyFromFormData(formData, COLLECTION, STRING_TYPE);
	}
}
