...
//
//        MariadbConnectionConfiguration.Builder connectionConfigurationBuilder = MariadbConnectionConfiguration.fromOptions(ob.build());
//        connectionConfigurationBuilder.allowPublicKeyRetrieval(true);
//
//        MariadbConnectionFactory connectionFactory = MariadbConnectionFactory.from(connectionConfigurationBuilder.build());
