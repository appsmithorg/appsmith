...
public class MySqlGetStructureUtils {
  ...
  /**
   * 1. Parse results obtained by running COLUMNS_QUERY defined on top of the page. 2. A sample
   * mysql output for the query is also given near COLUMNS_QUERY definition on top of the page.
   */
  public static void getTableInfo(
      Row row, RowMetadata meta, Map<String, DatasourceStructure.Table> tablesByName) {
  ...
  /**
   * 1. Parse results obtained by running KEYS_QUERY defined on top of the page. 2. A sample mysql
   * output for the query is also given near KEYS_QUERY definition on top of the page.
   */
          ...
          if ("text".equals(type) || "varchar".equals(type)) {
            ...
            if (type.startsWith("int")) {
              ...
              if (type.startsWith("double")) {
                ...
                if (DATE_COLUMN_TYPE_NAME.equals(type)) {
                  value = "'2019-07-01'";
                } else {
                  if (DATETIME_COLUMN_TYPE_NAME.equals(type)
