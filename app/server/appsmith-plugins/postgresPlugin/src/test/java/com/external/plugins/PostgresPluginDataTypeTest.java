...
public class PostgresPluginDataTypeTest {
    ...
    static {
        ...
        pluginSpecificTypes.put(
                ClientDataType.ARRAY, List.of(new NullArrayType(), new ArrayType()));
        ...
        */
        ...
        pluginSpecificTypes.put(
                ...
                List.of(new TimeType(), new DateType(), new TimestampType(), new StringType()));
    }
    ...
    public void shouldBeNullType() {
        ...
        AppsmithType appsmithType =
                DataTypeServiceUtils.getAppsmithType(
                        ClientDataType.NULL, value, pluginSpecificTypes);
    ...
    public void shouldBeBooleanType() {
        ...
        for (String value : values) {
            AppsmithType appsmithType =
                    DataTypeServiceUtils.getAppsmithType(
                            ClientDataType.BOOLEAN, value, pluginSpecificTypes);
    ...
    public void shouldBeIntegerType() {
        String[] values = {
            "0", "7166", String.valueOf(Integer.MIN_VALUE), String.valueOf(Integer.MAX_VALUE)
        };

        for (String value : values) {
            AppsmithType appsmithType =
                    DataTypeServiceUtils.getAppsmithType(
                            ClientDataType.NUMBER, value, pluginSpecificTypes);
    ...
    public void shouldBeJsonObjectTypeOrStringType() {
        ...
        for (String value : values) {
            AppsmithType appsmithType =
                    DataTypeServiceUtils.getAppsmithType(
                            ClientDataType.OBJECT, value, pluginSpecificTypes);
            assertTrue(
                    appsmithType instanceof JsonObjectType || appsmithType instanceof FallbackType);
        }
    }
    ...
    public void shouldBeTimeType() {
        ...
        for (String value : values) {
            AppsmithType appsmithType =
                    DataTypeServiceUtils.getAppsmithType(
                            ClientDataType.STRING, value, pluginSpecificTypes);
    ...
    public void shouldNullArrayType() {
        ...
        for (String value : values) {
            AppsmithType appsmithType =
                    DataTypeServiceUtils.getAppsmithType(
                            ClientDataType.ARRAY, value, pluginSpecificTypes);
