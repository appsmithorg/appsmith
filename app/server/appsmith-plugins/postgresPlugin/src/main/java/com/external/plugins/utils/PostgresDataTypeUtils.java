...
public class PostgresDataTypeUtils {
     ...
     *
     * <p>Capturing only the words post "::" so that the explict data type to which the parameter
     * must be cast can be read and ignoring the group "::" from getting captured by using regex
     * "?:" which ignores the subsequent string
     */
    ...
    public static class DataType {
         ...
         *
         * <p>!!! WARNING !!! When adding a new data type to support for explicit casting, please
         * ensure to add an entry in the Map dataTypeMapper which maps the postgres data types to
         * Appsmith data types.
         */
