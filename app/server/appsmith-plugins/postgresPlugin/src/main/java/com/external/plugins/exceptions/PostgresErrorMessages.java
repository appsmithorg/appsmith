...
public class PostgresErrorMessages {
    ...
    public static final String QUERY_EXECUTION_FAILED_ERROR_MSG =
            "Your PostgreSQL query failed to execute.";

    public static final String POSTGRES_JDBC_DRIVER_LOADING_ERROR_MSG =
            "Your PostgreSQL query failed to execute.";
    ...
    public static final String SSL_CONFIGURATION_ERROR_MSG =
            "The Appsmith server has failed to fetch SSL configuration from datasource"
                    + " configuration form. ";
    ...
    public static final String CONNECTION_POOL_CREATION_FAILED_ERROR_MSG =
            "An exception occurred while creating connection pool. One or more arguments in the"
                    + " datasource configuration may be invalid.";
    ...
    */
    ...
    public static final String DS_MISSING_AUTHENTICATION_DETAILS_ERROR_MSG =
            "Missing authentication details.";

    public static final String DS_MISSING_USERNAME_ERROR_MSG =
