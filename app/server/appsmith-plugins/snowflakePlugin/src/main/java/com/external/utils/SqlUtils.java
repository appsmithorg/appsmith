...
public class SqlUtils {
     ...
     * fk_database_name | fk_schema_name | fk_table_name | pk_column_name | key_sequence |
     * update_rule | delete_rule | fk_name | pk_name | deferrability | comment |
     * +------------+------------------+----------------+---------------+----------------+------------------+----------------+---------------+----------------+--------------+----------------+-------------+--------------------+--------------------+-----------------+------------+
    ...
    public static void getTableInfo(
            ResultSet row, Map<String, DatasourceStructure.Table> tablesByName)
            throws SQLException {
