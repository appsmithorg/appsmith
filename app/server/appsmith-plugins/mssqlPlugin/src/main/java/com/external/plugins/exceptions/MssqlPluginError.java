...
@Getter
public enum MssqlPluginError implements BasePluginError {
    ...
    MssqlPluginError(Integer httpErrorCode, String appErrorCode, String message, AppsmithErrorAction errorAction,
