...
public class AmazonS3ErrorUtils extends AppsmithPluginErrorUtils {
    ...
    public String getReadableError(Throwable error) {
        ...
        if (externalError instanceof AmazonServiceException) {
             ...
             *
             * <p>Sample external error message: The specified access point name or account is not
             * valid. Sample external error code: InvalidAccessPoint Return string:
             * InvalidAccessPoint: The specified access point name or account is not valid.
             */
            return amazonServiceException.getErrorCode()
                    + ": "
                    + amazonServiceException.getErrorMessage();
        }

        /**
         * Base case when the error is not an instance of AmazonServiceException or of its
         * subclasses. Sample external error message: An unescaped quote was found while parsing the
         * CSV file. To allow quoted record delimiters, set AllowQuotedRecordDelimiter to 'TRUE'.
         * Return String An unescaped quote was found while parsing the CSV file. To allow quoted
         * record delimiters, set AllowQuotedRecordDelimiter to 'TRUE'.
         */
        return error.getMessage();
    }
}
