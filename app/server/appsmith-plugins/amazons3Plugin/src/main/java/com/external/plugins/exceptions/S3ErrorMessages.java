...
public static final String FILE_CONTENT_FETCHING_ERROR_MSG =
	"Appsmith server has encountered an unexpected error when fetching file content from AWS S3"
		+ " server. Please reach out to Appsmith customer support to resolve this.";

public static final String CONNECTIVITY_ERROR_MSG =
	"Appsmith server has encountered an unexpected error when establishing connection with AWS S3"
		+ " server. Please reach out to Appsmith customer support to resolve this.";
...
public static final String S3_SERVICE_PROVIDER_IDENTIFICATION_ERROR_MSG =
	"Appsmith S3 plugin service has failed to identify the S3 service provider type. Please reach"
...
public static final String INCORRECT_S3_ENDPOINT_URL_ERROR_MSG =
	"Your S3 endpoint URL seems to be incorrect for the selected S3 service provider. Please"
		+ " check your endpoint URL and the selected S3 service provider.";
...
public static final String DS_AT_LEAST_ONE_MANDATORY_PARAMETER_MISSING_ERROR_MSG =
	"At least one of the mandatory fields in S3 datasource creation form is empty - 'Access"
		+ " key'/'Secret key'/'Region'. Please fill all the mandatory fields and try again.";
