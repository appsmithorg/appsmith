...
public class RestApiPlugin extends BasePlugin {
    ...
    public static class RestApiPluginExecutor extends BaseRestApiPluginExecutor {
        ...
        public Mono<ActionExecutionResult> executeCommon(APIConnection apiConnection,
            ...
            String autoGeneratedReqContentType = headerUtils.getRequestContentType(actionConfiguration);
            ...
            Object requestBodyObj = dataUtils.getRequestBodyObject(actionConfiguration, autoGeneratedReqContentType,
                    encodeParamsToggle,
                    httpMethod);
