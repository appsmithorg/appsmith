...
@Slf4j
public class CustomApiPlugin extends BasePlugin {

    public CustomApiPlugin(PluginWrapper wrapper) {
        super(wrapper);
    }

    @Extension
    public static class CustomApiPluginExecutor extends BaseRestApiPluginExecutor {

        public CustomApiPluginExecutor(SharedConfig sharedConfig) {
            super(sharedConfig);
        }
