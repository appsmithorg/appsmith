...
public class RedshiftPluginTest {
    RedshiftPlugin.RedshiftPluginExecutor pluginExecutor =
            new RedshiftPlugin.RedshiftPluginExecutor();
                        ...
                        throwable ->
                                throwable instanceof AppsmithPluginException
                                        && ((AppsmithPluginException) throwable)
                                                ...
                                                .equals(
                                                        "Failed to initialize pool: The connection"
                                                                + " attempt failed."))
                .verify();
    }
    ...
    public void testStaleConnectionCheck() throws SQLException {
        ...
        Mono<ActionExecutionResult> resultMono =
                pluginExecutor.execute(mockConnection, dsConfig, actionConfiguration);
    ...
    public void testExecute() throws SQLException {
        ...
        RedshiftPlugin.RedshiftPluginExecutor spyPluginExecutor =
                spy(new RedshiftPlugin.RedshiftPluginExecutor());
        ...
        Mono<ActionExecutionResult> executeMono =
                dsConnectionMono.flatMap(
                        connPool ->
                                spyPluginExecutor.execute(connPool, dsConfig, actionConfiguration));
    ...
    public void testStructure() throws SQLException {
        ...
        when(mockStatement.executeQuery(Mockito.anyString()))
                .thenReturn(mockResultSet, mockResultSet, mockResultSet);
        ...
        when(mockResultSet.getString("kind"))
                .thenReturn("r", "r", "r", "r", "r", "r", "r", "r"); // TABLES_QUERY
        ...
        when(mockResultSet.getString("foreign_schema"))
                .thenReturn("public"); // KEYS_QUERY_FOREIGN_KEY
        when(mockResultSet.getString("foreign_table"))
                .thenReturn("users"); // KEYS_QUERY_FOREIGN_KEY
        ...
        Mono<DatasourceStructure> structureMono =
                dsConnectionMono.flatMap(
                        connectionPool -> spyPluginExecutor.getStructure(connectionPool, dsConfig));
        ...
        StepVerifier.create(structureMono)
                .assertNext(
                        structure -> {
                            ...
                            assertEquals(
                                    DatasourceStructure.TableType.TABLE, campusTable.getType());
                            assertArrayEquals(
                                    new DatasourceStructure.Column[] {
                                        new DatasourceStructure.Column(
                                                "id", "timestamptz", "now()", false),
                                        new DatasourceStructure.Column(
                                                "name", "timestamptz", "now()", false)
                                    },
                            ...
                            final DatasourceStructure.PrimaryKey possessionsPrimaryKey =
                                    new DatasourceStructure.PrimaryKey(
                                            "possessions_pkey", new ArrayList<>());
                            ...
                            final DatasourceStructure.ForeignKey possessionsUserForeignKey =
                                    new DatasourceStructure.ForeignKey(
                                            "user_fk", List.of("user_id"), List.of("users.id"));
                            assertArrayEquals(
                            ...
                            assertArrayEquals(
                                    new DatasourceStructure.Template[] {
                                        new DatasourceStructure.Template(
                                                "SELECT",
                                                "SELECT * FROM public.\"possessions\" LIMIT 10;"),
                                        new DatasourceStructure.Template(
                                                "INSERT",
                                                "INSERT INTO public.\"possessions\" (\"id\","
                                                        + " \"title\", \"user_id\")\n"
                                                        + "  VALUES (1, '', 1);"),
                                        new DatasourceStructure.Template(
                                                "UPDATE",
    ...
    public void testDuplicateColumnNames() throws SQLException {
        ...
        when(mockResultSetMetaData.getColumnName(Mockito.anyInt()))
                .thenReturn("id", "id", "username", "username");
                ...
                .assertNext(
                        result -> {
                            ...
                            String expectedMessage =
                                    "Your Redshift query result may not have all the columns"
                                            + " because duplicate column names were found for the"
                                            + " column(s)";
                            assertTrue(
