...
/**
 * Datasource properties: 1. Client JSON
 *
 * <p>Query Action properties: 1. method: Dropdown 2. collection: String 3. documentKey: String
 */
public class FirestorePlugin extends BasePlugin {
    ...
    @Slf4j
    @Extension
    public static class FirestorePluginExecutor
            implements PluginExecutor<Firestore>, SmartSubstitutionInterface {
        ...
        public Mono<ActionExecutionResult> execute(
            ...
            return Mono.error(
                    new AppsmithPluginException(
                            FirestorePluginError.QUERY_EXECUTION_FAILED, "Unsupported Operation"));
        }
        ...
        public Mono<ActionExecutionResult> executeParameterized(
            ...
            if (smartSubstitutionObject instanceof Boolean) {
                ...
                // Older UI configuration used to set this value as a string which may/may not be
            ...
            // Smartly substitute in actionConfiguration.body and replace all the bindings with
            // values.
            ...
            if (TRUE.equals(smartJsonSubstitution)) {
                ...
                if (query != null) {
                    ...
                    setDataValueSafelyInFormData(
                            actionConfiguration.getFormData(), BODY, updatedQuery);
                }
            }
            ...
            String command =
                    PluginUtils.getDataValueSafelyFromFormData(formData, COMMAND, STRING_TYPE);
            ...
            return Mono.justOrEmpty(query)
                    .flatMap(
                            strBody -> {
                                    ...
                                    return Mono.error(
                                            new AppsmithPluginException(
                                                    AppsmithPluginError
                                                            .PLUGIN_EXECUTE_ARGUMENT_ERROR,
                                                    FirestoreErrorMessages
                                                            .EMPTY_DOC_OR_COLLECTION_PATH_ERROR_MSG));
                                }
                                    ...
                                    return Mono.error(
                                            new AppsmithPluginException(
                                                    AppsmithPluginError
                                                            .PLUGIN_EXECUTE_ARGUMENT_ERROR,
                                                    FirestoreErrorMessages
                                                            .FIRESTORE_PATH_INVALID_STARTING_CHAR_ERROR_MSG));
                                }
                                ...
                                try {
                                    return Mono.just(
                                            objectMapper.readValue(strBody, HashMap.class));
                                } catch (IOException e) {
                                    return Mono.error(
                                            new AppsmithPluginException(
                                                    AppsmithPluginError
                                                            .PLUGIN_EXECUTE_ARGUMENT_ERROR,
                                                    FirestoreErrorMessages
                                                            .QUERY_CONVERSION_TO_HASHMAP_FAILED_ERROR_MSG,
                                                    e.getMessage()));
                                }
                            })
                    .flatMap(
                                    ...
                                    if (method.isBodyNeeded()) {
                                        return Mono.error(
                                                new AppsmithPluginException(
                                                        ...
                                                        String.format(
                                                                FirestoreErrorMessages
                                                                        .NON_EMPTY_BODY_REQUIRED_FOR_METHOD_ERROR_MSG,
                                                                method)));
                                    }
                    ...
                    .flatMap(
                            mapBody -> {
                                if (method.isDocumentLevel()) {
                                    return handleDocumentLevelMethod(
                                            connection,
                                            path,
                                            method,
                                            mapBody,
        ...
        private boolean isTimestampAndDeleteFieldValuePathEmpty(Map<String, Object> formData) {
            if (isBlank(
                            PluginUtils.getDataValueSafelyFromFormData(
                                    formData, TIMESTAMP_VALUE_PATH, STRING_TYPE))
                    && isBlank(
                            PluginUtils.getDataValueSafelyFromFormData(
                                    formData, DELETE_KEY_PATH, STRING_TYPE))) {
                return true;
            }
        ...
        private void insertFieldValues(
            ...
            if (!isBlank(
                ...
                String deletePaths =
                        PluginUtils.getDataValueSafelyFromFormData(
                                formData, DELETE_KEY_PATH, STRING_TYPE);
                requestParams.add(
                        new RequestParamDTO(DELETE_KEY_PATH, deletePaths, null, null, null));
                List<String> deletePathsList;
                try {
                    deletePathsList =
                            objectMapper.readValue(
                                    deletePaths, new TypeReference<List<String>>() {});
                } catch (IOException e) {
                    throw new AppsmithPluginException(
                            AppsmithPluginError.PLUGIN_EXECUTE_ARGUMENT_ERROR,
            ...
            if (!isBlank(
                ...
                requestParams.add(
                        new RequestParamDTO(
                                TIMESTAMP_VALUE_PATH, timestampValuePaths, null, null, null));
                List<String> timestampPathsStringList; // ["key1.key2", "key3.key4"]
                try {
                    timestampPathsStringList =
                            objectMapper.readValue(
                                    timestampValuePaths, new TypeReference<List<String>>() {});
                } catch (IOException e) {
                    throw new AppsmithPluginException(
                            AppsmithPluginError.PLUGIN_EXECUTE_ARGUMENT_ERROR,
                ...
                timestampPathsStringList.stream()
                        .forEach(
                                dottedPath ->
                                        timestampPathsArrayList.add(
                                                List.of(dottedPath.split("\\."))));
                insertFieldValueByMethodName(
                        mapBody, timestampPathsArrayList, FIELDVALUE_TIMESTAMP_METHOD_NAME);
            }
        }
            ...
            pathsList.stream()
                    ...
                    .forEach(
                            singlePathList -> {
                                 ...
                                 *   if possible.
                                 */
                                HashMap<String, Object> targetKeyValuePair =
                                ...
                                for (int i = 0; i < singlePathList.size() - 1; i++) {
                                     ...
                                     */
                                    targetKeyValuePair =
                                            (HashMap<String, Object>) targetKeyValuePair.get(key);
                                }
                                ...
                                try {
                                    switch (method1) {
                                        ...
                                        case DELETE_DOCUMENT:
                                            return Mono.justOrEmpty(
                                                    DocumentReference.class.getMethod(methodName));
                                        case SET_DOCUMENT:
                                        case CREATE_DOCUMENT:
                                        case UPDATE_DOCUMENT:
                                            requestParams.add(
                                                    new RequestParamDTO(
                                                            ...
                                                            null));
                                            return Mono.justOrEmpty(
                                                    DocumentReference.class.getMethod(
                                        ...
                                        default:
                                            return Mono.error(
                                                    new AppsmithPluginException(
                                                            ...
                                                            String.format(
                                                                    FirestoreErrorMessages
                                                                            .INVALID_DOCUMENT_LEVEL_METHOD_ERROR_MSG,
                                                                    method1)));
                                    }
                                    ...
                                    return Mono.error(
                                            new AppsmithPluginException(
                                                    ...
                                                    String.format(
                                                            FirestoreErrorMessages
                                                                    .ACTUAL_METHOD_GETTING_ERROR_MSG,
                                                            method1),
                                                    e.getMessage()));
                                }
                            })
                                ...
                                try {
                                    ...
                                    return Mono.error(
                                            new AppsmithPluginException(
                                                    FirestorePluginError.QUERY_EXECUTION_FAILED,
                                                    FirestoreErrorMessages
                                                            .FAILURE_IN_GETTING_RESULT_FROM_FUTURE_ERROR_MSG,
                                                    e.getMessage()));
                                }
                            })
        ...
        public Mono<ActionExecutionResult> handleCollectionLevelMethod(
            ...
            return Mono.error(
                    new AppsmithPluginException(
                            FirestorePluginError.QUERY_EXECUTION_FAILED,
                            String.format(
                                    FirestoreErrorMessages.UNSUPPORTED_COLLECTION_METHOD_ERROR_MSG,
                                    method)));
        }
        ...
        private Mono<ActionExecutionResult> methodGetCollection(
            ...
            final String limitString =
                    PluginUtils.getDataValueSafelyFromFormData(
                            formData, LIMIT_DOCUMENTS, STRING_TYPE);
            ...
            try {
                orderings =
                        StringUtils.isEmpty(orderByString)
                ...
                return Mono.error(
                        new AppsmithPluginException(
                                AppsmithPluginError.PLUGIN_JSON_PARSE_ERROR, orderByString, e));
            }

            Map<String, Object> startAfterTemp = null;
            String startAfterJson =
                    getDataValueSafelyFromFormData(formData, NEXT, STRING_TYPE, "{}");
            ...
            if (PaginationField.NEXT.equals(paginationField)) {
                try {
                    startAfterTemp =
                            StringUtils.isEmpty(startAfterJson)
            ...
            String endBeforeJson =
                    getDataValueSafelyFromFormData(formData, PREV, STRING_TYPE, "{}");
            ...
            if (PaginationField.PREV.equals(paginationField)) {
                try {
                    endBeforeTemp =
                            StringUtils.isEmpty(endBeforeJson)
                                    ? Collections.emptyMap()
                                    : objectMapper.readValue(endBeforeJson, Map.class);
                } catch (IOException e) {
                    return Mono.error(
                            new AppsmithPluginException(
                                    AppsmithPluginError.PLUGIN_JSON_PARSE_ERROR, endBeforeJson, e));
                }
            }
            ...
            if (paginationField != null && CollectionUtils.isEmpty(orderings)) {
                return Mono.error(
                        new AppsmithPluginException(
                                AppsmithPluginError.PLUGIN_EXECUTE_ARGUMENT_ERROR,
                                FirestoreErrorMessages
                                        .PAGINATION_WITHOUT_SPECIFYING_ORDERING_ERROR_MSG));
            }
            ...
            return Mono.just(query)
                    ...
                    .map(
                            query1 -> {
                                ...
                                if (PaginationField.NEXT.equals(paginationField)
                                        && !CollectionUtils.isEmpty(startAfter)) {
                    ...
                    .flatMap(
                            query1 -> {
                                ...
                                Map<String, List<Map<String, String>>> childrenMap =
                                        PluginUtils.getDataValueSafelyFromFormData(
                                                formData, WHERE, new TypeReference<>() {});
                                final List<Map<String, String>> conditionList =
                                        childrenMap.get("children");
                                requestParams.add(
                                        new RequestParamDTO(
                                                WHERE, conditionList, null, null, null));
                                ...
                                for (Map<String, String> condition : conditionList) {
                                    ...
                                    if (StringUtils.isEmpty(path)
                                        ...
                                        String emptyConditionMessage =
                                                "At least one of the conditions in the 'where'"
                                                    + " clause has missing operator or operand(s)."
                                                    + " These conditions were ignored during the"
                                    ...
                                    try {
                                        query1 =
                                                applyWhereConditional(
                                                        query1, path, operatorString, value);
                                    } catch (AppsmithPluginException e) {
                                        return Mono.error(e);
                                    }
                                }
                    ...
                    .flatMap(
                            objResult1 -> {
                                ...
                                result.setIsExecutionSuccess(true);
                                log.debug(
                                        "In the Firestore Plugin, got action execution result for"
                                                + " get collection");
                                return Mono.just(result);
                            });
        }
        ...
        private Object resultToMap(Object objResult, boolean isRoot)
                throws AppsmithPluginException {
                    ...
                    .flatMap(
                            connection -> {
                                try {
                                    ...
                                    if (e.getMessage()
                                            .contains(
                                                    "Metadata operations require admin"
                                                            + " authentication")) {
                                        DatasourceTestResult datasourceTestResult =
        ...
        public void datasourceDestroy(Firestore connection) {
            ...
            // When the datasource is updated, the FirebaseApp instance will delete & re-create the
            // app
        }
        ...
        public Mono<DatasourceStructure> getStructure(
            ...
            return Mono.fromSupplier(
                            () -> {
                                Iterable<CollectionReference> collectionReferences =
                                        connection.listCollections();

                                List<DatasourceStructure.Table> tables =
        ...
        public Set<String> getSelfReferencingDataPaths() {
            return Set.of(
                    "formData.prev.data",
                    "formData.next.data",
                    "formData.startAfter.data",
                    "formData.endBefore.data");
        }
    }
}
