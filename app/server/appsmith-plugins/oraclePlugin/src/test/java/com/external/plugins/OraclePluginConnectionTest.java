...
public class OraclePluginConnectionTest {
    ...
    // pseudo-optional.
    @Container
    private static final OracleContainer oracleDB =
            OracleTestDBContainerManager.getOracleDBForTest();
                ...
                .assertNext(
                        testResult -> {
                            ...
                            String expectedError =
                                    "Failed to initialize pool: ORA-01017: invalid"
                                            + " username/password; logon denied";
                            boolean isExpectedErrorReceived =
                                    testResult.getInvalids().stream()
                                            .anyMatch(
                                                    errorString ->
