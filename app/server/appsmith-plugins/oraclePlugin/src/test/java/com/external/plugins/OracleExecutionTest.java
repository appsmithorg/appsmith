...
public class OracleExecutionTest {
    ...
    public static final String SELECT_TEST_WITH_PREPARED_STMT_TABLE_NAME =
            "testSelectWithPreparedStatementWithBinding";
    public static final String INSERT_TEST_WITHOUT_PREPARED_STMT_TABLE_NAME =
            "testInsertWithPreparedStatementWithoutAnyBinding";
    public static final String INSERT_TEST_WITH_PREPARED_STMT_TABLE_NAME =
            "testInsertWithPreparedStatementWithBinding";
    public static final String UPDATE_TEST_WITHOUT_PREPARED_STMT_TABLE_NAME =
            "testUpdateWithPreparedStatementWithoutAnyBinding";
    public static final String UPDATE_TEST_WITH_PREPARED_STMT_TABLE_NAME =
            "testUpdateWithPreparedStatementWithBinding";
    public static final String DELETE_TEST_WITHOUT_PREPARED_STMT_TABLE_NAME =
            "testDeleteWithPreparedStatementWithoutAnyBinding";
    public static final String DELETE_TEST_WITH_PREPARED_STMT_TABLE_NAME =
            "testDeleteWithPreparedStatementWithBinding";
    ...
    public static void setup() throws SQLException {
        sharedConnectionPool =
                oraclePluginExecutor.datasourceCreate(getDefaultDatasourceConfig(oracleDB)).block();
        createTablesForTest();
    }
    ...
    private static void createTableWithName(String tableName) throws SQLException {
        String sqlQueryToCreateTable =
                MessageFormat.format(SQL_QUERY_CREATE_TABLE_FORMAT, tableName);
        runSQLQueryOnOracleTestDB(sqlQueryToCreateTable, sharedConnectionPool);

        String sqlQueryToInsertRow1 =
                MessageFormat.format(SQL_QUERY_TO_INSERT_ONE_ROW_FORMAT, tableName, 1);
        runSQLQueryOnOracleTestDB(sqlQueryToInsertRow1, sharedConnectionPool);

        String sqlQueryToInsertRow2 =
                MessageFormat.format(SQL_QUERY_TO_INSERT_ONE_ROW_FORMAT, tableName, 2);
    ...
    public void testSelectQueryWithPreparedStatementWithoutAnyBinding() {
        String sqlSelectQuery =
                MessageFormat.format(
                        "SELECT c_number FROM {0} ORDER BY c_number",
        ...
        Mono<ActionExecutionResult> executionResultMono =
                oraclePluginExecutor.executeParameterized(
                        sharedConnectionPool,
    ...
    public void testSelectQueryWithPreparedStatementWithBinding() {
        String sqlSelectQuery =
                MessageFormat.format(
                        "SELECT c_number FROM {0} WHERE "
                                + "c_varchar2='{{'binding1'}}' ORDER BY c_number DESC",
        ...
        bindingNameToValueAndDataTypeMap.put(
                "binding1", List.of("varchar2", ClientDataType.STRING));
        ExecuteActionDTO executeActionDTO =
                getExecuteDTOForTestWithBindingAndValueAndDataType(
    ...
    public void testInsertQueryReturnValueWithPreparedStatementWithoutAnyBinding() {
        String sqlInsertQuery =
                MessageFormat.format(
                        SQL_QUERY_TO_INSERT_ONE_ROW_FORMAT,
    ...
    public void testInsertQueryVerifyNewRowAddedWithPreparedStatementWithoutAnyBinding() {
        ...
        String sqlSelectQuery =
                MessageFormat.format(
                        "SELECT * FROM {0} WHERE c_number=4",
                        INSERT_TEST_WITHOUT_PREPARED_STMT_TABLE_NAME);
    ...
    public void testInsertQueryReturnValueWithPreparedStatementWithBinding() {
        String sqlInsertQuery =
                MessageFormat.format(
                        SQL_QUERY_TO_INSERT_ONE_ROW_WITH_BINDING_FORMAT,
        ...
        bindingNameToValueAndDataTypeMap.put(
                "binding1", List.of("varchar2", ClientDataType.STRING));
        bindingNameToValueAndDataTypeMap.put(
                "binding2", List.of("nvarchar2", ClientDataType.STRING));
        ...
        bindingNameToValueAndDataTypeMap.put(
                "binding5", List.of("03-OCT-02", ClientDataType.STRING));
        ...
        bindingNameToValueAndDataTypeMap.put(
                "binding8", List.of("1997-01-01 09:26:50.124", ClientDataType.STRING));
        bindingNameToValueAndDataTypeMap.put(
                "binding9", List.of("1997-01-01 09:26:50.124", ClientDataType.STRING));
        bindingNameToValueAndDataTypeMap.put(
                "binding10", List.of("1997-01-01 09:26:50.124", ClientDataType.STRING));
        ...
        bindingNameToValueAndDataTypeMap.put(
                "binding13", List.of("000001F8.0001.0006", ClientDataType.STRING));
        bindingNameToValueAndDataTypeMap.put(
                "binding14", List.of("000001F8.0001.0006", ClientDataType.STRING));
    ...
    public void testInsertQueryVerifyNewRowAddedWithPreparedStatementWithBinding() {
        ...
        String sqlSelectQuery =
                MessageFormat.format(
                        "SELECT c_varchar2, c_nvarchar2, c_number, c_float, c_date, c_binary_float,"
                            + " c_binary_double, c_timestamp, c_interval_year, c_interval_day,"
                            + " c_rowid, c_urowid, c_char, c_nchar, c_clob, c_nclob FROM {0} WHERE"
                            + " c_number=5",
                        INSERT_TEST_WITH_PREPARED_STMT_TABLE_NAME);
        Map selectQueryFormData = setDataValueSafelyInFormData(null, "body", sqlSelectQuery);
        ActionConfiguration selectQueryActionConfig = new ActionConfiguration();
    ...
    private void verifyColumnValue(
            Mono<ActionExecutionResult> executionResultMono, String expectedResult) {
