...
public class OraclePluginDatasourceValidityErrorsTest {
    ...
    public void testErrorOnMissingUsername() {
        ...
        Set<String> dsValidateResult =
                oraclePluginExecutor.validateDatasource(dsConfigWithMissingUsername);
        boolean isExpectedErrorReceived =
                dsValidateResult.stream()
                        .anyMatch(
                                errorString ->
                                        DS_MISSING_USERNAME_ERROR_MSG.equals(errorString.trim()));
    ...
    public void testErrorOnMissingPassword() {
        ...
        Set<String> dsValidateResult =
                oraclePluginExecutor.validateDatasource(dsConfigWithMissingPassword);
        boolean isExpectedErrorReceived =
                dsValidateResult.stream()
                        .anyMatch(
                                errorString ->
                                        DS_MISSING_PASSWORD_ERROR_MSG.equals(errorString.trim()));
        assertTrue(isExpectedErrorReceived);
    }
    ...
    public void testErrorOnMissingEndpoint() {
        ...
        Set<String> dsValidateResult =
                oraclePluginExecutor.validateDatasource(dsConfigWithMissingEndpoint);
        boolean isExpectedErrorReceived =
                dsValidateResult.stream()
                        .anyMatch(
                                errorString ->
                                        DS_MISSING_ENDPOINT_ERROR_MSG.equals(errorString.trim()));
        assertTrue(isExpectedErrorReceived);
    }
    ...
    public void testErrorOnMissingHost() {
        ...
        Set<String> dsValidateResult =
                oraclePluginExecutor.validateDatasource(dsConfigWithMissingHost);
        boolean isExpectedErrorReceived =
                dsValidateResult.stream()
                        .anyMatch(
                                errorString ->
                                        DS_MISSING_HOSTNAME_ERROR_MSG.equals(errorString.trim()));
        assertTrue(isExpectedErrorReceived);
    }
}
