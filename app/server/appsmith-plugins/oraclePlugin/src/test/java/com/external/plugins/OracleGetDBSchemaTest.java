        ...
        StepVerifier.create(datasourceStructureMono)
                .assertNext(
                        datasourceStructure -> {
                            ...
                            assertTrue(
                                    supplierTable != null, "supplier table not found in DB schema");
                        ...
                        datasourceStructure -> {
                            ...
                            supplierTable.getTemplates().stream()
                                    ...
                                    .forEach(
                                            template -> {
                                                /**
                                                 * Not sure how to test query templates for insert
                                                 * and update queries as these queries include
                                                 * column names in an order that is not fixed.
                                                 * Hence, skipping testing them for now.
                                                 */
                                                String expectedSelectQueryTemplate = null;
                                                if ("select"
                                                        .equalsIgnoreCase(template.getTitle())) {
                                                    expectedSelectQueryTemplate =
                                                            "select * from supplier where rownum <"
                                                                    + " 10";
                                                } else if ("delete"
                                                        .equalsIgnoreCase(template.getTitle())) {
                                                    expectedSelectQueryTemplate =
