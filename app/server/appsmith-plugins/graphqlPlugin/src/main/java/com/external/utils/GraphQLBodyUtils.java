...
public static void validateBodyAndVariablesSyntax(ActionConfiguration actionConfiguration)
	...
	throw new AppsmithPluginException(
		AppsmithPluginError.PLUGIN_EXECUTE_ARGUMENT_ERROR,
		"Your GraphQL query body is empty. Please edit the 'Body' tab of your GraphQL API to"
			+ " provide a query body.");
	}
...
public static List<Property> getGraphQLQueryParamsForBodyAndVariables(
