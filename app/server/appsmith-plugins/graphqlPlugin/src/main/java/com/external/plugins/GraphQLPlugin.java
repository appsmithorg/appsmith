    ...
    public Mono<ActionExecutionResult> executeCommon(
      ...
      if (HttpMethod.POST.equals(httpMethod)) {
        ...
        if (HttpMethod.GET.equals(httpMethod)) {
          /**
           * When a GraphQL request is sent using GET method, the GraphQL body and variables are
           * sent as part of query parameters in the URL. Ref:
           * https://graphql.org/learn/serving-over-http/
           */
          ...
          return Mono.error(
              new AppsmithPluginException(
                  ...
                  String.format(
                      GraphQLErrorMessages.UNEXPECTED_HTTP_METHOD_ERROR_MSG, httpMethod)));
        }
      }
      ...
      Object requestBodyObj =
          dataUtils.getRequestBodyObject(
              actionConfiguration, reqContentType,
