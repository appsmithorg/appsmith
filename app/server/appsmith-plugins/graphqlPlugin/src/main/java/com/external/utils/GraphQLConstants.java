...
public class GraphQLConstants {
    ...
    protected static String HINT_MESSAGE_FOR_DUPLICATE_VARIABLE_DEFINITION =
            "Your GraphQL query may not run as expected because it has duplicate definition for"
                + " variable(s): {0}. Please remove one of the definitions - either in the query"
                + " variables section or the pagination tab to resolve this issue.";
}
