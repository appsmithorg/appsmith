...
public class RowsAppendMethodTest {
    ...
    public void testRowAppendMethodWithEmptyBody() {
                ...
                Collections.singletonMap(
                        ...
                        Map.of(
                                ...
                                Collections.singletonList(
                                        Collections.singletonMap("condition", "LT")))));
        formData.put(
                "pagination", Collections.singletonMap("data", Map.of("limit", 20, "offset", 0)));
        formData.put("smartSubstitution", Collections.singletonMap("data", true));
        formData.put(
                "sheetUrl",
                Collections.singletonMap(
                        "data", "https://docs.google.com/spreadsheets/d/123/edit"));
        formData.put("sheetName", Collections.singletonMap("data", "portSheet"));
        formData.put(
                "sortBy",
                Collections.singletonMap(
                        "data",
                        Collections.singletonList(Map.of("column", "", "order", "Ascending"))));
        ...
        for (int i = 0; i < testDataArray.length; i++) {
            ...
            formData.put(
                    "rowObjects",
                    new HashMap<>(Collections.singletonMap("data", testDataArray[i])));
