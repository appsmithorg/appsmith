...
public static final String SPREADSHEET_ID_NOT_FOUND_IN_URL_ERROR_MSG =
	"Cannot read spreadsheet URL. Please verify that the provided the Spreadsheet URL matches"
		+ " this pattern https://docs.google.com/spreadsheets/d/spreadsheetId_should_be_here/.";
}
