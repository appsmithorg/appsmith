...
public class ErrorMessages {
    ...
    public static final String EMPTY_UPDATE_ROW_OBJECT_MESSAGE =
            "Update Row object(s) cannot be empty.";

    public static final String EMPTY_UPDATE_ROW_OBJECTS_MESSAGE =
            "Update Row object(s) cannot be empty.";

    public static final String EXPECTED_ROW_OBJECT_MESSAGE =
    ...
    public static final String QUERY_EXECUTION_FAILED_ERROR_MSG =
            "Your GoogleSheets query failed to execute";

    public static final String MISSING_SPREADSHEET_URL_ERROR_MSG =
            "Missing required field 'Spreadsheet Url'";

    public static final String MISSING_SPREADSHEET_NAME_ERROR_MSG =
    ...
    public static final String MISSING_VALID_RESPONSE_ERROR_MSG =
    ...
    public static final String RESPONSE_DATA_MAPPING_FAILED_ERROR_MSG =
            "Could not map response to existing data. Appsmith server has either received an empty"
                    + " response or an unexpected response.";
    ...
    public static final String NULL_RESPONSE_BODY_ERROR_MSG =
            "Expected to receive a response body.";

    public static final String NO_DATA_FOUND_CURRENT_ROW_INDEX_ERROR_MSG =
    ...
    public static final String UNKNOWN_EXECUTION_METHOD_ERROR_MSG =
            "Unknown execution method type: %s";
    ...
    public static final String SPREADSHEET_ID_NOT_FOUND_IN_URL_ERROR_MSG =
            "Cannot read spreadsheet URL. Please verify that the provided the Spreadsheet URL"
                    + " matches this pattern"
                    + " https://docs.google.com/spreadsheets/d/spreadsheetId_should_be_here/.";
}
