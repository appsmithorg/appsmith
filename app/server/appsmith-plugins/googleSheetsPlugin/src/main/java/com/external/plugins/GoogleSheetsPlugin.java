...
public static class GoogleSheetsPluginExecutor
	...
	// This will get list of authorised sheet ids from datasource config, and transform execution
	// response to contain only authorised files
	...
	return executionMethod
		...
		// This method call will populate the request with all the configurations it needs for a
		// particular method
		.flatMap(
			res -> {
				return executionMethod
	...
	// This will get list of authorised sheet ids from datasource config, and transform trigger
	// response to contain only authorised files
