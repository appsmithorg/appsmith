...
public class SheetsUtil {
  ...
  public static Set<String> getUserAuthorizedSheetIds(
    ...
    if (!isEmpty(datasourceConfiguration.getProperties())
        ...
        && datasourceConfiguration.getProperties().get(USER_AUTHORIZED_SHEET_IDS_INDEX).getValue()
            != null
  ...
  private static Map<String, String> extractSheetData(
      JsonNode file, GoogleSheetMethodEnum methodType) {
