package com.appsmith.profiling.aspects;
...
import com.appsmith.profiling.components.StatManager;
...
public class TimingAspect {
    ...
    @Autowired
    public TimingAspect(StatManager statManager) {
        this.statManager = statManager;
    }

    // @Around("@annotation(com.appsmith.profiling.aspects.AppsmithTimed)")
    // public Object timed(ProceedingJoinPoint joinPoint) throws Throwable {
    //     String methodName = joinPoint.getSignature().getName();
    //     // log.debug("Method {} called with args {}", methodName, joinPoint.getArgs());
    //     try {
    //         long startTime = System.currentTimeMillis();
    //         Object result = joinPoint.proceed();
    //         long endTime = System.currentTimeMillis();
    //         long timeTaken = endTime - startTime;
    //         // log.debug("Method {} took {}ms to execute", methodName, timeTaken);
    //         statManager.updateStat(methodName, timeTaken);
    //         return result;
    //     } catch (Throwable t) {
    //         log.error("Error occurred in method {} with args {}", methodName, joinPoint.getArgs(), t);
    //         throw t;
    //     }
    // }
    ...
    //  */
    // private Mono<Object> callMonoMethodAndProfile(ProceedingJoinPoint joinPoint, String methodName) {
    //     try {
    ...
    //  */
    // private Flux<?> callFluxMethodAndProfile(ProceedingJoinPoint joinPoint, String methodName) {
    //     try {
