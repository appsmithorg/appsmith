...
echo -e "Thank you for installing appsmith! We wanted to be transparent and inform you that we do perform telemetry in our on-prem installations. This helps us understand your needs and prioritise features & bug fixes better"
