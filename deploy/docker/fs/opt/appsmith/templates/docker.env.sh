...
APPSMITH_NEW_RELIC_ENABLED=false
APPSMITH_NEW_RELIC_APM_LICENSE_KEY=''
APPSMITH_NEW_RELIC_APM_NAME=''
APPSMITH_NEW_RELIC_ACCOUNT_ID=''
APPSMITH_NEW_RELIC_APPLICATION_ID=''
APPSMITH_NEW_RELIC_BROWSER_AGENT_LICENSE_KEY=''
APPSMITH_NEW_RELIC_BROWSER_AGENT_ENDPOINT='bam.nr-data.net'
APPSMITH_NEW_RELIC_OTEL_EXPORTER_OTLP_ENDPOINT='https://otlp.nr-data.net:4317'
APPSMITH_NEW_RELIC_OTEL_SERVICE_NAME=''
OTEL_SERVICE_NAME=''
APPSMITH_NEWRELIC_MICROMETER_SERVICE_NAME=''
APPSMITH_NEW_RELIC_OTLP_LICENSE_KEY=''
APPSMITH_MICROMETER_METRICS_ENABLED=false
