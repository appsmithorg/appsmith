...
(all-config) {
  ...
  # A shared internal value used to validate requests from registered MCP servers.
  # MCP servers must include this value in the X-Appsmith-Internal-Marker header when
  # calling Appsmith services. The value should be a cryptographically random, opaque token generated by Appsmith.
