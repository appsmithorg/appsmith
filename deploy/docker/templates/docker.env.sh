...
# RapidAPI
APPSMITH_RAPID_API_KEY_VALUE=${APPSMITH_RAPID_API_KEY_VALUE:-}
APPSMITH_MARKETPLACE_ENABLED=${APPSMITH_MARKETPLACE_ENABLED:-}

# Optimizely
APPSMITH_OPTIMIZELY_KEY=${APPSMITH_OPTIMIZELY_KEY:-}

# Algolia Search (Docs)
APPSMITH_ALGOLIA_API_ID=${APPSMITH_ALGOLIA_API_ID:-}
APPSMITH_ALGOLIA_API_KEY=${APPSMITH_ALGOLIA_API_KEY:-}
APPSMITH_ALGOLIA_SEARCH_INDEX_NAME=${APPSMITH_ALGOLIA_SEARCH_INDEX_NAME:-}
...
APPSMITH_MONGODB_URI=${APPSMITH_MONGODB_URI:-mongodb://appsmith:$MONGO_PASSWORD@localhost/appsmith}

APPSMITH_API_BASE_URL=http://localhost:8080

APPSMITH_REDIS_URL=${APPSMITH_REDIS_URL:-redis://127.0.0.1:6379}

APPSMITH_ENCRYPTION_PASSWORD=${APPSMITH_ENCRYPTION_PASSWORD:-$ENCRYPTION_PASSWORD}
APPSMITH_ENCRYPTION_SALT=${APPSMITH_ENCRYPTION_SALT:-$ENCRYPTION_SALT}
...
APPSMITH_BASIC_AUTH_USER=${APPSMITH_BASIC_AUTH_USER:-appsmith}
APPSMITH_BASIC_AUTH_PASSWORD=${APPSMITH_BASIC_AUTH_PASSWORD:-$BASIC_AUTH_PASSWORD}
EOF
