...
- In case you are unable to setup the api server on your local system, you can also use Appsmith's api server: https://release-api.appsmith.com/. How to make this change is described in [one of the sections below](#if-you-would-like-to-hit-a-different-appsmith-server).
